---
document_id: DMC-AMPEL360E-EWTW-021-010-11A-GROUP-README
title: "DMC Group — DMC-AMPEL360E-EWTW-021-010-11A"
...
# DMC Group: DMC-AMPEL360E-EWTW-021-010-11A

**System:** 021 — Conditioning and Pressurization  
**Sub-system:** 021-010 — Compression Subsystem  
**Component:** Compression Cooling and Thermal Interfaces  
**SNS node:** 021-010-11A / ATA 21-10  
...
| `200_servicing/` | 200 | servicing data module |
| `300_examinations-tests-and-checks/` | 300, 320 | inspection, operational checks, functional tests |
| `400_fault-reports-and-isolation-procedures/` | 400, 420 | fault reporting and fault isolation procedures |
| `500_disconnect-remove-and-disassembly-procedures/` | 520, 540 | disconnect, remove and disassembly procedures |
| `600_repairs-and-locally-make-procedures-and-data/` | 600 | repair and locally made procedures and data |
| `700_assemble-install-and-connect-procedures/` | 720, 740 | assemble, install and connect procedures |
| `800_package-handling-storage-and-transportation/` | 800, 820, 840 | package, handling, storage and transportation procedures |
