---
document_id: QATL-ATLAS-1000-STA-120-129-02-README
title: "STA 120-129 · 02 — Propulsión Espacial Tradicional y Avanzada (Section Index)"
register: ATLAS-1000
...
section_title_en: "Traditional and Advanced Space Propulsion"
...
# STA 120-129 · Section 02 — Propulsión Espacial Tradicional y Avanzada
...
- Aggregates the subsections within the `120-129` code range listed in §3.
...
flowchart TB
    ...
    SEC["Section 02 · 120-129<br/>Propulsión Espacial Tradicional y Avanzada"]:::sec
    PARENT --> SEC

    subgraph SUBS["Subsections"]
        direction LR
        SUB_120["120 — Chemical Propulsion"]:::sub
    ...
    QSUPP["Q-SPACE, Q-HORIZON, Q-HPC<br/>(support Q-Divisions)"]:::qdiv
...
| Folder path | `Q+ATLANTIDE/100-199_STA/120-129_Propulsion-Espacial-Tradicional-y-Avanzada/` |
