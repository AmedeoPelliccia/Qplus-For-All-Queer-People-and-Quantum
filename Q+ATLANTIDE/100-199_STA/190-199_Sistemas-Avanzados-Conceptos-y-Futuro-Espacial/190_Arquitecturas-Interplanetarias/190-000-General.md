---
document_id: QATL-ATLAS-1000-STA-190-199-09-190-000-GENERAL
title: "STA 190-199 · 190-000 — General"
register: ATLAS-1000
...
|----|------|----------------------|
| 010 | [190-010-Interplanetary-Architecture-Controlled-Definition.md](./190-010-Interplanetary-Architecture-Controlled-Definition.md) | Establishes the Q+ATLANTIDE controlled definition of "Interplanetary Architecture" and its regime taxonomy. |
| 020 | [190-020-Mission-Classes-and-Interplanetary-Regimes.md](./190-020-Mission-Classes-and-Interplanetary-Regimes.md) | Defines the formal mission-class taxonomy (flyby through crewed surface) and all regime boundary conditions. |
| 030 | [190-030-Trajectory-Architecture-and-Transfer-Windows.md](./190-030-Trajectory-Architecture-and-Transfer-Windows.md) | Specifies trajectory architecture requirements — transfers, gravity assists, launch windows, and delta-V budgets. |
| 040 | [190-040-Deep-Space-Transport-and-Propulsion-Interfaces.md](./190-040-Deep-Space-Transport-and-Propulsion-Interfaces.md) | Architecture-level interface control between the transport vehicle and its propulsion system across all propulsion classes. |
| 050 | [190-050-Communication-Navigation-and-Time-Reference-Boundaries.md](./190-050-Communication-Navigation-and-Time-Reference-Boundaries.md) | Defines deep-space link architecture, navigation reference frames, light-time constraints, and time-system boundaries. |
| 060 | [190-060-Surface-Orbital-and-Transit-Infrastructure-Interfaces.md](./190-060-Surface-Orbital-and-Transit-Infrastructure-Interfaces.md) | Specifies interfaces between transit vehicle and surface, orbital, and in-space infrastructure elements. |
| 070 | [190-070-Autonomy-Safe-Modes-and-Long-Duration-Operations.md](./190-070-Autonomy-Safe-Modes-and-Long-Duration-Operations.md) | Classifies autonomy tiers, safe-mode hierarchies, FDIR architecture, and long-duration operations protocols. |
| 080 | [190-080-Radiation-Life-Support-and-Human-Factors-Boundaries.md](./190-080-Radiation-Life-Support-and-Human-Factors-Boundaries.md) | Characterises the radiation environment, ECLSS boundary requirements, and human-factors constraints for crewed missions. |
| 090 | [190-090-Traceability-Evidence-and-Lifecycle-Governance.md](./190-090-Traceability-Evidence-and-Lifecycle-Governance.md) | Maps each interplanetary architecture function to the applicable normative ECSS, NASA, and CCSDS standard. |
| 100 | [`190-090-Traceability-Evidence-and-Lifecycle-Governance.md`](./190-090-Traceability-Evidence-and-Lifecycle-Governance.md) | Defines evidence-package requirements, review gates (MDR through ORR), and mission-archive closure records. |
