---
document_id: QATL-ATLAS-1000-STA-180-189-08-182-007-PROPULSION-POWER-AND-THERMAL-TRANSPORT-CONSTRAINTS
title: "STA 180-189 · 08.182.007 — Propulsion, Power and Thermal Transport Constraints"
register: ATLAS-1000
...
# STA 180-189 · Section 08 · Subsection 182.007 — Propulsion, Power and Thermal Transport Constraints
...
These constraints are designated **space-transport critical**. Violations require formal deviation/waiver through the CCB process and reassessment of the transport RTM in `010_Traceability-Evidence-and-Lifecycle-Governance.md`. The `no_aaa_rule` applies to all constraint identifiers.
...
| Document | `007_Propulsion-Power-and-Thermal-Transport-Constraints.md` (this file) |
