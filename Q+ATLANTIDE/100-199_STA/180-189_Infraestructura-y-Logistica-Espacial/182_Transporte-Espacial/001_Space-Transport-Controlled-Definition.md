---
document_id: QATL-ATLAS-1000-STA-180-189-08-182-001-SPACE-TRANSPORT-CONTROLLED-DEFINITION
title: "STA 180-189 · 08.182.001 — Space Transport Controlled Definition"
register: ATLAS-1000
...
# STA 180-189 · Section 08 · Subsection 182.001 — Space Transport Controlled Definition

## 1. Purpose

This document establishes the normative, controlled definitions for all space transport elements referenced within subsection `182` *Transporte Espacial* and the broader STA `180-189` architecture. These definitions are authoritative within the **ATLAS-1000** register and the **Q+ATLANTIDE** baseline[^baseline]; any deviation or extension must follow the CCB process defined in `010_Traceability-Evidence-and-Lifecycle-Governance.md`.
...
| Document | `001_Space-Transport-Controlled-Definition.md` (this file) |
