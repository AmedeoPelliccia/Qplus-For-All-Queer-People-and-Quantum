---
document_id: QATL-ATLAS-1000-STA-180-189-08-182-020-SPACE-TRANSPORT-CLASSES-AND-MISSION-ROLES
title: "STA 180-189 · 182-020 — Space Transport Classes and Mission Roles"
register: ATLAS-1000
...
# STA 180-189 · 182-020 — Space Transport Classes and Mission Roles
...
- **Governance**: all class-to-role assignments are traceable via the transport RTM in `182-090-Traceability-Evidence-and-Lifecycle-Governance.md`.
...
| Document | `182-020-Space-Transport-Classes-and-Mission-Roles.md` (this file) |
