---
document_id: QATL-ATLAS-1000-STA-180-189-08-181-090-TRACEABILITY-EVIDENCE-AND-LIFECYCLE-GOVERNANCE
title: "STA 180-189 · 181-090 — Traceability Evidence and Lifecycle Governance"
register: ATLAS-1000
...
# STA 180-189 · 181-090 — Traceability Evidence and Lifecycle Governance
...
- **Traceability coverage**: every subsubject `001`–`009` shall be traceable to at least one mission-level logistics requirement and one applicable standard from [`009`](./181-090-Traceability-Evidence-and-Lifecycle-Governance.md)
...
| Document | `181-090-Traceability-Evidence-and-Lifecycle-Governance.md` (this file) |
