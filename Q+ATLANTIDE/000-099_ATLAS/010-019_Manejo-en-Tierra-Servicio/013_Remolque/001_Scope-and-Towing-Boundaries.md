...
> **Scope boundary:** This file defines *what* is in scope and *where* the boundaries are. The step-by-step procedures are in [`003_Towing-Procedures-Pushback-and-Maneuvering.md`](./003_Towing-Procedures-Pushback-and-Maneuvering.md); equipment specifications are in [`002_Towing-Equipment-and-Tug-Compatibility.md`](./002_Towing-Equipment-and-Tug-Compatibility.md).
...
- An authorised towing order (see [`005_Towing-Records-Incidents-and-Traceability.md`](./005_Towing-Records-Incidents-and-Traceability.md)).
- Insertion of the bypass pin before tug connection (see [`003_Towing-Procedures-Pushback-and-Maneuvering.md`](./003_Towing-Procedures-Pushback-and-Maneuvering.md)).
- A qualified tug and approved towbar or towbarless (TBL) adapter (see [`002_Towing-Equipment-and-Tug-Compatibility.md`](./002_Towing-Equipment-and-Tug-Compatibility.md)).
...
| Document | `001_Scope-and-Towing-Boundaries.md` (this file) |
