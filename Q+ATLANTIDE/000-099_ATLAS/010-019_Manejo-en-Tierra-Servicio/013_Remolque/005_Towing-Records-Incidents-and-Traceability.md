...
> **Scope boundary:** This file covers documentation and reporting requirements. The procedure steps that generate these records are in [`003_Towing-Procedures-Pushback-and-Maneuvering.md`](./003_Towing-Procedures-Pushback-and-Maneuvering.md). The limits that, when exceeded, trigger incident entries are in [`004_Towing-Limits-Loads-and-Steering-Constraints.md`](./004_Towing-Limits-Loads-and-Steering-Constraints.md).
...
| Document | `005_Towing-Records-Incidents-and-Traceability.md` (this file) |
