...
> **Scope boundary:** This file covers equipment specifications and qualification criteria. The procedure for using this equipment (installation sequence, tug connection, bypass pin insertion) is in [`003_Towing-Procedures-Pushback-and-Maneuvering.md`](./003_Towing-Procedures-Pushback-and-Maneuvering.md). Load and speed limits applicable to all equipment are in [`004_Towing-Limits-Loads-and-Steering-Constraints.md`](./004_Towing-Limits-Loads-and-Steering-Constraints.md).
...
| Document | `002_Towing-Equipment-and-Tug-Compatibility.md` (this file) |
