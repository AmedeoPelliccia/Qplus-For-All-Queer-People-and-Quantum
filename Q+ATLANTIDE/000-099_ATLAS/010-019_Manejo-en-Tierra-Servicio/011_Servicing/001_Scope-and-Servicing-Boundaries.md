...
- Concepts in scope:
  ...
  - **Boundary with Line Maintenance** — corrective actions triggered during servicing (e.g., a fluid system fault detected during replenishment) are handed over to line maintenance per the escalation protocol in `003_Scheduled-and-Unscheduled-Servicing.md`.
...
| Document | `001_Scope-and-Servicing-Boundaries.md` (this file) |
