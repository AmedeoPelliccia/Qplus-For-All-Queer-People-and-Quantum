...
> **Scope boundary:** This subsubject covers normal short-term and overnight parking. Mooring and wind-protection procedures are in `003_Mooring-Tie-Down-and-Wind-Protection.md`. Records and return-to-service inspection are in `005_Parking-Records-Inspections-and-Return-to-Service.md`. GSE vehicle positioning is in `015_GSE/`.
...
1. Position the GPU or fixed-ground-power (FGP) cart at the approved equipment-restraint line (see `001_Scope-and-Parking-Boundaries.md` §2.2). Do not approach the aircraft with the GPU until engines are shutdown and inlet/exhaust hazards are clear.
...
| Document | `004_Short-Term-Parking-and-Turnaround-Configurations.md` (this file) |
| Parent subsection | [`README.md`](./README.md) · [`000_Overview.md`](./000_Overview.md) |
| Mooring procedures | [`003_Mooring-Tie-Down-and-Wind-Protection.md`](./003_Mooring-Tie-Down-and-Wind-Protection.md) |
| Records and RTS | [`005_Parking-Records-Inspections-and-Return-to-Service.md`](./005_Parking-Records-Inspections-and-Return-to-Service.md) |
