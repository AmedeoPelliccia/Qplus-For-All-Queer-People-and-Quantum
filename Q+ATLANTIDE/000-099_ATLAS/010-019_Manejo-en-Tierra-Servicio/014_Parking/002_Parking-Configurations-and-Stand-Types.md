...
> **Scope boundary:** This subsubject covers stand type selection and configuration. Chock placement and GPU connection procedures are in `004_Short-Term-Parking-and-Turnaround-Configurations.md`. Mooring and tie-down are in `003_Mooring-Tie-Down-and-Wind-Protection.md`.
...
| Document | `002_Parking-Configurations-and-Stand-Types.md` (this file) |
| Parent subsection | [`README.md`](./README.md) · [`000_Overview.md`](./000_Overview.md) |
| Chock/GPU procedures | [`004_Short-Term-Parking-and-Turnaround-Configurations.md`](./004_Short-Term-Parking-and-Turnaround-Configurations.md) |
