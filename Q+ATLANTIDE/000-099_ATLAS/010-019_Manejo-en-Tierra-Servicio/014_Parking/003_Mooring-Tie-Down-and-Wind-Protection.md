...
| 7 | Record mooring rig status on the Parking State Record (see `005_Parking-Records-Inspections-and-Return-to-Service.md`). |
...
3. Pre-departure inspection has been completed (see `005_Parking-Records-Inspections-and-Return-to-Service.md`).
...
| Document | `003_Mooring-Tie-Down-and-Wind-Protection.md` (this file) |
