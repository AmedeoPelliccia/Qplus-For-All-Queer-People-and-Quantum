---
document_id: QATL-ATLAS-1000-ATLAS-010-019-01-050-012-PARKING-CONFIGURATIONS-AND-STAND-TYPES
title: "ATLAS 010-019 · 01.050.012 — Parking Configurations and Stand Types"
register: ATLAS-1000
...
language: en
---
# ATLAS 010-019 · Section 01 · Subsection 050 · Subsubject 012 — Parking Configurations and Stand Types
...
- Covers the *Parking Configurations and Stand Types* subsubject (`012`) of subsection `050` *parking* within section `01` *Manejo en Tierra & Servicio*.
...
- **Nose orientation, boarding modality, GSE positions:**
  ...
  - **Ground equipment positions while parked.** The GSE positions implied by each stand type — GPU, ACU, fuel truck, lavatory truck, water truck, catering trucks, baggage carts, belt loader — are documented as **stand-position diagrams** keyed to the stand class, with the safety perimeter inherited from [`../010_Ground-handling/`](../010_Ground-handling/010_Overview.md). Servicing flow itself remains owned by [`../020_servicing/`](../020_servicing/010_Overview.md); this subsubject defines only the *positions GSE occupies while the aircraft is parked*.
...
- **Out of scope.** Mooring and wind-protection actions applied on top of the parked configuration (subsubject `013`), the short-term/turnaround physical configuration of the aircraft itself (subsubject `014`), the records and return-to-service interface (subsubject `015`), and the GSE pool management (subsection `060`).
...
| Subsubject | `012` — Parking Configurations and Stand Types |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-MECHANICS, Q-INDUSTRY |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/000-099_ATLAS/010-019_Manejo-en-Tierra-Servicio/050_parking/` |
| Document | `012_Parking-Configurations-and-Stand-Types.md` (this file) |
