...
> **Note:** Single-gear lifts (tyre/wheel change) use `JP-NLG-C` (nose) or `JP-MLG-L` / `JP-MLG-R` individually with the aircraft otherwise supported on ground. See `016-003-Jacking-Procedures-and-Sequencing.md` §2.3 for single-gear procedure.
...
Record the pre-jacking structural interface inspection on the work order per `016-006-Lifting-Shoring-Jacking-Records-and-Traceability.md`.
...
| Document | `016-002-Jack-Points-Load-Limits-and-Aircraft-Side-Interfaces.md` (this file) |
