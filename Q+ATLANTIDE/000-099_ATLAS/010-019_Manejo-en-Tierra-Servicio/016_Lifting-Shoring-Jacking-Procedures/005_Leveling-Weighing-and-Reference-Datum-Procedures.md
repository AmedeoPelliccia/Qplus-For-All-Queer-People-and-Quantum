...
**Prerequisites:** Aircraft must be jacked to a stable three-point (or four-point for Gen 2) position per `003_Jacking-Procedures-and-Sequencing.md`. Fuel state must be known and recorded.
...
| 12 | Complete and sign W&B data sheet; submit to engineering for record update | W&B report filed per `006_Lifting-Shoring-Jacking-Records-and-Traceability.md` |
...
| Document | `005_Leveling-Weighing-and-Reference-Datum-Procedures.md` (this file) |
| Parent subsection | [`README.md`](./README.md) · [`000_Overview.md`](./000_Overview.md) |
| Jacking prerequisite | [`003_Jacking-Procedures-and-Sequencing.md`](./003_Jacking-Procedures-and-Sequencing.md) |
