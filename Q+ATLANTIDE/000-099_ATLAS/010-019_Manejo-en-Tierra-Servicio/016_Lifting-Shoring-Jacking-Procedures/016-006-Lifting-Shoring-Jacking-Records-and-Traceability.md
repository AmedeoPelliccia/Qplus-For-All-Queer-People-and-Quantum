...
| **Pre-Jacking Checklist (PJC)** | Every jacking event — completed before lift | All items in `016-003-Jacking-Procedures-and-Sequencing.md` §2.1, verified against aircraft state | Attached to corresponding JWO; same retention |
...
| Document | `016-006-Lifting-Shoring-Jacking-Records-and-Traceability.md` (this file) |
...
| Jacking procedure | [`016-003-Jacking-Procedures-and-Sequencing.md`](./016-003-Jacking-Procedures-and-Sequencing.md) |
| Shoring procedure | [`016-004-Shoring-and-Structural-Support-Procedures.md`](./016-004-Shoring-and-Structural-Support-Procedures.md) |
| Leveling and weighing | [`016-005-Leveling-Weighing-and-Reference-Datum-Procedures.md`](./016-005-Leveling-Weighing-and-Reference-Datum-Procedures.md) |
