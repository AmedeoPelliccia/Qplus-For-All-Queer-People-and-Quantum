...
Before initiating any jack operation, verify all items on the Pre-Jacking Checklist (work order attachment — see `006_Lifting-Shoring-Jacking-Records-and-Traceability.md`):

| # | Check item | Verified by |
|---|---|---|
| 1 | Aircraft weight within Maximum Jacking Weight (MJW) — AMM ch. 7 | AME / Lead mechanic |
| 2 | Jack-point locations confirmed and marked — `002_Jack-Points-Load-Limits-and-Aircraft-Side-Interfaces.md` | AME |
...
10. Complete work order documentation per `006_Lifting-Shoring-Jacking-Records-and-Traceability.md`.
...
| Document | `003_Jacking-Procedures-and-Sequencing.md` (this file) |
| Parent subsection | [`README.md`](./README.md) · [`000_Overview.md`](./000_Overview.md) |
| Jack-point reference | [`002_Jack-Points-Load-Limits-and-Aircraft-Side-Interfaces.md`](./002_Jack-Points-Load-Limits-and-Aircraft-Side-Interfaces.md) |
| Records | [`006_Lifting-Shoring-Jacking-Records-and-Traceability.md`](./006_Lifting-Shoring-Jacking-Records-and-Traceability.md) |
