...
| 8 | Record shoring installation on work order per `006_Lifting-Shoring-Jacking-Records-and-Traceability.md` | Work order entry complete |
...
| Document | `004_Shoring-and-Structural-Support-Procedures.md` (this file) |
