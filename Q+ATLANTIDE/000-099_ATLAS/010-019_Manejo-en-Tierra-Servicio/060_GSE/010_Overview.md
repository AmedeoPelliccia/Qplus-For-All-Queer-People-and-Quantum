...
The diagram below shows how this subsection's `00 Overview` aggregates the populated subsubjects (`011`–`015`) into the *GSE* slice of ATLAS `010-019`, the inversion against the five prior subsections (which **use** GSE), and the bidirectional flow of GSE-evidence records into the AEROSPACEMODEL / DPP / SSOT evidence chain.
