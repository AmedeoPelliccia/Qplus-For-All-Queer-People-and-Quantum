---
document_id: QATL-ATLAS-1000-ATLAS-010-019-01-060-05-GSE-MAINTENANCE-CALIBRATION-AND-RECORDS
title: "ATLAS 010-019 · 01.060.05 — GSE Maintenance, Calibration and Records"
register: ATLAS-1000
...
language: en
---
# ATLAS 010-019 · Section 01 · Subsection 060 · Subsubject 05 — GSE Maintenance, Calibration and Records
...
- Covers the *GSE Maintenance, Calibration and Records* subsubject (`05`) of subsection `060` *GSE* within section `01` *Manejo en Tierra & Servicio*.
- Inherits Q-Division authority and ORB support from the parent row in [`../../README.md` §3](../../README.md#3-architecture-table)[^archtable].

### 2.1 Scheduled maintenance regime

Each GSE class in the catalog (`02_`) carries a maintenance schedule keyed on the manufacturer's service manual, the operator's CMMS rules, and any AMPEL360-specific overlay (notably for the H₂ classes). The regime is structured as:
...
- `gse_class:` — the catalog class from [`./02`](./02_GSE-Catalog-and-Compatibility-Matrix.md) (e.g. `GSE-EP-*`, `GSE-FH-*`).
...
| Subsection | `060` — GSE |
| Subsubject | `05` — GSE Maintenance, Calibration and Records |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-MECHANICS, Q-INDUSTRY |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/000-099_ATLAS/010-019_Manejo-en-Tierra-Servicio/060_GSE/` |
| Document | `05_GSE-Maintenance-Calibration-and-Records.md` (this file) |
