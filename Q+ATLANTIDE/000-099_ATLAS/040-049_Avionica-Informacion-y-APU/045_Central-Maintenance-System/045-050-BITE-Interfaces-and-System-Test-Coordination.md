...
This document defines the BITE interfaces and system test coordination architecture of the CMS for the AMPEL360E eWTW aircraft. The CMS acts as the master BITE coordinator for all ATA chapter LRUs. It specifies BITE test modes (PBIT, CBIT, IBIT, MBIT), inhibit logic enforced via the LGCIU air/ground discrete, and eWTW-specific BITE coverage for EMA, EMB, MPDU, and LH2 monitoring subsystems.
...
- eWTW BITE: EMA, EMB, MPDU, LH2 monitoring BITE adapters.
...
**eWTW BITE extensions**: BITE adapters are provided for EMA, EMB, MPDU, and LH2 monitoring subsystems. These adapters translate proprietary eWTW BITE protocols to the AFDX BITE VLAN format, making eWTW subsystem health fully visible in the CMS BITE framework.
...
graph TD
    ...
    BMC --> EMA["EMA BITE Adapter (eWTW)"]
    BMC --> EMB["EMB BITE Adapter (eWTW)"]
    BMC --> MPDU["MPDU BITE Adapter (eWTW)"]
    BMC --> LH2["LH2 Monitor BITE Adapter (eWTW)"]
```
...
| EMA BITE Adapter (eWTW) | Translates EMA proprietary BITE to AFDX VLAN | CCU-A/B (SW) |
| EMB BITE Adapter (eWTW) | Translates EMB proprietary BITE to AFDX VLAN | CCU-A/B (SW) |
| MPDU BITE Adapter (eWTW) | Translates MPDU proprietary BITE to AFDX VLAN | CCU-A/B (SW) |
...
| EMA BITE | eWTW EMA system | Proprietary → AFDX adapter | Rx |
| MPDU BITE | eWTW MPDU | Proprietary → AFDX adapter | Rx |
...
| BITE subscriber count | TBD (all ATA chapters + eWTW) | <img src="https://img.shields.io/badge/TBD-red" alt="TBD"> |
| BITE no-response detection | < 2 s (PBIT window) | <img src="https://img.shields.io/badge/TBD-red" alt="TBD"> |
| eWTW BITE adapter latency | < 500 ms (proprietary → AFDX) | <img src="https://img.shields.io/badge/TBD-red" alt="TBD"> |
...
- **eWTW adapter integrity**: BITE adapter protocol translation verified by CRC check on each translated BITE frame.
...
| eWTW BITE adapters | Hosted in CCU (DO-160G qualified) | DO-160G |
...
- **eWTW BITE adapters**: DO-178C DAL C; protocol translation tables version-controlled and SHA-256 signed.
...
| eWTW BITE adapter protocol update | Gatelink or USB-C | AMM ATA 45-50-06 |
...
| eWTW BITE adapter test | 6 months | AMM ATA 45-50-06 |
...
| eWTW BITE adapters | Programme-controlled + DO-178C DAL C | <img src="https://img.shields.io/badge/To_Be_Completed-orange" alt="To Be Completed"> |
...
- eWTW BITE adapter status visible on CMP as a dedicated "eWTW BITE" panel.
...
|---------------|------------|--------|
| BITE coverage expansion | eWTW BITE adapters enable comprehensive fault detection without additional hardware | <img src="https://img.shields.io/badge/DRAFT-yellow" alt="DRAFT"> |
...
| EMB | Electric Motor Bus — electrical bus supplying propulsion motors (eWTW) |
| MPDU | Main Power Distribution Unit — primary electrical power distribution unit (eWTW) |
...
| [R4] | AMPEL360E eWTW EMA BITE Protocol Specification | TBD | <img src="https://img.shields.io/badge/TBD-red" alt="TBD"> |
| [R5] | AMPEL360E eWTW MPDU BITE Protocol Specification | TBD | <img src="https://img.shields.io/badge/TBD-red" alt="TBD"> |
...
| eWTW BITE Adapters (SW) | CCU-A/B | E/E Bay | Software only |
...
| eWTW adapters (SW) | CCU 28 V DC | AFDX BITE VLAN | No additional power draw |
