...
This document defines the monitoring, diagnostics, and external control interfaces for the APU on the **programme-defined aircraft type** aircraft, covering Built-In Test (PBIT/CBIT), Prognostic and Health Management (PHM), vibration monitoring using MEMS accelerometers, Quick Access Recorder (QAR) parameter streaming, Aircraft Communications Addressing and Reporting System (ACARS) Aircraft Health Monitoring (AHM) uplink, and Central Maintenance System (CMS, ATA 45) integration.
...
- **AHM message schema**: The ACARS AHM report format is defined in the [PROGRAMME-AIRCRAFT] AHM Schema v1.0 (operator-customisable); the schema defines parameter names, units, and encoding; airline customisation requires an AHM schema update process with APCU software change.
...
- **QAR data ownership**: All QAR data recorded by the DMU is the property of the aircraft operator; [PROGRAMME-AIRCRAFT] program does not have direct access to individual aircraft QAR data without operator consent.
...
| OI-049-080-004 | Define [PROGRAMME-AIRCRAFT] AHM schema v1.0 and submit to AOC integration partners | Q-DATAGOV | 2026-Q4 | <img src="https://img.shields.io/badge/To_Be_Completed-orange" alt="To Be Completed"> |
