---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-037-060-VACUUM-SYSTEM-INDICATION-AND-WARNING
title: "ATLAS 030-039 · 03.037.060 — Vacuum System Indication and Warning"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 037 · 060 — Vacuum System Indication and Warning

## 1. Purpose

Covers suction gauge, low-vacuum warning light, and ECAM/EICAS integration for vacuum system status and crew alerting.

## 2. Scope

- Suction gauge (inches Hg) location, range, and accuracy.
- Low-vacuum warning light threshold setting and switch type.
- ECAM/EICAS caution message for low vacuum condition.
- Inhibit phases and warning logic sequencing.
...
| Subsubject | `060` — Vacuum System Indication and Warning |
| Primary Q-Division | Q-MECHANICS[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-STRUCTURES |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/000-099_ATLAS/030-039_Proteccion-y-Sistemas-Mecanicos/037_Vacuum/` |
| Document | `037-060-Vacuum-System-Indication-and-Warning.md` (this file) |
...
flowchart TB
    ...
    THIS["037-060<br/>Vacuum System Indication and W…"]:::document
