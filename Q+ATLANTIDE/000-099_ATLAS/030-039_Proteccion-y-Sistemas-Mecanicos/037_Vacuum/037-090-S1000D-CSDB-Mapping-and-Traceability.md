...
dmc_prefix: "DMC-<PROGRAMME>-<VARIANT>-037-90"
...
This document defines the agnostic ATLAS standard-level architecture context for `037-090 — S1000D / CSDB Mapping and Traceability`.
...
> **Reduction note:** A conventional aircraft ATA 37 DMRL would contain ~60–80 DMs. The [PROGRAMME-VARIANT] DMRL is approximately half that due to the elimination of vacuum gyro instruments and autopilot vacuum servos. If OI-037-002 resolves to **dry-flush toilets**, the DMRL count drops further to ~2–5 DMs (general description + confirmed eliminations only).
...
- S1000D DMC format specification for [PROGRAMME-VARIANT] ATA 37
...
All ATA 37 [PROGRAMME-VARIANT] data modules follow this DMC format:

```
DMC-<PROGRAMME>-<VARIANT>-037-{NN}-{AA}-00{infoCode}{variant}-{lang}.xml
```

Where:
| Field | Description | Example |
|-------|-------------|---------|
| `[PROGRAMME-AIRCRAFT]-[PROGRAMME-VARIANT]` | Model identification code | Fixed |
...
| BREX document | <img src="https://img.shields.io/badge/TBD-red"> [PROGRAMME-VARIANT]-BREX-001 TBD | Not frozen |
| Publication | [PROGRAMME-AIRCRAFT] [PROGRAMME-VARIANT] AMM — Chapter 37 | Planned |
...
The following conventional ATA 37 DM categories are **explicitly eliminated** from the [PROGRAMME-VARIANT] DMRL:

| Eliminated DM Category | Conventional ATA 37 Count (est.) | Reason Eliminated | [PROGRAMME-VARIANT] Replacement |
|------------------------|----------------------------------|-------------------|-----------------|
...
|----------------|-----------|-------|----------|--------|
| DMC-<PROGRAMME>-<VARIANT>-037-00-00-00A-040A-A | 040 | Vacuum System — General Description and Operation | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-00-00-00A-040B-A | 040 | Vacuum System — [PROGRAMME-VARIANT] Design Philosophy and ATA 37 Scope Reduction | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |

### 6.2 SNS 037-10 — Vacuum Sources (EVG)

| Planned DM Code | Info Code | Title | Priority | Status |
|----------------|-----------|-------|----------|--------|
| DMC-<PROGRAMME>-<VARIANT>-037-10-00-00A-040A-A | 040 | Electric Vacuum Generator (EVG) — Description and Operation | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-10-00-00A-300A-A | 300 | EVG — Functional Test | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-10-00-00A-520A-A | 520 | EVG — Removal | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-10-00-00A-720A-A | 720 | EVG — Installation | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-10-00-00A-400A-A | 400 | EVG — Fault Isolation | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |

### 6.3 SNS 037-20 — Vacuum Distribution

| Planned DM Code | Info Code | Title | Priority | Status |
|----------------|-----------|-------|----------|--------|
| DMC-<PROGRAMME>-<VARIANT>-037-20-00-00A-040A-A | 040 | Vacuum Distribution Manifold — Description | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-20-00-00A-300A-A | 300 | Vacuum Manifold — Inspection and Leak Check | P2 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-20-00-00A-300B-A | 300 | Vacuum Line — Inspection and Leak Test (Decay Method) | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |

### 6.4 SNS 037-30 — Regulation and Shutoff

| Planned DM Code | Info Code | Title | Priority | Status |
|----------------|-----------|-------|----------|--------|
| DMC-<PROGRAMME>-<VARIANT>-037-30-00-00A-040A-A | 040 | Vacuum Relief Valve (VRV) — Description | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-30-00-00A-040B-A | 040 | Shutoff Valve (SOV) — Description | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-30-00-00A-300A-A | 300 | VRV — Pop-Test Procedure | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-30-00-00A-520A-A | 520 | VRV — Removal | P2 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-30-00-00A-720A-A | 720 | VRV — Installation | P2 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |

### 6.5 SNS 037-40 — Pumps, Ejectors, Valves, and Lines

| Planned DM Code | Info Code | Title | Priority | Status |
|----------------|-----------|-------|----------|--------|
| DMC-<PROGRAMME>-<VARIANT>-037-40-00-00A-040A-A | 040 | Non-Return Valve (NRV) — Description | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-40-00-00A-300A-A | 300 | NRV — Inspection and Leak Test | P2 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-40-00-00A-520A-A | 520 | NRV — Removal | P2 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-40-00-00A-720A-A | 720 | NRV — Installation | P2 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-40-00-00A-400A-A | 400 | Vacuum Line — Fault Isolation (leak, blockage) | P2 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |

### 6.6 SNS 037-50 — Vacuum Consumers and Interfaces

| Planned DM Code | Info Code | Title | Priority | Status |
|----------------|-----------|-------|----------|--------|
| DMC-<PROGRAMME>-<VARIANT>-037-50-00-00A-040A-A | 040 | Vacuum Consumers and System Interfaces — Description | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-50-00-00A-300A-A | 300 | EFV — Inspection | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-50-00-00A-520A-A | 520 | EFV — Removal | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-50-00-00A-720A-A | 720 | EFV — Installation | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-50-00-00A-400A-A | 400 | EFV — Fault Isolation | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |

### 6.7 SNS 037-60 — Indication and Warning

| Planned DM Code | Info Code | Title | Priority | Status |
|----------------|-----------|-------|----------|--------|
| DMC-<PROGRAMME>-<VARIANT>-037-60-00-00A-040A-A | 040 | Vacuum Indication and Warning — Description | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-60-00-00A-300A-A | 300 | CAS Alert Functional Check | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-60-00-00A-400A-A | 400 | Vacuum CAS Alert — Fault Isolation | P2 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |

### 6.8 SNS 037-70 — Ground Service and Test

| Planned DM Code | Info Code | Title | Priority | Status |
|----------------|-----------|-------|----------|--------|
| DMC-<PROGRAMME>-<VARIANT>-037-70-00-00A-040A-A | 040 | Ground Service and Test — Description | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-70-00-00A-300A-A | 300 | Waste Drain and Line Rinse Procedure | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-70-00-00A-300B-A | 300 | Vacuum System Functional Test | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-70-00-00A-300C-A | 300 | VRV Pop-Test | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-70-00-00A-300D-A | 300 | Vacuum Decay Leak Test | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-70-00-00A-400A-A | 400 | Vacuum System Ground Fault Isolation | P2 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |

### 6.9 SNS 037-80 — Monitoring and Diagnostics

| Planned DM Code | Info Code | Title | Priority | Status |
|----------------|-----------|-------|----------|--------|
| DMC-<PROGRAMME>-<VARIANT>-037-80-00-00A-040A-A | 040 | Monitoring and Diagnostics — Description | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-80-00-00A-300A-A | 300 | CMC / OMS Monitoring Check | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-80-00-00A-400A-A | 400 | Fault Isolation — EVG Fault | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-80-00-00A-400B-A | 400 | Fault Isolation — EFV Fault | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
| DMC-<PROGRAMME>-<VARIANT>-037-80-00-00A-400C-A | 400 | Fault Isolation — Transducer Fault | P2 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |

### 6.10 SNS 037-90 — S1000D / CSDB Mapping

| Planned DM Code | Info Code | Title | Priority | Status |
|----------------|-----------|-------|----------|--------|
| DMC-<PROGRAMME>-<VARIANT>-037-90-00-00A-040A-A | 040 | S1000D / CSDB Mapping and Traceability — Description | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
...
flowchart LR
    ...
    CSDB -->|BREX validation| BREX[[PROGRAMME-VARIANT] BREX TBD]
    CSDB -->|Publication| AMM[[PROGRAMME-AIRCRAFT] [PROGRAMME-VARIANT]\nAMM Chapter 37\nPDF / IETP TBD]
...
| IF-037-090-002 | BREX | CSDB ↔ BREX | All DMs validated against [PROGRAMME-VARIANT] BREX before publication | <img src="https://img.shields.io/badge/TBD-red"> |
...
- **BREX enforcement:** All DMs validated against [PROGRAMME-VARIANT] BREX before CSDB ingestion (automated tooling TBD).
...
| 037-00-…-040B | 037-00 | 040 | [PROGRAMME-VARIANT] Scope Reduction | P1 | <img src="https://img.shields.io/badge/To_Be_Completed-orange"> |
...
| S1000D BREX compliance | [PROGRAMME-VARIANT] BREX TBD | Automated BREX validation | <img src="https://img.shields.io/badge/TBD-red"> |
...
| Term | Definition |
|------|-----------|
| ADIRU | Air Data Inertial Reference Unit — solid-state; gyro vacuum DMs eliminated on [PROGRAMME-VARIANT] |
...
| Gyroscopic instruments | Vacuum-driven AI, DI, TC — **eliminated on [PROGRAMME-VARIANT]**; no gyro vacuum DMs in DMRL |
...
| OI-DMRL-002 | **BREX document TBD** — [PROGRAMME-VARIANT] BREX not yet created; required for CSDB validation | Tech Pubs | HIGH | <img src="https://img.shields.io/badge/TBD-red"> |
...
---
*Q+ATLANTIDE ATLAS — ATA 37 Vacuum — 037-090 S1000D / CSDB Mapping and Traceability — [PROGRAMME-AIRCRAFT] [PROGRAMME-VARIANT]*
*Classification: UNCLASSIFIED — ENGINEERING SCAFFOLD*
