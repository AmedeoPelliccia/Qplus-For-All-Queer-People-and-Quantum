---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-037-070-VACUUM-GROUND-SERVICE-AND-TEST-INTERFACES
title: "ATLAS 030-039 · 03.037.070 — Vacuum Ground Service and Test Interfaces"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 037 · 070 — Vacuum Ground Service and Test Interfaces

## 1. Purpose

Documents ground test connections, system leak check procedures, pump servicing points, and interface with ground support equipment.

## 2. Scope

- Ground vacuum source connection port and coupling type.
- System leak test procedure: vacuum source, hold time, acceptance criteria.
- Pump oil servicing point location (oil-lubricated pumps) and interval.
- Filter inspection and replacement procedure references.
- Not in scope: engine ground run requirements.
...
| Subsubject | `070` — Vacuum Ground Service and Test Interfaces |
| Primary Q-Division | Q-MECHANICS[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-STRUCTURES |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/000-099_ATLAS/030-039_Proteccion-y-Sistemas-Mecanicos/037_Vacuum/` |
| Document | `037-070-Vacuum-Ground-Service-and-Test-Interfaces.md` (this file) |
...
flowchart TB
    ...
    THIS["037-070<br/>Vacuum Ground Service and Test…"]:::document
