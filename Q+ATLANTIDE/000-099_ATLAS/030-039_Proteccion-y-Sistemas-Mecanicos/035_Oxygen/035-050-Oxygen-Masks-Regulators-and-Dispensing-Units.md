...
dmc_prefix: "DMC-AMPEL360E-EWTW-035-50"
...
This document describes the Oxygen Masks, Regulators, and Dispensing Units (ATA 35-50) as implemented on the AMPEL360e Wide Tube-and-Wing (eWTW) fully electric aircraft. It covers the crew quick-donning masks (QDM) and diluter-demand regulators at flight deck stations, the passenger continuous-flow masks dispensed from PSU overhead panels, the PSU dispensing unit mechanism, and the portable PBE integrated mask/hood assembly. It also describes the oxygen mask microphone interface with the communications system (ATA 23).
...
| ATA Subsubject | 035-50 — Oxygen Masks, Regulators, and Dispensing Units |
| Crew Mask Type | Quick-Donning Mask (QDM) — full-face or oro-nasal (TBD) |
| Crew Regulator Type | Diluter-demand with 100% O₂ and pressure-demand modes |
| Crew Stations | Pilot 1, Pilot 2, Observer (TBD) |
| Pax Mask Type | Continuous-flow oro-nasal mask |
| Pax Mask Count | 3–4 per PSU COG unit (over-provision per CS-25.1447) |
| Pax Mask Tubing | Flexible lightweight — length TBD (sufficient for seated adult) |
| PBE Mask | Integrated hood — part of PBE unit (see 035-030) |
| Donning Time | Crew QDM: ≤ 5 sec one-handed (CS-25.1447) |
| Certification Basis | CS-25.1443, CS-25.1445, CS-25.1447 |
| S1000D SNS | 035-50 |
...
Three categories of oxygen mask and regulator equipment are fitted to the AMPEL360e eWTW:
...
| oro-nasal mask | A mask covering only the nose and mouth (not the eyes); used for both crew and passenger masks on the eWTW |
