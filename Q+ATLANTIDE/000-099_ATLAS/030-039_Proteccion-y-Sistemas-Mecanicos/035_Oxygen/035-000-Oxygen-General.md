---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-035-000-OXYGEN-GENERAL
title: "ATLAS 030-039 · 03.035.000 — Oxygen General"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 035 · 000 — Oxygen General

## 1. Purpose

Scope and overview of the oxygen systems chapter per ATA 35. Covers all crew, passenger, and portable oxygen equipment, storage, distribution, and monitoring functions installed in the aircraft.

## 2. Scope

- Defines the ATA 35 scope, oxygen system architecture (gaseous, chemical, LOX), and design philosophy.
- Lists applicable certification standards: CS-25.1441–25.1453, FAR 25.1441, AS8025, AS8047.
- Identifies Q-Division authority (Q-MECHANICS) and supporting divisions.
- Not in scope: pressurization system (ATA 21) or hazardous-materials handling beyond aircraft oxygen systems.
...
flowchart TB
    ...
    THIS["035-000<br/>Oxygen General"]:::document
