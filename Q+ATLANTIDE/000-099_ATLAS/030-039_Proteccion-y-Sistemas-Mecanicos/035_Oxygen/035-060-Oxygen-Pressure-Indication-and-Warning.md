---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-035-060-OXYGEN-PRESSURE-INDICATION-AND-WARNING
title: "ATLAS 030-039 · 03.035.060 — Oxygen Pressure Indication and Warning"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 035 · 060 — Oxygen Pressure Indication and Warning

## 1. Purpose

Covers pressure transducers, remote quantity gauges, low-pressure warning sensors, ECAM/EICAS alert integration, and crew advisory messages for oxygen system status.

## 2. Scope

- Pressure transducer specifications and accuracy class.
- Remote oxygen quantity indicator location and scale.
- Low-pressure warning threshold setting and hysteresis.
- ECAM/EICAS alert text and aural tone for oxygen low-pressure condition.
- Not in scope: oxygen BITE / diagnostics (subsubject 080) or mask deployment status.
...
| Subsubject | `060` — Oxygen Pressure Indication and Warning |
| Primary Q-Division | Q-MECHANICS[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-STRUCTURES |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/000-099_ATLAS/030-039_Proteccion-y-Sistemas-Mecanicos/035_Oxygen/` |
| Document | `035-060-Oxygen-Pressure-Indication-and-Warning.md` (this file) |
...
flowchart TB
    ...
    THIS["035-060<br/>Oxygen Pressure Indication and…"]:::document
