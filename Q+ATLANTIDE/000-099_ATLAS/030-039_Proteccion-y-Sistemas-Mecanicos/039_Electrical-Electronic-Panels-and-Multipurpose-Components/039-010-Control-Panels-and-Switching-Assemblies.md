---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-039-010-CONTROL-PANELS-AND-SWITCHING-ASSEMBLIES
title: "ATLAS 030-039 · 03.039.010 — Control Panels and Switching Assemblies"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 039 · 010 — Control Panels and Switching Assemblies

## 1. Purpose

Documents the overhead, centre pedestal, and instrument panel switching assemblies: toggle switches, pushbutton indicators, rotary selectors, and guard covers.

## 2. Scope

- Panel substrate material (aluminium, composite), finish, and placard requirements.
- Switch and pushbutton indicator specifications: rating, illumination type (LED), colour coding.
- Rotary selector switch detent torque and contact arrangement.
- Guard cover design for safety-critical switches.
- Not in scope: display units and controllers covered by ATA 31.
...
| Subsubject | `010` — Control Panels and Switching Assemblies |
...
| Document | `039-010-Control-Panels-and-Switching-Assemblies.md` (this file) |
...
flowchart TB
    ...
    THIS["039-010<br/>Control Panels and Switching A…"]:::document
