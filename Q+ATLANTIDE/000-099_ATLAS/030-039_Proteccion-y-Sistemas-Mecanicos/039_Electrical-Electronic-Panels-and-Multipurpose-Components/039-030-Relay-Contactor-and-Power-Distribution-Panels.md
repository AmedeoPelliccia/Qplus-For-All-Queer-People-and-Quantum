---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-039-030-RELAY-CONTACTOR-AND-POWER-DISTRIBUTION-PANELS
title: "ATLAS 030-039 · 03.039.030 — Relay, Contactor and Power Distribution Panels"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 039 · 030 — Relay, Contactor and Power Distribution Panels

## 1. Purpose

Documents relay panels, contactor assemblies, bus-tie contactors, and power distribution panels including their housing design, terminal identification, and installation.

## 2. Scope

- Relay and contactor rating (voltage, current, cycle life) and coil specification.
- Power distribution panel bus bar material, cross-section, and insulation.
- Terminal block identification and wiring diagram reference.
- Thermal protection and ambient temperature derating.
- Not in scope: generator and battery systems (ATA 24).
...
| Subsubject | `030` — Relay, Contactor and Power Distribution Panels |
...
| Document | `039-030-Relay-Contactor-and-Power-Distribution-Panels.md` (this file) |
...
flowchart TB
    ...
    THIS["039-030<br/>Relay Contactor and Power Dist…"]:::document
