---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-033-030-CARGO-AND-SERVICE-COMPARTMENT-LIGHTING
title: "ATLAS 030-039 · 03.033.030 — Cargo and Service Compartment Lighting"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 033 · 030 — Cargo and Service Compartment Lighting

## 1. Purpose

Documents cargo hold lighting, belly compartment work lights, and service access area lighting for ground personnel.

## 2. Scope

- Cargo hold overhead fluorescent/LED strip layout and coverage zones.
- Light intensity levels for loading, inspection, and security checks.
- Service access panels and landing gear bay lighting (where applicable).
- Ground crew controlled switches and safety interlock provisions.
- Not in scope: forward equipment bay lighting (covered by individual system chapters).
...
| Subsubject | `030` — Cargo and Service Compartment Lighting |
| Primary Q-Division | Q-MECHANICS[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-STRUCTURES |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/000-099_ATLAS/030-039_Proteccion-y-Sistemas-Mecanicos/033_Lights/` |
| Document | `033-030-Cargo-and-Service-Compartment-Lighting.md` (this file) |
...
flowchart TB
    ...
    THIS["033-030<br/>Cargo and Service Compartment …"]:::document
