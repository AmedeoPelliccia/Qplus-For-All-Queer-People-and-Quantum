---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-033-080-LIGHTS-MONITORING-DIAGNOSTICS-AND-CONTROL-INTERFACES
title: "ATLAS 030-039 · 03.033.080 — Lights Monitoring, Diagnostics and Control Interfaces"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 033 · 080 — Lights Monitoring, Diagnostics and Control Interfaces

## 1. Purpose

Covers lamp/LED failure detection, BITE functions, fault reporting to the on-board maintenance system, and integration with the aircraft health monitoring network.

## 2. Scope

- Lamp-failed detection method (current sensing, photodetector) per zone.
- Fault code generation and routing to CFDS/OMS via ARINC 429 or AFDX.
- BITE test modes (automatic, manual) and minimum equipment list (MEL) support.
- Crew and maintenance alerts for lighting failures.
...
| Subsubject | `080` — Lights Monitoring, Diagnostics and Control Interfaces |
| Primary Q-Division | Q-MECHANICS[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-STRUCTURES |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/000-099_ATLAS/030-039_Proteccion-y-Sistemas-Mecanicos/033_Lights/` |
| Document | `033-080-Lights-Monitoring-Diagnostics-and-Control-Interfaces.md` (this file) |
...
flowchart TB
    ...
    THIS["033-080<br/>Lights Monitoring Diagnostics …"]:::document
