---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-038-050-TOILET-AND-VACUUM-WASTE-SYSTEM
title: "ATLAS 030-039 · 03.038.050 — Toilet and Vacuum Waste System"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 038 · 050 — Toilet and Vacuum Waste System

## 1. Purpose

Documents the vacuum-generated waste collection system including vacuum generators, waste tank, flush valves, rinse water supply, and odour control.

## 2. Scope

- Vacuum generator type (motor/blower) and differential pressure requirement.
- Waste tank capacity, material, and pressure rating.
- Flush valve actuation: electric or pneumatic, and flush cycle timing.
- Rinse water demand and connection to potable water circuit.
- Tank full indicator and over-fill protection.
- Not in scope: grey-water drainage (subsubject 040).
...
| Subsubject | `050` — Toilet and Vacuum Waste System |
...
| Document | `038-050-Toilet-and-Vacuum-Waste-System.md` (this file) |
...
flowchart TB
    ...
    THIS["038-050<br/>Toilet and Vacuum Waste System"]:::document
