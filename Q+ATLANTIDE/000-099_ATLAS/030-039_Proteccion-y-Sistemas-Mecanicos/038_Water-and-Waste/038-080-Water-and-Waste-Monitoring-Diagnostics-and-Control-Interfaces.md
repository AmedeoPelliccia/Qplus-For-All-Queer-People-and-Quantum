---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-038-080-WATER-AND-WASTE-MONITORING-DIAGNOSTICS-AND-CONTROL-INTERFACES
title: "ATLAS 030-039 · 03.038.080 — Water and Waste Monitoring, Diagnostics and Control Interfaces"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 038 · 080 — Water and Waste Monitoring, Diagnostics and Control Interfaces

## 1. Purpose

Covers BITE functions of water/waste controllers, fault code routing to the on-board maintenance system, and integration with the aircraft health-monitoring network.

## 2. Scope

- Water system controller / smart valve BITE architecture.
...
- MEL dispatch provisions for water or waste system faults.
...
| Subsubject | `080` — Water and Waste Monitoring, Diagnostics and Control Interfaces |
...
| Document | `038-080-Water-and-Waste-Monitoring-Diagnostics-and-Control-Interfaces.md` (this file) |
...
flowchart TB
    ...
    THIS["038-080<br/>Water and Waste Monitoring Dia…"]:::document
