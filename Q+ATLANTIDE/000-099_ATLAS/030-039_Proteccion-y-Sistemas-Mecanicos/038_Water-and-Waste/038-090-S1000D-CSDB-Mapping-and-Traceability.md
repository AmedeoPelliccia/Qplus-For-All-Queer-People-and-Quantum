---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-038-090-S1000D-CSDB-MAPPING-AND-TRACEABILITY
title: "ATLAS 030-039 · 03.038.090 — S1000D CSDB Mapping and Traceability"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 038 · 090 — S1000D CSDB Mapping and Traceability

## 1. Purpose

Controlled mapping of ATA 38 subsubjects (038-000 through 038-080) to S1000D Issue 6.0 Data Module Codes (DMC), CSDB publication objects, and applicable ATA iSpec 2200 cross-references.

## 2. Scope

- DMC model-identification code assignment for ATA 38 data modules.
...
| Document | `038-090-S1000D-CSDB-Mapping-and-Traceability.md` (this file) |
...
flowchart TB
    ...
    THIS["038-090<br/>S1000D CSDB Mapping and Tracea…"]:::document
