---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-038-040-WASTE-WATER-DRAINAGE
title: "ATLAS 030-039 · 03.038.040 — Waste Water Drainage"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 038 · 040 — Waste Water Drainage

## 1. Purpose

Covers grey-water collection from galley sinks and lavatory wash basins, drain mast(s), evaporative drain plates, and freeze protection for drain lines.

## 2. Scope

- Grey-water drain line routing and gradient.
- Drain mast type (heated, unheated) and exterior location.
- Evaporative drain plate installation below structural skin.
- Drain line freeze protection: electric heating elements or insulation.
- Not in scope: vacuum waste system (subsubject 050) or black-water tanks.
...
| Subsubject | `040` — Waste Water Drainage |
...
| Document | `038-040-Waste-Water-Drainage.md` (this file) |
...
flowchart TB
    ...
    THIS["038-040<br/>Waste Water Drainage"]:::document
