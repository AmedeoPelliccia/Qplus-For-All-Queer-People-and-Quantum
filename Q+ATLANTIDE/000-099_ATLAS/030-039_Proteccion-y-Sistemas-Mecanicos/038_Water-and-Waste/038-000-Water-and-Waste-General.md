---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-038-000-WATER-AND-WASTE-GENERAL
title: "ATLAS 030-039 · 03.038.000 — Water and Waste General"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 038 · 000 — Water and Waste General

## 1. Purpose

Scope and overview of the water and waste systems chapter per ATA 38. Covers potable water supply, distribution, heating, and all waste collection and drainage functions installed in the aircraft.

## 2. Scope

- Defines the ATA 38 scope, water and waste system architecture, and design philosophy.
- Lists applicable certification standards: CS-25.1557, FAR 25.1557, and applicable sanitation standards.
- Identifies Q-Division authority (Q-MECHANICS) and supporting divisions.
- Not in scope: pressurization system (ATA 21), or galley equipment (ATA 25).
...
| Subsubject | `000` — Water and Waste General |
...
| Document | `038-000-Water-and-Waste-General.md` (this file) |
...
flowchart TB
    ...
    THIS["038-000<br/>Water and Waste General"]:::document
