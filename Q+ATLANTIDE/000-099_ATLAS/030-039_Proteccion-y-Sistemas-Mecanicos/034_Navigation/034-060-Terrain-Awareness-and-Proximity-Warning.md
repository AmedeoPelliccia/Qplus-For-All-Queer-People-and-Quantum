---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-034-060-TERRAIN-AWARENESS-AND-PROXIMITY-WARNING
title: "ATLAS 030-039 · 03.034.060 — Terrain Awareness and Proximity Warning"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 034 · 060 — Terrain Awareness and Proximity Warning

## 1. Purpose

Covers Enhanced Ground Proximity Warning System (EGPWS/TAWS), terrain database management, look-ahead terrain alerting modes, and crew display integration per EUROCAE ED-119B.

## 2. Scope

- TAWS Mode 1–7 warning criteria and aural/visual annunciation.
- Look-ahead terrain and obstacle alerting using internal GNSS position and terrain database.
- Terrain database update cycle and CRC validation.
- ARINC 429 / AFDX interface labels (radio altitude, gear position, flap position, glideslope).
- Not in scope: terrain map display rendering (ATA 31) or weather radar (subsubject 070).
...
| Subsubject | `060` — Terrain Awareness and Proximity Warning |
| Primary Q-Division | Q-MECHANICS[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-STRUCTURES |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/000-099_ATLAS/030-039_Proteccion-y-Sistemas-Mecanicos/034_Navigation/` |
| Document | `034-060-Terrain-Awareness-and-Proximity-Warning.md` (this file) |
...
flowchart TB
    ...
    THIS["034-060<br/>Terrain Awareness and Proximit…"]:::document
