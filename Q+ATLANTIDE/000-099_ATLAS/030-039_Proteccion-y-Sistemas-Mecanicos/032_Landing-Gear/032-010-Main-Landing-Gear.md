---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-032-010-MAIN-LANDING-GEAR
title: "ATLAS 030-039 · 03.032.010 — Main Landing Gear"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 032 · 010 — Main Landing Gear

## 1. Purpose

Documents the main gear assemblies including shock struts, side-stays, drag-stays, trunnion attachments, and retraction/extension kinematics.

## 2. Scope

- Shock strut (oleo-pneumatic) design parameters, stroke, and servicing.
- Side-stay and drag-stay geometry, load path, and lock mechanisms.
- Trunnion-to-wing-box attachment interface and load distribution.
- Retraction direction, stowage envelope, and door sequencing.
- Not in scope: brake system detail (subsubject 040) or wheel/tire (subsubject 040).
...
flowchart TB
    ...
    THIS["032-010<br/>Main Landing Gear"]:::document
