---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-032-060-POSITION-INDICATION-AND-WARNING
title: "ATLAS 030-039 · 03.032.060 — Position Indication and Warning"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 032 · 060 — Position Indication and Warning

## 1. Purpose

Documents gear position proximity sensors (squat switches, uplocks, downlocks), Gear Unsafe Warning system, and Landing Gear Control and Indication Panel (LGCIP).

## 2. Scope

- Proximity switch / RVDT sensor locations on each gear and door.
- Gear-unsafe warning horn logic and inhibit conditions.
- LGCIP lamp/LED layout and test function.
- Weight-on-Wheels (WOW) discrete routing to aircraft systems.
- Not in scope: BITE / diagnostics integration (subsubject 080).
...
flowchart TB
    ...
    THIS["032-060<br/>Position Indication and Warning"]:::document
