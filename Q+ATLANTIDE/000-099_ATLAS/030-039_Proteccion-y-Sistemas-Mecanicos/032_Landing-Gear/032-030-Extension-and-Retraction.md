---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-032-030-EXTENSION-AND-RETRACTION
title: "ATLAS 030-039 · 03.032.030 — Extension and Retraction"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 032 · 030 — Extension and Retraction

## 1. Purpose

Covers the hydraulic actuation circuits, up-locks, down-locks, emergency free-fall extension system, and gear sequencing logic for all landing gear assemblies.

## 2. Scope

- Hydraulic selector valve and actuator circuit (normal extension/retraction).
- Up-lock and down-lock mechanisms, load sensing, and override.
- Emergency free-fall / gravity extension: gravity assist, manual selector, and airspeed limits.
- Gear sequencing controller logic and failure-mode analysis.
- Not in scope: hydraulic power generation (ATA 29) or door actuation logic beyond gear sequencing.
...
flowchart TB
    ...
    THIS["032-030<br/>Extension and Retraction"]:::document
