---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-032-080-LANDING-GEAR-MONITORING-DIAGNOSTICS-AND-CONTROL-INTERFACES
title: "ATLAS 030-039 · 03.032.080 — Landing Gear Monitoring, Diagnostics and Control Interfaces"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 032 · 080 — Landing Gear Monitoring, Diagnostics and Control Interfaces

## 1. Purpose

Covers Weight-on-Wheels (WOW) discrete network, Brake and Steering Control Unit (BSCU) BITE, gear health monitoring, and data-bus interfaces to the on-board maintenance system.

## 2. Scope

- WOW signal routing to FMS, FMGEC, FADEC, hydraulics, and pneumatics.
- BSCU BITE architecture, fault codes, and post-flight report generation.
- Gear health monitoring parameters: strut pressure, brake temperature, tire pressure.
- ARINC 429 / AFDX data bus interface labels and data rates.
...
| Subsubject | `080` — Landing Gear Monitoring, Diagnostics and Control Interfaces |
| Primary Q-Division | Q-MECHANICS[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-STRUCTURES |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/000-099_ATLAS/030-039_Proteccion-y-Sistemas-Mecanicos/032_Landing-Gear/` |
| Document | `032-080-Landing-Gear-Monitoring-Diagnostics-and-Control-Interfaces.md` (this file) |
...
flowchart TB
    ...
    THIS["032-080<br/>Landing Gear Monitoring Diagno…"]:::document
