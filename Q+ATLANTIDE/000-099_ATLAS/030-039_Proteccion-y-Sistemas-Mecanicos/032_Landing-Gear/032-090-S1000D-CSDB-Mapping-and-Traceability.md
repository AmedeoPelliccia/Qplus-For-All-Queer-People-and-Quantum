...
dmc_prefix: "DMC-<PROGRAMME>-<VARIANT>-032-90"
...
This document defines the agnostic ATLAS standard-level architecture context for `032-090 — S1000D CSDB Mapping and Traceability`.
...
**S1000D DMC Structure**: A Data Module Code (DMC) uniquely identifies each Data Module (DM) in the CSDB. For the [PROGRAMME-AIRCRAFT] [PROGRAMME-VARIANT], the DMC structure follows the standard S1000D format:

`DMC-{ModelIdent}-{SNS}-{disassyCode}-{disassyCodeVariant}-{infoCode}-{infoCodeVariant}-{itemLocationCode}`

For ATA 32, the `{ModelIdent}` is `[PROGRAMME-AIRCRAFT]-[PROGRAMME-VARIANT]`, the SNS codes are in the range `032-00` through `032-90` (two-digit sub-subassembly). The disassembly code, info code, and item location code are assigned per the DMRL.

**SNS to ATA Mapping**: The ATA 32 subsubject numbering used in Q+ATLANTIDE ATLAS (032-000 through 032-090) maps directly to the S1000D SNS by truncating the trailing zero of the subsubject number. For example, ATA subsubject 032-010 maps to SNS 032-10, and the DMC prefix is `DMC-<PROGRAMME>-<VARIANT>-032-10`.
...
**BREX**: The [PROGRAMME-VARIANT] BREX (Business Rules Exchange Object) defines programme-specific deviations from S1000D baseline business rules, including: applicability model; security classification conventions; graphics format; applicability annotation format. The ATA 32 content must comply with the [PROGRAMME-VARIANT] BREX when the BREX is released. Until then, scaffolding follows default S1000D Issue 4.2 rules.
...
- Publication module hierarchy for ATA 32 in the [PROGRAMME-AIRCRAFT] [PROGRAMME-VARIANT] CSDB
...
- CSDB administration (user management, version control) — managed by the [PROGRAMME-AIRCRAFT] documentation programme office
...
- **Effectivity model**: Applicability (which MSN/aircraft variant a DM applies to) is managed per the [PROGRAMME-VARIANT] effectivity annotation model (TBD). Baseline: DMC applies to all [PROGRAMME-VARIANT]-100/100ER MSNs from MSN 001 unless annotated otherwise.
...
| F-090-004 | BREX Compliance | Confirm [PROGRAMME-VARIANT] BREX applicability to ATA 32 content; resolve BREX deviations | 032-090 |
...
```mermaid
flowchart LR
    ATLAS[Q+ATLANTIDE ATLAS 032 Scaffold Files] -->|Source content for description DMs| CSDB[[PROGRAMME-AIRCRAFT] CSDB]
    ...
    BREX[[PROGRAMME-VARIANT] BREX] -->|Business rules govern content| CSDB
...
|---|---|---|---|---|---|
| IF-090-001 | [PROGRAMME-AIRCRAFT] CSDB | System / tool | DMC import/export; DM authoring and approval workflow | ATLAS → CSDB | <img src="https://img.shields.io/badge/TBD-red"> |
| IF-090-002 | [PROGRAMME-VARIANT] BREX | Data | Business rule compliance check against BREX object | CSDB ← BREX | <img src="https://img.shields.io/badge/TBD-red"> |
...
BREX validation is performed automatically by the CSDB authoring tool against the [PROGRAMME-VARIANT] BREX object. BREX violations are reported per DM; a DM with BREX violations cannot be approved. BREX compliance is monitored as a KPI for the ATA 32 documentation team.

---

## §13 Maintenance Concept

The S1000D CSDB for ATA 32 is maintained under version control in the [PROGRAMME-AIRCRAFT] CSDB management system (TBD). Revisions to DMCs are controlled by the documentation change process — a change request (CR) is raised for each technical change, the affected DMs are revised, reviewed, and re-approved. In-service revisions driven by Service Bulletins (SBs) must be incorporated into the AMM within the timescale defined by the EASA-approved revision procedure.
...
|---|---|---|---|---|---|---|
| 032-000 — General | 032-000-Landing-Gear-General.md | 032-00 | DMC-<PROGRAMME>-<VARIANT>-032-00 | 040, 300, 400 | 3 | <img src="https://img.shields.io/badge/TBD-red"> |
| 032-010 — Main Landing Gear | 032-010-Main-Landing-Gear.md | 032-10 | DMC-<PROGRAMME>-<VARIANT>-032-10 | 040, 300, 400, 520, 720 | 5 | <img src="https://img.shields.io/badge/TBD-red"> |
| 032-020 — Nose Landing Gear | 032-020-Nose-Landing-Gear.md | 032-20 | DMC-<PROGRAMME>-<VARIANT>-032-20 | 040, 300, 400, 520, 720 | 5 | <img src="https://img.shields.io/badge/TBD-red"> |
| 032-030 — Extension and Retraction | 032-030-Extension-and-Retraction.md | 032-30 | DMC-<PROGRAMME>-<VARIANT>-032-30 | 040, 300, 400, 520 | 4 | <img src="https://img.shields.io/badge/TBD-red"> |
| 032-040 — Wheels, Tires, and Brakes | 032-040-Wheels-Tires-and-Brakes.md | 032-40 | DMC-<PROGRAMME>-<VARIANT>-032-40 | 040, 300, 400, 520, 720 | 5 | <img src="https://img.shields.io/badge/TBD-red"> |
| 032-050 — Steering | 032-050-Steering.md | 032-50 | DMC-<PROGRAMME>-<VARIANT>-032-50 | 040, 300, 400, 520 | 4 | <img src="https://img.shields.io/badge/TBD-red"> |
| 032-060 — Position Indication and Warning | 032-060-Position-Indication-and-Warning.md | 032-60 | DMC-<PROGRAMME>-<VARIANT>-032-60 | 040, 300, 400, 520 | 4 | <img src="https://img.shields.io/badge/TBD-red"> |
| 032-070 — Shock Absorption and Structural Interfaces | 032-070-Shock-Absorption-and-Structural-Interfaces.md | 032-70 | DMC-<PROGRAMME>-<VARIANT>-032-70 | 040, 300, 400, 520, 720 | 5 | <img src="https://img.shields.io/badge/TBD-red"> |
| 032-080 — LG Monitoring, Diagnostics, and Control Interfaces | 032-080-Landing-Gear-Monitoring-Diagnostics-and-Control-Interfaces.md | 032-80 | DMC-<PROGRAMME>-<VARIANT>-032-80 | 040, 300, 400, 520 | 4 | <img src="https://img.shields.io/badge/TBD-red"> |
| 032-090 — S1000D CSDB Mapping and Traceability | 032-090-S1000D-CSDB-Mapping-and-Traceability.md | 032-90 | DMC-<PROGRAMME>-<VARIANT>-032-90 | 040 | 1 | <img src="https://img.shields.io/badge/TBD-red"> |
| **TOTAL** | | | | | **40 est.** | |
...
- CSDB: managed in [PROGRAMME-AIRCRAFT] CSDB (TBD)
...
| S1000D Brex | S1000D programme | CSDB content must comply with [PROGRAMME-VARIANT] BREX | BREX validated against all ATA 32 DMs before approval | <img src="https://img.shields.io/badge/TBD-red"> |
| Programme QMS | [PROGRAMME-AIRCRAFT] | CSDB document control follows programme quality management system | DM approval workflow configured in CSDB tool | <img src="https://img.shields.io/badge/TBD-red"> |
...
|---|---|---|---|
| CIT-090-001 | S1000D Issue 4.2 | International specification for technical publications | Governing S1000D standard for [PROGRAMME-AIRCRAFT] [PROGRAMME-VARIANT] publications |
...
| OI-090-002 | [PROGRAMME-AIRCRAFT] CSDB tool not selected — impacts DMRL format, BREX validation method, authoring workflow | Documentation | High | TBD | <img src="https://img.shields.io/badge/TBD-red"> |
| OI-090-003 | [PROGRAMME-VARIANT] BREX not yet produced — all DMs formally non-compliant until BREX released | Documentation | High | TBD | <img src="https://img.shields.io/badge/TBD-red"> |
