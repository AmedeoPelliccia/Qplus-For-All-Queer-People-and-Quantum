---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-036-020-PNEUMATIC-AIR-DISTRIBUTION
title: "ATLAS 030-039 · 03.036.020 — Pneumatic Air Distribution"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 036 · 020 — Pneumatic Air Distribution

## 1. Purpose

Documents the bleed-air manifold, cross-feed valve, isolation valves, and ducting routing that distributes conditioned bleed air to air-conditioning, anti-icing, pressurisation, and other consumer systems.

## 2. Scope

- Bleed manifold design pressure, temperature rating, and material.
- Cross-feed valve operation: normal, closed, and cross-bleed start modes.
- Isolation valve location and control logic for each consumer system.
- Duct routing and support clamp specifications.
- Not in scope: air-conditioning pack inlet (ATA 21) or wing anti-ice valve (ATA 30).
...
flowchart TB
    ...
    THIS["036-020<br/>Pneumatic Air Distribution"]:::document
