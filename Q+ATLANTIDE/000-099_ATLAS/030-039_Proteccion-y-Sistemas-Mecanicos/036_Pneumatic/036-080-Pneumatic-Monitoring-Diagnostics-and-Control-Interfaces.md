---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-036-080-PNEUMATIC-MONITORING-DIAGNOSTICS-AND-CONTROL-INTERFACES
title: "ATLAS 030-039 · 03.036.080 — Pneumatic Monitoring, Diagnostics and Control Interfaces"
register: ATLAS-1000
...
# ATLAS 030-039 · Section 03 · Subsection 036 · 080 — Pneumatic Monitoring, Diagnostics and Control Interfaces

## 1. Purpose

Covers Pneumatic System Controller (PSC) BITE, pressure/temperature sensor BITE, fault code routing to the on-board maintenance system, and ARINC 429/AFDX data bus integration.

## 2. Scope

- PSC BITE architecture: power-up self-test, continuous monitoring, and latched faults.
...
- MEL dispatch provisions for bleed valve or sensing faults.
...
| Subsubject | `080` — Pneumatic Monitoring, Diagnostics and Control Interfaces |
| Primary Q-Division | Q-MECHANICS[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-STRUCTURES |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/000-099_ATLAS/030-039_Proteccion-y-Sistemas-Mecanicos/036_Pneumatic/` |
| Document | `036-080-Pneumatic-Monitoring-Diagnostics-and-Control-Interfaces.md` (this file) |
...
flowchart TB
    ...
    THIS["036-080<br/>Pneumatic Monitoring Diagnosti…"]:::document
