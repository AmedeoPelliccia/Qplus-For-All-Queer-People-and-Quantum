---
document_id: QATL-ATLAS-1000-ATLAS-030-039-03-031-000-INDICATING-AND-RECORDING-GENERAL
title: "ATLAS 030-039 · 03.031.000 — Indicating and Recording General"
register: ATLAS-1000
...
subsubject: "000"
subsubject_title: "Indicating and Recording General"
...
# ATLAS 030-039 · Section 03 · Subsection 031 · 000 — Indicating and Recording General

## 1. Purpose

Scope and overview of the indicating and recording systems chapter per ATA 31. Covers all instruments, displays, recorders, and data-acquisition equipment installed on the aircraft.

## 2. Scope

- Defines the scope, architectural intent, and inter-system dependencies of ATA 31.
- Establishes controlled vocabulary for indicators, displays, recorders, and data-acquisition units.
- Identifies applicable regulatory and industry standards (EUROCAE, RTCA, EASA CS-25 AMC).
- Not in scope: autopilot and auto-flight logic (ATA 22), navigation sensors (ATA 34), or on-board maintenance system (ATA 45).
...
| Subsubject | `000` — Indicating and Recording General |
...
| Document | `031-000-Indicating-and-Recording-General.md` (this file) |
...
flowchart TB
    ...
    THIS["031-000<br/>Indicating and Recording General"]:::document
