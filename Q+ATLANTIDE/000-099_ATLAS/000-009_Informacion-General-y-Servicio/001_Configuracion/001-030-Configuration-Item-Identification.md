---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-001-030-CONFIGURATION-ITEM-IDENTIFICATION"
title: "ATLAS 000-009 · 00.001.030 — Configuration Item Identification"
register: ATLAS-1000
...
subsubject: "030"
subsubject_title: "Configuration Item Identification"
subsubject_file: "001-030-Configuration-Item-Identification.md"
subsubject_link: "./001-030-Configuration-Item-Identification.md"
...
# ATLAS 000-009 · Section 00 · Subsection 001 · 030 — Configuration Item Identification
...
Establishes the hierarchy and naming rules for Configuration Items (CIs) in the programme-defined aircraft type. Defines the CI identification scheme, hardware/software CI boundaries, and the mapping between CI identifiers and CSDB data module applicability codes.
...
| S1000D SNS | 001-030-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Configuration Item Identification** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the configuration item identification scope;
...
The **Configuration Item Identification** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for configuration item identification. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Configuration Item Identification]
...
*Diagram 1 — System context for Configuration Item Identification.*
...
```mermaid
flowchart TB
    SYS[Configuration Item Identification] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Configuration Item Identification.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-001-030` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-001-030-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-001-030-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
