---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-001-010-AIRCRAFT-CONFIGURATION-BASELINE"
title: "ATLAS 000-009 · 00.001.010 — Aircraft Configuration Baseline"
register: ATLAS-1000
...
subsubject: "010"
subsubject_title: "Aircraft Configuration Baseline"
subsubject_file: "001-010-Aircraft-Configuration-Baseline.md"
subsubject_link: "./001-010-Aircraft-Configuration-Baseline.md"
...
# ATLAS 000-009 · Section 00 · Subsection 001 · 010 — Aircraft Configuration Baseline
...
Documents the formally controlled aircraft configuration baselines for the programme-defined aircraft type, including type design baseline, production baseline, and in-service configuration records. Defines the CCB-controlled baseline freeze criteria and the relationship between design and as-built configuration.
...
| S1000D SNS | 001-010-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Aircraft Configuration Baseline** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the aircraft configuration baseline scope;
...
The **Aircraft Configuration Baseline** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for aircraft configuration baseline. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Aircraft Configuration Baseline]
...
*Diagram 1 — System context for Aircraft Configuration Baseline.*
...
```mermaid
flowchart TB
    SYS[Aircraft Configuration Baseline] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Aircraft Configuration Baseline.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-001-010` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-001-010-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-001-010-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
