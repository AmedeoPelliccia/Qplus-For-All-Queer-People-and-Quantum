---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-001-000-CONFIGURATION-GENERAL"
title: "ATLAS 000-009 · 00.001.000 — Configuration General"
register: ATLAS-1000
...
subsubject: "000"
subsubject_title: "Configuration General"
subsubject_file: "001-000-Configuration-General.md"
subsubject_link: "./001-000-Configuration-General.md"
...
# ATLAS 000-009 · Section 00 · Subsection 001 · 000 — Configuration General
...
Establishes the top-level configuration management framework for the programme-defined aircraft type. Defines the configuration baseline concept, the controlled configuration item hierarchy, and the governance structure linking design authority, production, and in-service configuration management.
...
| S1000D SNS | 001-000-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Configuration General** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the configuration general scope;
...
The **Configuration General** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for configuration general. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Configuration General]
...
*Diagram 1 — System context for Configuration General.*
...
```mermaid
flowchart TB
    SYS[Configuration General] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Configuration General.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-001-000` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-001-000-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-001-000-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
