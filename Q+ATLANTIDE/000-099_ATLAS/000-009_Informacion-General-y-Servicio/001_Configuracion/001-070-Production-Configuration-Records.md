---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-001-070-PRODUCTION-CONFIGURATION-RECORDS"
title: "ATLAS 000-009 · 00.001.070 — Production Configuration Records"
register: ATLAS-1000
...
subsubject: "070"
subsubject_title: "Production Configuration Records"
subsubject_file: "001-070-Production-Configuration-Records.md"
subsubject_link: "./001-070-Production-Configuration-Records.md"
...
# ATLAS 000-009 · Section 00 · Subsection 001 · 070 — Production Configuration Records
...
Defines the production configuration records maintained for each programme-defined aircraft type at delivery, including the Aircraft Configuration Listing (ACL), as-built parts list, software load record, and deviation/waiver disposition. Establishes the configuration baseline that transitions from production to in-service management.
...
| S1000D SNS | 001-070-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Production Configuration Records** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the production configuration records scope;
...
The **Production Configuration Records** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for production configuration records. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Production Configuration Records]
...
*Diagram 1 — System context for Production Configuration Records.*
...
```mermaid
flowchart TB
    SYS[Production Configuration Records] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Production Configuration Records.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-001-070` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-001-070-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-001-070-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
