---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-001-050-APPLICABILITY-MATRIX"
title: "ATLAS 000-009 · 00.001.050 — Applicability Matrix"
register: ATLAS-1000
...
subsubject: "050"
subsubject_title: "Applicability Matrix"
subsubject_file: "001-050-Applicability-Matrix.md"
subsubject_link: "./001-050-Applicability-Matrix.md"
...
# ATLAS 000-009 · Section 00 · Subsection 001 · 050 — Applicability Matrix
...
Provides the controlled applicability matrix linking programme-defined aircraft type model variants, MSN ranges, modification states, and option codes to applicable data modules, maintenance tasks, and component part numbers. Used as the primary traceability tool for CSDB applicability management.
...
| S1000D SNS | 001-050-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Applicability Matrix** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the applicability matrix scope;
...
The **Applicability Matrix** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for applicability matrix. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Applicability Matrix]
...
*Diagram 1 — System context for Applicability Matrix.*
...
```mermaid
flowchart TB
    SYS[Applicability Matrix] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Applicability Matrix.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-001-050` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-001-050-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-001-050-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
