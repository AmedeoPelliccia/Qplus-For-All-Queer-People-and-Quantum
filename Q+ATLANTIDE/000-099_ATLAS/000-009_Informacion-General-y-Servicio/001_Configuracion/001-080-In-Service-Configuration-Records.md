---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-001-080-IN-SERVICE-CONFIGURATION-RECORDS"
title: "ATLAS 000-009 · 00.001.080 — In-Service Configuration Records"
register: ATLAS-1000
...
subsubject: "080"
subsubject_title: "In-Service Configuration Records"
subsubject_file: "001-080-In-Service-Configuration-Records.md"
subsubject_link: "./001-080-In-Service-Configuration-Records.md"
...
# ATLAS 000-009 · Section 00 · Subsection 001 · 080 — In-Service Configuration Records
...
Documents the in-service configuration management records for the programme-defined aircraft type fleet, including continuing airworthiness records, modification status, component replacement history, and software configuration state. Defines the interface between airline Technical Records and the Q+ATLANTIDE CSDB configuration management modules.
...
| S1000D SNS | 001-080-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **In-Service Configuration Records** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the in-service configuration records scope;
...
The **In-Service Configuration Records** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for in-service configuration records. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[In-Service Configuration Records]
...
*Diagram 1 — System context for In-Service Configuration Records.*
...
```mermaid
flowchart TB
    SYS[In-Service Configuration Records] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for In-Service Configuration Records.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-001-080` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-001-080-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-001-080-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
