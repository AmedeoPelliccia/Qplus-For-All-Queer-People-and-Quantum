---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-001-020-MODEL-VARIANT-AND-EFFECTIVITY-CONTROL"
title: "ATLAS 000-009 · 00.001.020 — Model Variant and Effectivity Control"
register: ATLAS-1000
...
subsubject: "020"
subsubject_title: "Model Variant and Effectivity Control"
subsubject_file: "001-020-Model-Variant-and-Effectivity-Control.md"
subsubject_link: "./001-020-Model-Variant-and-Effectivity-Control.md"
...
# ATLAS 000-009 · Section 00 · Subsection 001 · 020 — Model Variant and Effectivity Control
...
Defines the controlled effectivity expressions used to link configuration items, data modules, and maintenance procedures to specific aircraft serial numbers and model variants in the programme-defined aircraft type programme. Covers range effectivity, MSN-based effectivity, and modification-status effectivity.
...
| S1000D SNS | 001-020-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Model Variant and Effectivity Control** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the model variant and effectivity control scope;
...
The **Model Variant and Effectivity Control** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for model variant and effectivity control. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Model Variant and Effectivity Control]
...
*Diagram 1 — System context for Model Variant and Effectivity Control.*
...
```mermaid
flowchart TB
    SYS[Model Variant and Effectivity Control] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Model Variant and Effectivity Control.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-001-020` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-001-020-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-001-020-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
