---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-001-040-CHANGE-CONTROL-AND-REVISION-BASELINE"
title: "ATLAS 000-009 · 00.001.040 — Change Control and Revision Baseline"
register: ATLAS-1000
...
subsubject: "040"
subsubject_title: "Change Control and Revision Baseline"
subsubject_file: "001-040-Change-Control-and-Revision-Baseline.md"
subsubject_link: "./001-040-Change-Control-and-Revision-Baseline.md"
...
# ATLAS 000-009 · Section 00 · Subsection 001 · 040 — Change Control and Revision Baseline
...
Documents the Engineering Change Request (ECR) and Engineering Change Order (ECO) process for the programme-defined aircraft type configuration baseline. Defines revision levels, change classification (Class I / Class II), effectivity assignment, and the CCB governance process for approved changes.
...
| S1000D SNS | 001-040-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Change Control and Revision Baseline** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the change control and revision baseline scope;
...
The **Change Control and Revision Baseline** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for change control and revision baseline. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Change Control and Revision Baseline]
...
*Diagram 1 — System context for Change Control and Revision Baseline.*
...
```mermaid
flowchart TB
    SYS[Change Control and Revision Baseline] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Change Control and Revision Baseline.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-001-040` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-001-040-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-001-040-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
