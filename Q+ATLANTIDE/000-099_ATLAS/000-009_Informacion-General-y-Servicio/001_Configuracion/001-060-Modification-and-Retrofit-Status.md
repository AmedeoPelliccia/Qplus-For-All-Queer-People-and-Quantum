---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-001-060-MODIFICATION-AND-RETROFIT-STATUS"
title: "ATLAS 000-009 · 00.001.060 — Modification and Retrofit Status"
register: ATLAS-1000
...
subsubject: "060"
subsubject_title: "Modification and Retrofit Status"
subsubject_file: "001-060-Modification-and-Retrofit-Status.md"
subsubject_link: "./001-060-Modification-and-Retrofit-Status.md"
...
# ATLAS 000-009 · Section 00 · Subsection 001 · 060 — Modification and Retrofit Status
...
Documents the modification incorporation status tracking system for the programme-defined aircraft type. Covers Service Bulletin (SB) and Engineering Order (EO) status, retrofit kit identification, post-production modification records, and the interface with the in-service configuration management system.
...
| S1000D SNS | 001-060-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Modification and Retrofit Status** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the modification and retrofit status scope;
...
The **Modification and Retrofit Status** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for modification and retrofit status. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Modification and Retrofit Status]
...
*Diagram 1 — System context for Modification and Retrofit Status.*
...
```mermaid
flowchart TB
    SYS[Modification and Retrofit Status] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Modification and Retrofit Status.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-001-060` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-001-060-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-001-060-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
