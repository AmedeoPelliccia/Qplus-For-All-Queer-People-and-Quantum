---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-000-030-MODEL-VARIANT-AND-TYPE-DESIGNATOR"
title: "ATLAS 000-009 · 00.000.030 — Model Variant and Type Designator"
register: ATLAS-1000
...
subsubject: "030"
subsubject_title: "Model Variant and Type Designator"
subsubject_file: "000-030-Model-Variant-and-Type-Designator.md"
subsubject_link: "./000-030-Model-Variant-and-Type-Designator.md"
...
# ATLAS 000-009 · Section 00 · Subsection 000 · 030 — Model Variant and Type Designator
...
Defines the controlled model variant codes and type designator hierarchy for the programme-defined aircraft type family. Covers the relationship between baseline model, sub-variants (seat-density, range, propulsion configuration), and the formal type designator as registered with certification authorities.
...
| S1000D SNS | 000-030-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Model Variant and Type Designator** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the model variant and type designator scope;
...
The **Model Variant and Type Designator** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for model variant and type designator. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Model Variant and Type Designator]
...
*Diagram 1 — System context for Model Variant and Type Designator.*
...
```mermaid
flowchart TB
    SYS[Model Variant and Type Designator] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Model Variant and Type Designator.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-000-030` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-000-030-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-000-030-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
