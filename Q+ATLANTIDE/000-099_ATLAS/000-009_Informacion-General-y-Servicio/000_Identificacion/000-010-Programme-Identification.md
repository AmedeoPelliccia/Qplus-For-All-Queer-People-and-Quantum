---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-000-010-PROGRAMME-IDENTIFICATION"
title: "ATLAS 000-009 · 00.000.010 — Programme Identification"
register: ATLAS-1000
...
subsubject: "010"
subsubject_title: "Programme Identification"
subsubject_file: "000-010-Programme-Identification.md"
subsubject_link: "./000-010-Programme-Identification.md"
...
# ATLAS 000-009 · Section 00 · Subsection 000 · 010 — Programme Identification
...
Defines the controlled programme identifiers for the programme-defined aircraft type family, including programme code, programme manager designation, and registration in the Q+ATLANTIDE baseline. Establishes traceability from programme-level to aircraft-level identifiers.
...
| S1000D SNS | 000-010-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Programme Identification** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the programme identification scope;
...
The **Programme Identification** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for programme identification. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Programme Identification]
...
*Diagram 1 — System context for Programme Identification.*
...
```mermaid
flowchart TB
    SYS[Programme Identification] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Programme Identification.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-000-010` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-000-010-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-000-010-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
