---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-000-060-SYSTEM-AND-ARCHITECTURE-IDENTIFICATION"
title: "ATLAS 000-009 · 00.000.060 — System and Architecture Identification"
register: ATLAS-1000
...
subsubject: "060"
subsubject_title: "System and Architecture Identification"
subsubject_file: "000-060-System-and-Architecture-Identification.md"
subsubject_link: "./000-060-System-and-Architecture-Identification.md"
...
# ATLAS 000-009 · Section 00 · Subsection 000 · 060 — System and Architecture Identification
...
Defines how each aircraft system, sub-system, and component is identified within the ATLAS-1000 register and the S1000D System/Subsystem/Subsubsystem/Assembly (SNS) hierarchy. Covers the mapping between ATLAS section codes and S1000D system codes for the programme-defined aircraft type.
...
| S1000D SNS | 000-060-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **System and Architecture Identification** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the system and architecture identification scope;
...
The **System and Architecture Identification** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for system and architecture identification. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[System and Architecture Identification]
...
*Diagram 1 — System context for System and Architecture Identification.*
...
```mermaid
flowchart TB
    SYS[System and Architecture Identification] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for System and Architecture Identification.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-000-060` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-000-060-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-000-060-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
