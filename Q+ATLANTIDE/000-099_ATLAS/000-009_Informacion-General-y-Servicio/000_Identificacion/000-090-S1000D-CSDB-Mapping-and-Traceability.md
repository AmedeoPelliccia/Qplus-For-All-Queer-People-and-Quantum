...
Maps the identification artefacts defined in subsection 000 to S1000D Data Module Codes (DMC) and CSDB data modules. Establishes the BREX rules governing identification fields, DMC prefix conventions, and the traceability chain from Q+ATLANTIDE identifier to CSDB data module for the AMPEL360E eWTW.
...
| DMC prefix | `DMC-AMPEL360E-EWTW-000-090` | ![TBD](https://img.shields.io/badge/TBD-red) |
