---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-000-000-IDENTIFICATION-GENERAL"
title: "ATLAS 000-009 · 00.000.000 — Identification General"
register: ATLAS-1000
...
subsubject: "000"
subsubject_title: "Identification General"
subsubject_file: "000-000-Identification-General.md"
subsubject_link: "./000-000-Identification-General.md"
...
# ATLAS 000-009 · Section 00 · Subsection 000 · 000 — Identification General
...
Establishes the top-level identification framework for the programme-defined aircraft type programme. Defines the controlled vocabulary and hierarchical identifier schema linking aircraft programme, type, variant, serial number, document, and digital identifiers across the Q+ATLANTIDE ATLAS-1000 register.
...
| S1000D SNS | 000-000-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Identification General** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the identification general scope;
...
The **Identification General** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for identification general. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Identification General]
...
*Diagram 1 — System context for Identification General.*
...
```mermaid
flowchart TB
    SYS[Identification General] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Identification General.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-000-000` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-000-000-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-000-000-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
