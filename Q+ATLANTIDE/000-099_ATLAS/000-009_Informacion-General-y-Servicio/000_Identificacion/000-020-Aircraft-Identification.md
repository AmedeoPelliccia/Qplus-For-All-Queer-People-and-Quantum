---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-000-020-AIRCRAFT-IDENTIFICATION"
title: "ATLAS 000-009 · 00.000.020 — Aircraft Identification"
register: ATLAS-1000
...
subsubject_file: "000-020-Aircraft-Identification.md"
subsubject_link: "./000-020-Aircraft-Identification.md"
...
# ATLAS 000-009 · Section 00 · Subsection 000 · 020 — Aircraft Identification
...
Documents the ICAO type designator, IATA aircraft type code, FAA type designator, and EASA type-certificate data sheet reference for the programme-defined aircraft type. These identifiers are used in all ATLAS data modules, airworthiness correspondence, and operational documentation.
...
| S1000D SNS | 000-020-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Aircraft Identification** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the aircraft identification scope;
...
The **Aircraft Identification** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for aircraft identification. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Aircraft Identification]
...
*Diagram 1 — System context for Aircraft Identification.*
...
```mermaid
flowchart TB
    SYS[Aircraft Identification] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Aircraft Identification.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-000-020` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-000-020-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-000-020-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
