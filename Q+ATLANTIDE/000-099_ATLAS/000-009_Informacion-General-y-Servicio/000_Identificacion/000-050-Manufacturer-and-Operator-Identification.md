---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-000-050-MANUFACTURER-AND-OPERATOR-IDENTIFICATION"
title: "ATLAS 000-009 · 00.000.050 — Manufacturer and Operator Identification"
register: ATLAS-1000
...
subsubject: "050"
subsubject_title: "Manufacturer and Operator Identification"
subsubject_file: "000-050-Manufacturer-and-Operator-Identification.md"
subsubject_link: "./000-050-Manufacturer-and-Operator-Identification.md"
...
# ATLAS 000-009 · Section 00 · Subsection 000 · 050 — Manufacturer and Operator Identification
...
Documents the CAGE code, DUNS/LEI, and Q+ATLANTIDE manufacturer registry entry for the aircraft OEM and key tier-1 suppliers. Also defines the operator identification scheme used in CSDB applicability and in-service configuration records.
...
| S1000D SNS | 000-050-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Manufacturer and Operator Identification** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the manufacturer and operator identification scope;
...
The **Manufacturer and Operator Identification** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for manufacturer and operator identification. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Manufacturer and Operator Identification]
...
*Diagram 1 — System context for Manufacturer and Operator Identification.*
...
```mermaid
flowchart TB
    SYS[Manufacturer and Operator Identification] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Manufacturer and Operator Identification.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-000-050` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-000-050-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-000-050-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
