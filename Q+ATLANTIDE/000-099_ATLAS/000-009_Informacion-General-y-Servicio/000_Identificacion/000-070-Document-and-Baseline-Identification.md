---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-000-070-DOCUMENT-AND-BASELINE-IDENTIFICATION"
title: "ATLAS 000-009 · 00.000.070 — Document and Baseline Identification"
register: ATLAS-1000
...
subsubject: "070"
subsubject_title: "Document and Baseline Identification"
subsubject_file: "000-070-Document-and-Baseline-Identification.md"
subsubject_link: "./000-070-Document-and-Baseline-Identification.md"
...
# ATLAS 000-009 · Section 00 · Subsection 000 · 070 — Document and Baseline Identification
...
Establishes the controlled document identification scheme for all Q+ATLANTIDE ATLAS-1000 artefacts, including document_id formation rules (QATL-ATLAS-1000-ATLAS-{RANGE}-{SECTION}-{NNN}-{MMM}-{SLUG}), revision and issue numbering, and baseline registration. Defines the relationship between document identifiers and CSDB data module codes.
...
| S1000D SNS | 000-070-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Document and Baseline Identification** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the document and baseline identification scope;
...
The **Document and Baseline Identification** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for document and baseline identification. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Document and Baseline Identification]
...
*Diagram 1 — System context for Document and Baseline Identification.*
...
```mermaid
flowchart TB
    SYS[Document and Baseline Identification] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Document and Baseline Identification.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-000-070` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-000-070-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-000-070-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
