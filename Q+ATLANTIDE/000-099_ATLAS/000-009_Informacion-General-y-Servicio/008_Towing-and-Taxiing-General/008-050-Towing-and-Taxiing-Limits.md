---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-008-050-TOWING-AND-TAXIING-LIMITS"
title: "ATLAS 000-009 · 00.008.050 — Towing and Taxiing Limits"
register: ATLAS-1000
...
subsubject: "050"
subsubject_title: "Towing and Taxiing Limits"
subsubject_file: "008-050-Towing-and-Taxiing-Limits.md"
subsubject_link: "./008-050-Towing-and-Taxiing-Limits.md"
...
# ATLAS 000-009 · Section 00 · Subsection 008 · 050 — Towing and Taxiing Limits
...
Documents the controlled towing and taxiing limits for the programme-defined aircraft type. Covers maximum towing speed (forward and rearward), minimum turn radius, maximum steered angle during towing, braking distance requirements, and the HVDC system status requirements during towing operations.
...
| S1000D SNS | 008-050-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the towing and taxiing limits scope;
...
The **Towing and Taxiing Limits** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for towing and taxiing limits. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Towing and Taxiing Limits]
...
*Diagram 1 — System context for Towing and Taxiing Limits.*
...
```mermaid
flowchart TB
    SYS[Towing and Taxiing Limits] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Towing and Taxiing Limits.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-008-050` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-008-050-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-008-050-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
