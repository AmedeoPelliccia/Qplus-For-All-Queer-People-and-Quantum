---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-008-040-STEERING-BRAKING-AND-GROUND-MOVEMENT-INTERFACES"
title: "ATLAS 000-009 · 00.008.040 — Steering Braking and Ground Movement Interfaces"
register: ATLAS-1000
...
subsubject: "040"
subsubject_title: "Steering Braking and Ground Movement Interfaces"
subsubject_file: "008-040-Steering-Braking-and-Ground-Movement-Interfaces.md"
subsubject_link: "./008-040-Steering-Braking-and-Ground-Movement-Interfaces.md"
...
# ATLAS 000-009 · Section 00 · Subsection 008 · 040 — Steering Braking and Ground Movement Interfaces
...
Defines the steering, braking, and ground movement control interfaces for the programme-defined aircraft type. Covers the nose wheel steering system interface, electric brake-by-wire system interface, anti-skid function, and the integration of steering and braking with the aircraft power management and CMS.
...
| S1000D SNS | 008-040-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the steering braking and ground movement interfaces scope;
...
The **Steering Braking and Ground Movement Interfaces** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for steering braking and ground movement interfaces. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Steering Braking and Ground Movement Interfaces]
...
*Diagram 1 — System context for Steering Braking and Ground Movement Interfaces.*
...
```mermaid
flowchart TB
    SYS[Steering Braking and Ground Movement Interfaces] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Steering Braking and Ground Movement Interfaces.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-008-040` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-008-040-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-008-040-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
