---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-008-080-TOWING-TAXIING-MONITORING-DIAGNOSTICS-AND-CONTROL-INTERFACES"
title: "ATLAS 000-009 · 00.008.080 — Towing Taxiing Monitoring Diagnostics and Control Interfaces"
register: ATLAS-1000
...
subsubject: "080"
subsubject_title: "Towing Taxiing Monitoring Diagnostics and Control Interfaces"
subsubject_file: "008-080-Towing-Taxiing-Monitoring-Diagnostics-and-Control-Interfaces.md"
subsubject_link: "./008-080-Towing-Taxiing-Monitoring-Diagnostics-and-Control-Interfaces.md"
...
# ATLAS 000-009 · Section 00 · Subsection 008 · 080 — Towing Taxiing Monitoring Diagnostics and Control Interfaces
...
Defines the monitoring and control interfaces available during towing and taxiing operations on the programme-defined aircraft type. Covers the nose gear steering position sensor, brake temperature monitoring, HVDC bus status during towing, and the CMS maintenance messages related to towing and taxiing events.
...
| S1000D SNS | 008-080-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the towing taxiing monitoring diagnostics and control interfaces scope;
...
The **Towing Taxiing Monitoring Diagnostics and Control Interfaces** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for towing taxiing monitoring diagnostics and control interfaces. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Towing Taxiing Monitoring Diagnostics and Control Interfaces]
...
*Diagram 1 — System context for Towing Taxiing Monitoring Diagnostics and Control Interfaces.*
...
```mermaid
flowchart TB
    SYS[Towing Taxiing Monitoring Diagnostics and Control Interfaces] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Towing Taxiing Monitoring Diagnostics and Control Interfaces.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-008-080` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-008-080-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-008-080-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
