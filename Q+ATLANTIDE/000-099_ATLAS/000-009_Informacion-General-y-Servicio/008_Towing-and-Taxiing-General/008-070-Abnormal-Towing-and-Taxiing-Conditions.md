---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-008-070-ABNORMAL-TOWING-AND-TAXIING-CONDITIONS"
title: "ATLAS 000-009 · 00.008.070 — Abnormal Towing and Taxiing Conditions"
register: ATLAS-1000
...
subsubject: "070"
subsubject_title: "Abnormal Towing and Taxiing Conditions"
subsubject_file: "008-070-Abnormal-Towing-and-Taxiing-Conditions.md"
subsubject_link: "./008-070-Abnormal-Towing-and-Taxiing-Conditions.md"
...
# ATLAS 000-009 · Section 00 · Subsection 008 · 070 — Abnormal Towing and Taxiing Conditions
...
Documents the procedures and safety requirements for abnormal towing and taxiing conditions on the programme-defined aircraft type, including towing with a flat tyre, towing after a gear collapse, taxiing with a failed nose wheel steering system, and towing following a runway excursion or foreign object damage event.
...
| S1000D SNS | 008-070-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the abnormal towing and taxiing conditions scope;
...
The **Abnormal Towing and Taxiing Conditions** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for abnormal towing and taxiing conditions. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Abnormal Towing and Taxiing Conditions]
...
*Diagram 1 — System context for Abnormal Towing and Taxiing Conditions.*
...
```mermaid
flowchart TB
    SYS[Abnormal Towing and Taxiing Conditions] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Abnormal Towing and Taxiing Conditions.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-008-070` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-008-070-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-008-070-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
