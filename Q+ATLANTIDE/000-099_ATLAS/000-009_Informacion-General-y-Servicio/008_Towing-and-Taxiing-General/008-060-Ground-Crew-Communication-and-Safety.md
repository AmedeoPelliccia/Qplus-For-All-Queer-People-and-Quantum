---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-008-060-GROUND-CREW-COMMUNICATION-AND-SAFETY"
title: "ATLAS 000-009 · 00.008.060 — Ground Crew Communication and Safety"
register: ATLAS-1000
...
subsubject: "060"
subsubject_title: "Ground Crew Communication and Safety"
subsubject_file: "008-060-Ground-Crew-Communication-and-Safety.md"
subsubject_link: "./008-060-Ground-Crew-Communication-and-Safety.md"
...
# ATLAS 000-009 · Section 00 · Subsection 008 · 060 — Ground Crew Communication and Safety
...
Defines the communication protocols and safety requirements for ground crew during towing and taxiing operations on the programme-defined aircraft type. Covers headset communication requirements, wing-walker requirements, HVDC system caution zones, jet blast exclusion areas (if applicable), and emergency stop procedures.
...
| S1000D SNS | 008-060-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Ground Crew Communication and Safety** node defines the communication protocols, safety zones, and hazard-specific precautions for ground personnel during towing and taxiing operations on the programme-defined aircraft type. The [PROGRAMME-VARIANT] introduces two unique ground safety considerations compared to conventional aircraft: (1) the ENWTD operates silently (no engine noise cue) — ground crew must confirm aircraft movement authorisation via WGI handshake, not by engine noise; (2) the 540 V HVDC bus is active during e-taxi — standard high-voltage safety zone applies (minimum 1 m clearance from HVDC component access panels marked with the lightning-bolt hazard decal).
...
- controlled definition of the ground crew communication and safety scope;
...
The **Ground Crew Communication and Safety** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for ground crew communication and safety. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Ground Crew Communication and Safety]
...
*Diagram 1 — System context for Ground Crew Communication and Safety.*
...
```mermaid
flowchart TB
    SYS[Ground Crew Communication and Safety] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Ground Crew Communication and Safety.*
...
| Sub-system code | `060` | ![TBD](https://img.shields.io/badge/TBD-red) |
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-008-060` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-008-060-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-008-060-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
