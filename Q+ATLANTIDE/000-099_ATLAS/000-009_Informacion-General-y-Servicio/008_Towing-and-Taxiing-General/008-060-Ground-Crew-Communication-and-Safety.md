...
Defines the communication protocols and safety requirements for ground crew during towing and taxiing operations on the AMPEL360E eWTW. Covers headset communication requirements, wing-walker requirements, HVDC system caution zones, jet blast exclusion areas (if applicable), and emergency stop procedures.
...
The **Ground Crew Communication and Safety** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the AMPEL360E eWTW programme.
...
| DMC prefix | `DMC-AMPEL360E-EWTW-008-060` | ![TBD](https://img.shields.io/badge/TBD-red) |
