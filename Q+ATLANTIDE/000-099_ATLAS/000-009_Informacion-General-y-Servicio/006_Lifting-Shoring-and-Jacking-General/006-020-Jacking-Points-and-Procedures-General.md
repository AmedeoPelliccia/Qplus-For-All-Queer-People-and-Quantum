---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-006-020-JACKING-POINTS-AND-PROCEDURES-GENERAL"
title: "ATLAS 000-009 · 00.006.020 — Jacking Points and Procedures General"
register: ATLAS-1000
...
subsubject: "020"
subsubject_title: "Jacking Points and Procedures General"
subsubject_file: "006-020-Jacking-Points-and-Procedures-General.md"
subsubject_link: "./006-020-Jacking-Points-and-Procedures-General.md"
...
# ATLAS 000-009 · Section 00 · Subsection 006 · 020 — Jacking Points and Procedures General
...
Documents the controlled jacking points on the programme-defined aircraft type, including the primary nose jack point, main wing jack points, and tail jack point. Defines the controlled jacking procedure sequence, load sequencing requirements, and the safety interlock requirements for HVDC system isolation during jacking operations.
...
| S1000D SNS | 006-020-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the jacking points and procedures general scope;
...
The **Jacking Points and Procedures General** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for jacking points and procedures general. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Jacking Points and Procedures General]
...
*Diagram 1 — System context for Jacking Points and Procedures General.*
...
```mermaid
flowchart TB
    SYS[Jacking Points and Procedures General] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Jacking Points and Procedures General.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-006-020` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-006-020-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-006-020-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
