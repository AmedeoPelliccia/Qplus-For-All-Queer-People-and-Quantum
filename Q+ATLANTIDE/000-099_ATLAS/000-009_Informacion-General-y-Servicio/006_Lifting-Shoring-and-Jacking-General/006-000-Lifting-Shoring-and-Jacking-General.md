---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-006-000-LIFTING-SHORING-AND-JACKING-GENERAL"
title: "ATLAS 000-009 · 00.006.000 — Lifting Shoring and Jacking General"
register: ATLAS-1000
...
subsubject: "000"
subsubject_title: "Lifting Shoring and Jacking General"
subsubject_file: "006-000-Lifting-Shoring-and-Jacking-General.md"
subsubject_link: "./006-000-Lifting-Shoring-and-Jacking-General.md"
...
# ATLAS 000-009 · Section 00 · Subsection 006 · 000 — Lifting Shoring and Jacking General
...
| S1000D SNS | 006-000-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for lifting shoring and jacking general. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Lifting Shoring and Jacking General]
...
*Diagram 1 — System context for Lifting Shoring and Jacking General.*
...
```mermaid
flowchart TB
    SYS[Lifting Shoring and Jacking General] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Lifting Shoring and Jacking General.*
...
|---|---|---|---|
| OI-006-000-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-006-000-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
