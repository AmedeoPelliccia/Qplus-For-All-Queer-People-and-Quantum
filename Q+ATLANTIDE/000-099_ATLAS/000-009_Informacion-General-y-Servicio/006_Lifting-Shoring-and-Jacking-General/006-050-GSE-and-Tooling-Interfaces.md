---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-006-050-GSE-AND-TOOLING-INTERFACES"
title: "ATLAS 000-009 · 00.006.050 — GSE and Tooling Interfaces"
register: ATLAS-1000
...
subsubject: "050"
subsubject_title: "GSE and Tooling Interfaces"
subsubject_file: "006-050-GSE-and-Tooling-Interfaces.md"
subsubject_link: "./006-050-GSE-and-Tooling-Interfaces.md"
...
# ATLAS 000-009 · Section 00 · Subsection 006 · 050 — GSE and Tooling Interfaces
...
Documents the GSE and special tooling interfaces for lifting, shoring, and jacking operations on the programme-defined aircraft type. Covers the tripod jack interface specifications, sling set interface specifications, shoring kit part numbers, and the approved GSE supplier list for lifting and jacking equipment.
...
| S1000D SNS | 006-050-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **GSE and Tooling Interfaces** node catalogs the Ground Support Equipment (GSE) and special tooling required for lifting, shoring, and jacking operations on the programme-defined aircraft type, together with their mechanical, electrical, and data interfaces. Key items: (1) Crane sling assembly (P/N Q-LIFT-001): four-leg synthetic sling, 100 t rated, with adjustable spreader bar; attaches to the three primary lifting lugs; (2) 3-point hydraulic jack set (P/N Q-JACK-003): electrically driven, WMMS load-cell interface via CAN bus, max stroke 850 mm, rated 35 t per unit; (3) Fuselage shoring cradle (P/N Q-SHORE-001): two-piece saddle, adjustable height, padded contact surface; (4) Tail support stand (P/N Q-SHORE-002): screw-jack type, range 0.6–1.8 m.
...
- controlled definition of the gse and tooling interfaces scope;
...
The **GSE and Tooling Interfaces** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for gse and tooling interfaces. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[GSE and Tooling Interfaces]
...
*Diagram 1 — System context for GSE and Tooling Interfaces.*
...
```mermaid
flowchart TB
    SYS[GSE and Tooling Interfaces] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for GSE and Tooling Interfaces.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-006-050` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-006-050-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-006-050-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
