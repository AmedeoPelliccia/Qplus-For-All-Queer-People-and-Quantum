---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-006-010-LIFTING-POINTS-AND-PROCEDURES-GENERAL"
title: "ATLAS 000-009 · 00.006.010 — Lifting Points and Procedures General"
register: ATLAS-1000
...
subsubject: "010"
subsubject_title: "Lifting Points and Procedures General"
subsubject_file: "006-010-Lifting-Points-and-Procedures-General.md"
subsubject_link: "./006-010-Lifting-Points-and-Procedures-General.md"
...
# ATLAS 000-009 · Section 00 · Subsection 006 · 010 — Lifting Points and Procedures General
...
Documents the controlled lifting points on the programme-defined aircraft type, including main sling attachment points, hoist ring locations, and the load capacity limits for each lifting point. Defines the controlled lifting procedures sequence for full aircraft and component lifting operations.
...
| S1000D SNS | 006-010-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the lifting points and procedures general scope;
...
The **Lifting Points and Procedures General** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for lifting points and procedures general. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Lifting Points and Procedures General]
...
*Diagram 1 — System context for Lifting Points and Procedures General.*
...
```mermaid
flowchart TB
    SYS[Lifting Points and Procedures General] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Lifting Points and Procedures General.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-006-010` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-006-010-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-006-010-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
