---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-006-040-AIRCRAFT-LEVELING-FOR-LIFTING-AND-JACKING"
title: "ATLAS 000-009 · 00.006.040 — Aircraft Leveling for Lifting and Jacking"
register: ATLAS-1000
...
subsubject: "040"
subsubject_title: "Aircraft Leveling for Lifting and Jacking"
subsubject_file: "006-040-Aircraft-Leveling-for-Lifting-and-Jacking.md"
subsubject_link: "./006-040-Aircraft-Leveling-for-Lifting-and-Jacking.md"
...
# ATLAS 000-009 · Section 00 · Subsection 006 · 040 — Aircraft Leveling for Lifting and Jacking
...
Defines the aircraft leveling requirements applicable to lifting and jacking operations on the programme-defined aircraft type. Covers the reference datum points, acceptable tolerance limits, leveling measurement equipment, and the leveling procedure sequence required before and during jacking to full aircraft height.
...
| S1000D SNS | 006-040-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the aircraft leveling for lifting and jacking scope;
...
The **Aircraft Leveling for Lifting and Jacking** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for aircraft leveling for lifting and jacking. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Aircraft Leveling for Lifting and Jacking]
...
*Diagram 1 — System context for Aircraft Leveling for Lifting and Jacking.*
...
```mermaid
flowchart TB
    SYS[Aircraft Leveling for Lifting and Jacking] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Aircraft Leveling for Lifting and Jacking.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-006-040` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-006-040-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-006-040-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
