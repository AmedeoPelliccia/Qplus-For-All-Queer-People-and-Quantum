---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-006-030-SHORING-POINTS-AND-SUPPORT-GENERAL"
title: "ATLAS 000-009 · 00.006.030 — Shoring Points and Support General"
register: ATLAS-1000
...
subsubject: "030"
subsubject_title: "Shoring Points and Support General"
subsubject_file: "006-030-Shoring-Points-and-Support-General.md"
subsubject_link: "./006-030-Shoring-Points-and-Support-General.md"
...
# ATLAS 000-009 · Section 00 · Subsection 006 · 030 — Shoring Points and Support General
...
Documents the controlled shoring points and structural support requirements for the programme-defined aircraft type, covering the wing shoring provisions, fuselage keel beam shoring, and nacelle support for composite structure protection. Defines the controlled shoring procedure when used in conjunction with jacking.
...
| S1000D SNS | 006-030-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the shoring points and support general scope;
...
The **Shoring Points and Support General** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for shoring points and support general. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Shoring Points and Support General]
...
*Diagram 1 — System context for Shoring Points and Support General.*
...
```mermaid
flowchart TB
    SYS[Shoring Points and Support General] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Shoring Points and Support General.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-006-030` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-006-030-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-006-030-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
