---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-006-060-SAFETY-PRECAUTIONS-AND-LOAD-LIMITS"
title: "ATLAS 000-009 · 00.006.060 — Safety Precautions and Load Limits"
register: ATLAS-1000
...
subsubject: "060"
subsubject_title: "Safety Precautions and Load Limits"
subsubject_file: "006-060-Safety-Precautions-and-Load-Limits.md"
subsubject_link: "./006-060-Safety-Precautions-and-Load-Limits.md"
...
# ATLAS 000-009 · Section 00 · Subsection 006 · 060 — Safety Precautions and Load Limits
...
Defines the controlled safety precautions and load limits for all lifting, shoring, and jacking operations on the programme-defined aircraft type. Covers HVDC isolation requirements, composite structure protection requirements, maximum jack load per jack point, maximum lift rate, and the personnel safety exclusion zones.
...
| S1000D SNS | 006-060-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Safety Precautions and Load Limits** node specifies the mandatory safety precautions, personnel qualification requirements, environmental restrictions, and structural load limits applicable to all lifting, shoring, and jacking operations on the programme-defined aircraft type. Personnel: minimum two qualified Licensed Aircraft Maintenance Engineers (LAME) Category B2/B1 plus a supervisor; all personnel must hold the [PROGRAMME-VARIANT] type-specific lifting & jacking endorsement (Q-GROUND-TRAIN-006). Minimum PPE: hard hat, safety boots, high-visibility vest, and anti-static wrist strap when within 3 m of any HVDC panel.
...
- controlled definition of the safety precautions and load limits scope;
...
The **Safety Precautions and Load Limits** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for safety precautions and load limits. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Safety Precautions and Load Limits]
...
*Diagram 1 — System context for Safety Precautions and Load Limits.*
...
```mermaid
flowchart TB
    SYS[Safety Precautions and Load Limits] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Safety Precautions and Load Limits.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-006-060` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-006-060-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-006-060-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
