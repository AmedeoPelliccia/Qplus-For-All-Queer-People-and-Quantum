---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-005-030-ACCESS-AREAS-AND-SERVICE-ZONES"
title: "ATLAS 000-009 · 00.005.030 — Access Areas and Service Zones"
register: ATLAS-1000
...
subsubject: "030"
subsubject_title: "Access Areas and Service Zones"
subsubject_file: "005-030-Access-Areas-and-Service-Zones.md"
subsubject_link: "./005-030-Access-Areas-and-Service-Zones.md"
...
# ATLAS 000-009 · Section 00 · Subsection 005 · 030 — Access Areas and Service Zones
...
Defines the access area and service zone scheme for the programme-defined aircraft type. Covers zone numbering (major zones, sub-zones), access panel locations with ATA zone references, service area boundaries, and the mapping between zone codes and the S1000D SNS system for maintenance documentation.
...
| S1000D SNS | 005-030-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the access areas and service zones scope;
...
The **Access Areas and Service Zones** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for access areas and service zones. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Access Areas and Service Zones]
...
*Diagram 1 — System context for Access Areas and Service Zones.*
...
```mermaid
flowchart TB
    SYS[Access Areas and Service Zones] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Access Areas and Service Zones.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-005-030` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-005-030-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-005-030-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
