---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-005-040-GROUND-CLEARANCE-AND-SWEPT-AREAS"
title: "ATLAS 000-009 · 00.005.040 — Ground Clearance and Swept Areas"
register: ATLAS-1000
...
subsubject: "040"
subsubject_title: "Ground Clearance and Swept Areas"
subsubject_file: "005-040-Ground-Clearance-and-Swept-Areas.md"
subsubject_link: "./005-040-Ground-Clearance-and-Swept-Areas.md"
...
# ATLAS 000-009 · Section 00 · Subsection 005 · 040 — Ground Clearance and Swept Areas
...
| S1000D SNS | 005-040-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for ground clearance and swept areas. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Ground Clearance and Swept Areas]
...
*Diagram 1 — System context for Ground Clearance and Swept Areas.*
...
```mermaid
flowchart TB
    SYS[Ground Clearance and Swept Areas] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Ground Clearance and Swept Areas.*
...
|---|---|---|---|
| OI-005-040-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-005-040-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
