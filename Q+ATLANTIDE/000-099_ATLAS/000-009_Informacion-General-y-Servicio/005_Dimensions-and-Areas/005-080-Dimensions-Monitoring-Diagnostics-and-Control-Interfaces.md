---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-005-080-DIMENSIONS-MONITORING-DIAGNOSTICS-AND-CONTROL-INTERFACES"
title: "ATLAS 000-009 · 00.005.080 — Dimensions Monitoring Diagnostics and Control Interfaces"
register: ATLAS-1000
...
subsubject: "080"
subsubject_title: "Dimensions Monitoring Diagnostics and Control Interfaces"
subsubject_file: "005-080-Dimensions-Monitoring-Diagnostics-and-Control-Interfaces.md"
subsubject_link: "./005-080-Dimensions-Monitoring-Diagnostics-and-Control-Interfaces.md"
...
# ATLAS 000-009 · Section 00 · Subsection 005 · 080 — Dimensions Monitoring Diagnostics and Control Interfaces
...
Defines the monitoring and control interfaces related to aircraft dimensional parameters for the programme-defined aircraft type. Covers structural deflection monitoring, landing gear position sensors, door opening angle sensors, and the CMS interface for dimensional anomaly reporting during maintenance operations.
...
| S1000D SNS | 005-080-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the dimensions monitoring diagnostics and control interfaces scope;
...
The **Dimensions Monitoring Diagnostics and Control Interfaces** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for dimensions monitoring diagnostics and control interfaces. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Dimensions Monitoring Diagnostics and Control Interfaces]
...
*Diagram 1 — System context for Dimensions Monitoring Diagnostics and Control Interfaces.*
...
```mermaid
flowchart TB
    SYS[Dimensions Monitoring Diagnostics and Control Interfaces] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Dimensions Monitoring Diagnostics and Control Interfaces.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-005-080` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-005-080-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-005-080-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
