---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-005-070-AIRCRAFT-STATION-AND-ZONE-REFERENCE"
title: "ATLAS 000-009 · 00.005.070 — Aircraft Station and Zone Reference"
register: ATLAS-1000
...
subsubject: "070"
subsubject_title: "Aircraft Station and Zone Reference"
subsubject_file: "005-070-Aircraft-Station-and-Zone-Reference.md"
subsubject_link: "./005-070-Aircraft-Station-and-Zone-Reference.md"
...
# ATLAS 000-009 · Section 00 · Subsection 005 · 070 — Aircraft Station and Zone Reference
...
Provides the complete aircraft station and zone reference tables for the programme-defined aircraft type, mapping station numbers (Fuselage Station FS, Wing Station WS, Buttock Line BL, Waterline WL) to physical aircraft locations and to the S1000D SNS zone references used in maintenance documentation.
...
| S1000D SNS | 005-070-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the aircraft station and zone reference scope;
...
The **Aircraft Station and Zone Reference** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for aircraft station and zone reference. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Aircraft Station and Zone Reference]
...
*Diagram 1 — System context for Aircraft Station and Zone Reference.*
...
```mermaid
flowchart TB
    SYS[Aircraft Station and Zone Reference] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Aircraft Station and Zone Reference.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-005-070` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-005-070-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-005-070-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
