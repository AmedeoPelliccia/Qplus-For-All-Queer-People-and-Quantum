---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-005-020-AIRCRAFT-INTERNAL-DIMENSIONS"
title: "ATLAS 000-009 · 00.005.020 — Aircraft Internal Dimensions"
register: ATLAS-1000
...
subsubject: "020"
subsubject_title: "Aircraft Internal Dimensions"
subsubject_file: "005-020-Aircraft-Internal-Dimensions.md"
subsubject_link: "./005-020-Aircraft-Internal-Dimensions.md"
...
# ATLAS 000-009 · Section 00 · Subsection 005 · 020 — Aircraft Internal Dimensions
...
Documents the controlled internal dimensions of the programme-defined aircraft type including cabin cross-section, cabin ceiling height, cabin aisle width, overhead bin dimensions, seat track spacing, cargo hold internal envelope, and avionics bay access dimensions. Used for cabin configuration planning and cargo loading analysis.
...
| S1000D SNS | 005-020-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the aircraft internal dimensions scope;
...
The **Aircraft Internal Dimensions** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for aircraft internal dimensions. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Aircraft Internal Dimensions]
...
*Diagram 1 — System context for Aircraft Internal Dimensions.*
...
```mermaid
flowchart TB
    SYS[Aircraft Internal Dimensions] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Aircraft Internal Dimensions.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-005-020` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-005-020-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-005-020-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
