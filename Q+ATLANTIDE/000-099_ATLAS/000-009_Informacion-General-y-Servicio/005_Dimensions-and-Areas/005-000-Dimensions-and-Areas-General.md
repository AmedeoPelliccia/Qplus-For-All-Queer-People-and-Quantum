---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-005-000-DIMENSIONS-AND-AREAS-GENERAL"
title: "ATLAS 000-009 · 00.005.000 — Dimensions and Areas General"
register: ATLAS-1000
...
subsubject: "000"
subsubject_title: "Dimensions and Areas General"
subsubject_file: "005-000-Dimensions-and-Areas-General.md"
subsubject_link: "./005-000-Dimensions-and-Areas-General.md"
...
# ATLAS 000-009 · Section 00 · Subsection 005 · 000 — Dimensions and Areas General
...
Establishes the reference framework for aircraft dimensions, zones, and service areas on the programme-defined aircraft type. Defines the coordinate reference system (station, butt line, waterline), zone numbering scheme, and the controlled vocabulary used across all dimensional and zoning documentation.
...
| S1000D SNS | 005-000-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the dimensions and areas general scope;
...
The **Dimensions and Areas General** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for dimensions and areas general. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Dimensions and Areas General]
...
*Diagram 1 — System context for Dimensions and Areas General.*
...
```mermaid
flowchart TB
    SYS[Dimensions and Areas General] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Dimensions and Areas General.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-005-000` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-005-000-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-005-000-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
