---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-005-060-CABIN-CARGO-AND-EQUIPMENT-AREAS"
title: "ATLAS 000-009 · 00.005.060 — Cabin Cargo and Equipment Areas"
register: ATLAS-1000
...
subsubject: "060"
subsubject_title: "Cabin Cargo and Equipment Areas"
subsubject_file: "005-060-Cabin-Cargo-and-Equipment-Areas.md"
subsubject_link: "./005-060-Cabin-Cargo-and-Equipment-Areas.md"
...
# ATLAS 000-009 · Section 00 · Subsection 005 · 060 — Cabin Cargo and Equipment Areas
...
Documents the cabin, cargo, and equipment area layout for the programme-defined aircraft type, including the passenger cabin zones (forward, mid, aft), galley and lavatory positions, crew rest areas, cargo hold zones (forward, aft, bulk), avionics bay, and electrical equipment bay locations with zone references.
...
| S1000D SNS | 005-060-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the cabin cargo and equipment areas scope;
...
The **Cabin Cargo and Equipment Areas** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for cabin cargo and equipment areas. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Cabin Cargo and Equipment Areas]
...
*Diagram 1 — System context for Cabin Cargo and Equipment Areas.*
...
```mermaid
flowchart TB
    SYS[Cabin Cargo and Equipment Areas] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Cabin Cargo and Equipment Areas.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-005-060` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-005-060-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-005-060-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
