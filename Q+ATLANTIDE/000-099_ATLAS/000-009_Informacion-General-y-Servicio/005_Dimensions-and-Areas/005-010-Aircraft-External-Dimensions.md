---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-005-010-AIRCRAFT-EXTERNAL-DIMENSIONS"
title: "ATLAS 000-009 · 00.005.010 — Aircraft External Dimensions"
register: ATLAS-1000
...
subsubject: "010"
subsubject_title: "Aircraft External Dimensions"
subsubject_file: "005-010-Aircraft-External-Dimensions.md"
subsubject_link: "./005-010-Aircraft-External-Dimensions.md"
...
# ATLAS 000-009 · Section 00 · Subsection 005 · 010 — Aircraft External Dimensions
...
Documents the controlled external dimensions of the programme-defined aircraft type including overall length, wingspan, overall height, cabin width, cabin length, tail height, and wheelbase. Provides the controlled dimensional data required for airport compatibility assessments, hangar planning, and GSE clearance analysis.
...
| S1000D SNS | 005-010-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the aircraft external dimensions scope;
...
The **Aircraft External Dimensions** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for aircraft external dimensions. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Aircraft External Dimensions]
...
*Diagram 1 — System context for Aircraft External Dimensions.*
...
```mermaid
flowchart TB
    SYS[Aircraft External Dimensions] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Aircraft External Dimensions.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-005-010` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-005-010-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-005-010-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
