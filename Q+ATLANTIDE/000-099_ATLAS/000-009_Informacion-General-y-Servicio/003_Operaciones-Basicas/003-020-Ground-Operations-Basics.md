---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-003-020-GROUND-OPERATIONS-BASICS"
title: "ATLAS 000-009 · 00.003.020 — Ground Operations Basics"
register: ATLAS-1000
...
subsubject: "020"
subsubject_title: "Ground Operations Basics"
subsubject_file: "003-020-Ground-Operations-Basics.md"
subsubject_link: "./003-020-Ground-Operations-Basics.md"
...
# ATLAS 000-009 · Section 00 · Subsection 003 · 020 — Ground Operations Basics
...
Defines the general ground operations procedures for the programme-defined aircraft type, including aircraft reception, pre-flight checks, ground power connection (HVDC GPU), turnaround sequence, ground movement coordination, and the principal ground safety rules for an all-electric aircraft.
...
| S1000D SNS | 003-020-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Ground Operations Basics** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the ground operations basics scope;
...
The **Ground Operations Basics** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for ground operations basics. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Ground Operations Basics]
...
*Diagram 1 — System context for Ground Operations Basics.*
...
```mermaid
flowchart TB
    SYS[Ground Operations Basics] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Ground Operations Basics.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-003-020` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-003-020-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-003-020-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
