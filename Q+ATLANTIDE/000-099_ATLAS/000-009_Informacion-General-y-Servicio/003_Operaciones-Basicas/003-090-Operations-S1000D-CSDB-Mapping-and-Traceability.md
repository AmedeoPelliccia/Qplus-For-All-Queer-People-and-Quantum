---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-003-090-OPERATIONS-S1000D-CSDB-MAPPING-AND-TRACEABILITY"
title: "ATLAS 000-009 · 00.003.090 — Operations S1000D CSDB Mapping and Traceability"
register: ATLAS-1000
...
subsubject: "090"
subsubject_title: "Operations S1000D CSDB Mapping and Traceability"
subsubject_file: "003-090-Operations-S1000D-CSDB-Mapping-and-Traceability.md"
subsubject_link: "./003-090-Operations-S1000D-CSDB-Mapping-and-Traceability.md"
...
# ATLAS 000-009 · Section 00 · Subsection 003 · 090 — Operations S1000D CSDB Mapping and Traceability
...
Maps the operations basics artefacts defined in subsection 003 to S1000D CSDB data modules. Establishes DMC codes for operations data modules, BREX rules for operational procedure content, and the traceability chain from operations concept to CSDB data module for the programme-defined aircraft type.
...
| S1000D SNS | 003-090-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Operations S1000D CSDB Mapping and Traceability** node defines the correspondence between ATLAS 003 operational topics and the programme-defined aircraft type S1000D Data Module (DM) structure. Each 003-NNN subsubject maps to one or more S1000D system/sub-system codes under systemCode="003", and the resulting DMCs populate the CSDB under the model identification code [PROGRAMME-AIRCRAFT], system differential code [PROGRAMME-VARIANT].
...
- controlled definition of the operations s1000d csdb mapping and traceability scope;
...
The **Operations S1000D CSDB Mapping and Traceability** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for operations s1000d csdb mapping and traceability. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Operations S1000D CSDB Mapping and Traceability]
...
*Diagram 1 — System context for Operations S1000D CSDB Mapping and Traceability.*
...
```mermaid
flowchart TB
    SYS[Operations S1000D CSDB Mapping and Traceability] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Operations S1000D CSDB Mapping and Traceability.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-003-090` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-003-090-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-003-090-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
