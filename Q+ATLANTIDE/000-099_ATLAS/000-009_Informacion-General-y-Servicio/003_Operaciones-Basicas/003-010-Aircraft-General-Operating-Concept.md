...
Documents the AMPEL360E eWTW general operating concept, covering the aircraft mission profile, fleet utilisation assumptions, operational environment envelope, and the principal differences from conventional aircraft operations driven by the all-electric, bleed-less architecture.
...
The **Aircraft General Operating Concept** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the AMPEL360E eWTW programme.
...
| DMC prefix | `DMC-AMPEL360E-EWTW-003-010` | ![TBD](https://img.shields.io/badge/TBD-red) |
