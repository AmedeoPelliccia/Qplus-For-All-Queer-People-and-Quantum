---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-003-010-AIRCRAFT-GENERAL-OPERATING-CONCEPT"
title: "ATLAS 000-009 · 00.003.010 — Aircraft General Operating Concept"
register: ATLAS-1000
...
subsubject: "010"
subsubject_title: "Aircraft General Operating Concept"
subsubject_file: "003-010-Aircraft-General-Operating-Concept.md"
subsubject_link: "./003-010-Aircraft-General-Operating-Concept.md"
...
# ATLAS 000-009 · Section 00 · Subsection 003 · 010 — Aircraft General Operating Concept
...
Documents the programme-defined aircraft type general operating concept, covering the aircraft mission profile, fleet utilisation assumptions, operational environment envelope, and the principal differences from conventional aircraft operations driven by the all-electric, bleed-less architecture.
...
| S1000D SNS | 003-010-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Aircraft General Operating Concept** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the aircraft general operating concept scope;
...
The **Aircraft General Operating Concept** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for aircraft general operating concept. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Aircraft General Operating Concept]
...
*Diagram 1 — System context for Aircraft General Operating Concept.*
...
```mermaid
flowchart TB
    SYS[Aircraft General Operating Concept] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Aircraft General Operating Concept.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-003-010` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-003-010-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-003-010-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
