---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-003-080-OPERATIONAL-DATA-AND-REPORTING-BASICS"
title: "ATLAS 000-009 · 00.003.080 — Operational Data and Reporting Basics"
register: ATLAS-1000
...
subsubject: "080"
subsubject_title: "Operational Data and Reporting Basics"
subsubject_file: "003-080-Operational-Data-and-Reporting-Basics.md"
subsubject_link: "./003-080-Operational-Data-and-Reporting-Basics.md"
...
# ATLAS 000-009 · Section 00 · Subsection 003 · 080 — Operational Data and Reporting Basics
...
Defines the operational data recording and reporting requirements for the programme-defined aircraft type, including flight data recorder (FDR) parameter set, quick access recorder (QAR) data, ACARS/SATCOM operational reporting, and the interface between aircraft operational data and airline performance monitoring systems.
...
| S1000D SNS | 003-080-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Operational Data and Reporting Basics** node covers the data capture, retention, and reporting framework for operational events on the programme-defined aircraft type. The Aircraft Condition Monitoring System (ACMS) records IMA-sourced parameters at 1 Hz (normal) and 8 Hz (burst on trigger), including HVDC bus voltage/current, battery cell temperatures, motor-drive efficiency, and EAC load profiles.
...
- controlled definition of the operational data and reporting basics scope;
...
The **Operational Data and Reporting Basics** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for operational data and reporting basics. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Operational Data and Reporting Basics]
...
*Diagram 1 — System context for Operational Data and Reporting Basics.*
...
```mermaid
flowchart TB
    SYS[Operational Data and Reporting Basics] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Operational Data and Reporting Basics.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-003-080` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-003-080-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-003-080-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
