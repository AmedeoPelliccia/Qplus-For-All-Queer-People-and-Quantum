...
> | **Level 2 — Procedure** | `010-019_Manejo-en-Tierra-Servicio/` and its subsections | *How* each operation is executed: step sequences, safety checks, tooling requirements, limits, sign-offs. |
