---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-003-040-TURNAROUND-AND-DISPATCH-BASICS"
title: "ATLAS 000-009 · 00.003.040 — Turnaround and Dispatch Basics"
register: ATLAS-1000
...
subsubject: "040"
subsubject_title: "Turnaround and Dispatch Basics"
subsubject_file: "003-040-Turnaround-and-Dispatch-Basics.md"
subsubject_link: "./003-040-Turnaround-and-Dispatch-Basics.md"
...
# ATLAS 000-009 · Section 00 · Subsection 003 · 040 — Turnaround and Dispatch Basics
...
Establishes the standard turnaround and dispatch process for the programme-defined aircraft type, covering the sequence of activities between arrival and next departure including towing, servicing, refuelling, ground power management, cabin preparation, cargo handling, and the minimum equipment list (MEL) dispatch check process.
...
| S1000D SNS | 003-040-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the turnaround and dispatch basics scope;
...
The **Turnaround and Dispatch Basics** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for turnaround and dispatch basics. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Turnaround and Dispatch Basics]
...
*Diagram 1 — System context for Turnaround and Dispatch Basics.*
...
```mermaid
flowchart TB
    SYS[Turnaround and Dispatch Basics] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Turnaround and Dispatch Basics.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-003-040` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-003-040-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-003-040-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
