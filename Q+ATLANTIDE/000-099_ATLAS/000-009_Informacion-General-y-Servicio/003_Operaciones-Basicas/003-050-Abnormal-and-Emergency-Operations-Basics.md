...
Defines the general framework for abnormal and emergency operations on the AMPEL360E eWTW. Covers the hierarchy of QRH/ECAM actions, emergency electrical configuration, electrical fire procedures, and the crew coordination rules for non-normal events specific to the all-electric aircraft architecture.
...
The **Abnormal and Emergency Operations Basics** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the AMPEL360E eWTW programme.
...
| DMC prefix | `DMC-AMPEL360E-EWTW-003-050` | ![TBD](https://img.shields.io/badge/TBD-red) |
