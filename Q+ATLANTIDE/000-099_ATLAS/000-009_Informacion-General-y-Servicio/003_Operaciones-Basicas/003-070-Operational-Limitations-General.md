---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-003-070-OPERATIONAL-LIMITATIONS-GENERAL"
title: "ATLAS 000-009 · 00.003.070 — Operational Limitations General"
register: ATLAS-1000
...
subsubject: "070"
subsubject_title: "Operational Limitations General"
subsubject_file: "003-070-Operational-Limitations-General.md"
subsubject_link: "./003-070-Operational-Limitations-General.md"
...
# ATLAS 000-009 · Section 00 · Subsection 003 · 070 — Operational Limitations General
...
Summarises the principal operational limitations for the programme-defined aircraft type as defined in the Airplane Flight Manual (AFM) and Flight Crew Operating Manual (FCOM). Covers performance limits, environmental limits, power limits, and the specific limitations arising from the all-electric, bleed-less architecture.
...
| S1000D SNS | 003-070-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Operational Limitations General** node defines the master set of operational limitations applicable to the programme-defined aircraft type. Key limitations categories include: maximum/minimum battery SoC for dispatch, HVDC bus voltage and current ratings, motor/propulsor torque and speed limits, Environmental Control System (ECS/EAC) capacity limits as a function of ambient temperature, and All-Electric Anti-Ice (AEAI) power-draw limits during specific flight phases.

Range and diversion limitations are energy-based rather than fuel-mass-based: the [PROGRAMME-VARIANT] Operational Flight Plan (OFP) shall specify en-route energy reserves in kWh, and the applicable Airplane Flight Manual (AFM) shall define minimum diversion SoC at destination. ETOPS-analogous rules ("eTOPS") apply for routes with en-route alternates beyond the nominal single-propulsor-failed energy range. Certification basis is EASA CS-25 Amendment 27+ with Special Conditions for electric propulsion systems.
...
- controlled definition of the operational limitations general scope;
...
The **Operational Limitations General** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for operational limitations general. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Operational Limitations General]
...
*Diagram 1 — System context for Operational Limitations General.*
...
```mermaid
flowchart TB
    SYS[Operational Limitations General] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Operational Limitations General.*
...
| System code | `003` | ![TBD](https://img.shields.io/badge/TBD-red) |
| Sub-system code | `070` | ![TBD](https://img.shields.io/badge/TBD-red) |
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-003-070` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-003-070-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-003-070-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
