---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-003-060-CREW-AND-MAINTENANCE-COORDINATION-BASICS"
title: "ATLAS 000-009 · 00.003.060 — Crew and Maintenance Coordination Basics"
register: ATLAS-1000
...
subsubject: "060"
subsubject_title: "Crew and Maintenance Coordination Basics"
subsubject_file: "003-060-Crew-and-Maintenance-Coordination-Basics.md"
subsubject_link: "./003-060-Crew-and-Maintenance-Coordination-Basics.md"
...
# ATLAS 000-009 · Section 00 · Subsection 003 · 060 — Crew and Maintenance Coordination Basics
...
Documents the coordination protocols between flight crew, cabin crew, and maintenance personnel for the programme-defined aircraft type. Covers MEL/CDL release procedures, crew notification of deferred maintenance items, ground maintenance access control, and the interface between aircraft CMS and airline maintenance operations centre.
...
| S1000D SNS | 003-060-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the crew and maintenance coordination basics scope;
...
The **Crew and Maintenance Coordination Basics** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for crew and maintenance coordination basics. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Crew and Maintenance Coordination Basics]
...
*Diagram 1 — System context for Crew and Maintenance Coordination Basics.*
...
```mermaid
flowchart TB
    SYS[Crew and Maintenance Coordination Basics] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Crew and Maintenance Coordination Basics.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-003-060` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-003-060-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-003-060-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
