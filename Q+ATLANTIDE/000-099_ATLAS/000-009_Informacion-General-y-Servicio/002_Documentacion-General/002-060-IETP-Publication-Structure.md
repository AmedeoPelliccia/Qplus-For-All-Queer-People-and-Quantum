---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-002-060-IETP-PUBLICATION-STRUCTURE"
title: "ATLAS 000-009 · 00.002.060 — IETP Publication Structure"
register: ATLAS-1000
...
subsubject: "060"
subsubject_title: "IETP Publication Structure"
subsubject_file: "002-060-IETP-Publication-Structure.md"
subsubject_link: "./002-060-IETP-Publication-Structure.md"
...
# ATLAS 000-009 · Section 00 · Subsection 002 · 060 — IETP Publication Structure
...
Documents the Interactive Electronic Technical Publication (IETP) structure for the programme-defined aircraft type, including publication module organization, navigation hierarchy, applicability filtering, and the interface between S1000D CSDB data modules and the IETP delivery system used by airline maintenance organizations.
...
| S1000D SNS | 002-060-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **IETP Publication Structure** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the ietp publication structure scope;
...
The **IETP Publication Structure** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for ietp publication structure. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[IETP Publication Structure]
...
*Diagram 1 — System context for IETP Publication Structure.*
...
```mermaid
flowchart TB
    SYS[IETP Publication Structure] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for IETP Publication Structure.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-002-060` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-002-060-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-002-060-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
