---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-002-030-CSDB-STRUCTURE-AND-GOVERNANCE"
title: "ATLAS 000-009 · 00.002.030 — CSDB Structure and Governance"
register: ATLAS-1000
...
subsubject: "030"
subsubject_title: "CSDB Structure and Governance"
subsubject_file: "002-030-CSDB-Structure-and-Governance.md"
subsubject_link: "./002-030-CSDB-Structure-and-Governance.md"
...
# ATLAS 000-009 · Section 00 · Subsection 002 · 030 — CSDB Structure and Governance
...
Defines the Common Source DataBase (CSDB) structure, folder organization, naming conventions, and governance rules for the programme-defined aircraft type programme. Establishes the CCB-controlled CSDB access policies, data module lifecycle states, and the interface with the programme PLM system.
...
| S1000D SNS | 002-030-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **CSDB Structure and Governance** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the csdb structure and governance scope;
...
The **CSDB Structure and Governance** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for csdb structure and governance. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[CSDB Structure and Governance]
...
*Diagram 1 — System context for CSDB Structure and Governance.*
...
```mermaid
flowchart TB
    SYS[CSDB Structure and Governance] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for CSDB Structure and Governance.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-002-030` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-002-030-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-002-030-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
