---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-002-040-DMRL-AND-DATA-MODULE-PLANNING"
title: "ATLAS 000-009 · 00.002.040 — DMRL and Data Module Planning"
register: ATLAS-1000
...
subsubject: "040"
subsubject_title: "DMRL and Data Module Planning"
subsubject_file: "002-040-DMRL-and-Data-Module-Planning.md"
subsubject_link: "./002-040-DMRL-and-Data-Module-Planning.md"
...
# ATLAS 000-009 · Section 00 · Subsection 002 · 040 — DMRL and Data Module Planning
...
Documents the Data Module Requirement List (DMRL) planning process for the programme-defined aircraft type. Defines the DMRL structure, system/subsystem scope allocation, applicability planning, info-code assignment, and the DMRL review and approval process with the design authority and operators.
...
| S1000D SNS | 002-040-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **DMRL and Data Module Planning** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the dmrl and data module planning scope;
...
The **DMRL and Data Module Planning** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for dmrl and data module planning. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[DMRL and Data Module Planning]
...
*Diagram 1 — System context for DMRL and Data Module Planning.*
...
```mermaid
flowchart TB
    SYS[DMRL and Data Module Planning] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for DMRL and Data Module Planning.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-002-040` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-002-040-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-002-040-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
