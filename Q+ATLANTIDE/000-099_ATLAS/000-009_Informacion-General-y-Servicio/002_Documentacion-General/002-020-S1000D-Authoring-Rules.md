---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-002-020-S1000D-AUTHORING-RULES"
title: "ATLAS 000-009 · 00.002.020 — S1000D Authoring Rules"
register: ATLAS-1000
...
subsubject: "020"
subsubject_title: "S1000D Authoring Rules"
subsubject_file: "002-020-S1000D-Authoring-Rules.md"
subsubject_link: "./002-020-S1000D-Authoring-Rules.md"
...
# ATLAS 000-009 · Section 00 · Subsection 002 · 020 — S1000D Authoring Rules
...
Documents the controlled authoring rules for S1000D data modules applicable to the programme-defined aircraft type CSDB. Covers Simplified Technical English (STE) requirements, markup conventions, content management tags, applicability statement rules, and ICN (Illustration Control Number) authoring standards.
...
| S1000D SNS | 002-020-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **S1000D Authoring Rules** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the s1000d authoring rules scope;
...
The **S1000D Authoring Rules** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for s1000d authoring rules. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[S1000D Authoring Rules]
...
*Diagram 1 — System context for S1000D Authoring Rules.*
...
```mermaid
flowchart TB
    SYS[S1000D Authoring Rules] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for S1000D Authoring Rules.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-002-020` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-002-020-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-002-020-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
