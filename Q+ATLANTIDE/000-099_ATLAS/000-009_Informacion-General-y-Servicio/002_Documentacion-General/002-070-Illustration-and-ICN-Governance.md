---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-002-070-ILLUSTRATION-AND-ICN-GOVERNANCE"
title: "ATLAS 000-009 · 00.002.070 — Illustration and ICN Governance"
register: ATLAS-1000
...
subsubject: "070"
subsubject_title: "Illustration and ICN Governance"
subsubject_file: "002-070-Illustration-and-ICN-Governance.md"
subsubject_link: "./002-070-Illustration-and-ICN-Governance.md"
...
# ATLAS 000-009 · Section 00 · Subsection 002 · 070 — Illustration and ICN Governance
...
Establishes the Illustration Control Number (ICN) scheme and illustration governance rules for the programme-defined aircraft type. Covers ICN formation rules, illustration type classification (isometric, schematic, exploded-view, installation diagram), and the controlled process for illustration creation, review, and CSDB integration.
...
| S1000D SNS | 002-070-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Illustration and ICN Governance** node covers the architecture, interfaces, operational logic, maintenance boundaries, and traceability requirements associated with this topic.
...
- controlled definition of the illustration and icn governance scope;
...
The **Illustration and ICN Governance** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for illustration and icn governance. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Illustration and ICN Governance]
...
*Diagram 1 — System context for Illustration and ICN Governance.*
...
```mermaid
flowchart TB
    SYS[Illustration and ICN Governance] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Illustration and ICN Governance.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-002-070` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-002-070-001 | Content requires review by system expert. | Q-DATAGOV | open |
| OI-002-070-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
