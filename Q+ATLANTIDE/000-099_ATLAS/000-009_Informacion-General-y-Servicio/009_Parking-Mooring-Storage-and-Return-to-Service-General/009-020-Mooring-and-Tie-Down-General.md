---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-009-020-MOORING-AND-TIE-DOWN-GENERAL"
title: "ATLAS 000-009 · 00.009.020 — Mooring and Tie Down General"
register: ATLAS-1000
...
subsubject: "020"
subsubject_title: "Mooring and Tie Down General"
subsubject_file: "009-020-Mooring-and-Tie-Down-General.md"
subsubject_link: "./009-020-Mooring-and-Tie-Down-General.md"
...
# ATLAS 000-009 · Section 00 · Subsection 009 · 020 — Mooring and Tie Down General
...
Defines the aircraft mooring and tie-down procedures for the programme-defined aircraft type. Covers mooring point locations, tie-down chain and strap specifications, minimum tie-down configuration for wind speeds up to 65 knots (line maintenance) and 100 knots (storm mooring), and the approved tie-down GSE part numbers.
...
| S1000D SNS | 009-020-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the mooring and tie down general scope;
...
The **Mooring and Tie Down General** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for mooring and tie down general. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Mooring and Tie Down General]
...
*Diagram 1 — System context for Mooring and Tie Down General.*
...
```mermaid
flowchart TB
    SYS[Mooring and Tie Down General] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Mooring and Tie Down General.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-009-020` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-009-020-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-009-020-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
