...
The **Long-Term Storage** node defines the procedures, preservation requirements, and periodic inspection schedule for parking the AMPEL360E eWTW out of service for more than 30 days, up to a maximum of 24 months. Long-term storage (LTS) imposes more extensive preservation actions than short-term storage, particularly for: (A) traction battery pack — SoC target 50%; HVDC GPU trickle-charge maintained; battery management system (BMS) performs a full cell-balance cycle every 30 days; monthly inspection includes visual check of battery enclosure vents and thermal management coolant level; (B) electric drive systems — ENWTD and ENWS actuator lubricant preservation per AMM 09-40 (manual shaft rotation every 60 days to prevent bearing false-brinelling); (C) fuel system — tanks drained and purged per AMM 28-40 (eWTW fuel is Jet A-1/SAF blend; microbial growth inhibitor STADIS-450 added at 1:1 000 ratio before drain); (D) hydraulic system — not applicable (no hydraulic system on the eWTW); (E) engine — each CFM RISE-derived turbofan preserved per CMM 72-00 (fog-oil spray, all ports sealed with moisture-absorbing desiccant plugs).
