---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-009-060-SYSTEM-PRESERVATION-AND-DEPRESERVATION"
title: "ATLAS 000-009 · 00.009.060 — System Preservation and Depreservation"
register: ATLAS-1000
...
subsubject: "060"
subsubject_title: "System Preservation and Depreservation"
subsubject_file: "009-060-System-Preservation-and-Depreservation.md"
subsubject_link: "./009-060-System-Preservation-and-Depreservation.md"
...
# ATLAS 000-009 · Section 00 · Subsection 009 · 060 — System Preservation and Depreservation
...
Documents the controlled system preservation and depreservation procedures for the programme-defined aircraft type. Covers HVDC battery preservation (discharge to storage SOC, cell voltage equalisation), fuel system preservation (inhibitor treatment), landing gear preservation, and the controlled depreservation sequence and functional test requirements before return to service.
...
| S1000D SNS | 009-060-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **System Preservation and Depreservation** node defines the step-by-step preservation and depreservation actions for each aircraft system on the programme-defined aircraft type, referenced by storage duration category. The [PROGRAMME-VARIANT] preservation philosophy is driven by the replacement of legacy hydraulic and pneumatic systems with electric and digital systems, significantly reducing the number of fluid-based preservation actions and replacing them with software-mode and electro-mechanical preservation steps.
...
- controlled definition of the system preservation and depreservation scope;
...
The **System Preservation and Depreservation** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for system preservation and depreservation. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[System Preservation and Depreservation]
...
*Diagram 1 — System context for System Preservation and Depreservation.*
...
```mermaid
flowchart TB
    SYS[System Preservation and Depreservation] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for System Preservation and Depreservation.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-009-060` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-009-060-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-009-060-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
