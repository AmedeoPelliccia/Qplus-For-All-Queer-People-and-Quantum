---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-009-030-SHORT-TERM-STORAGE"
title: "ATLAS 000-009 · 00.009.030 — Short-Term Storage"
register: ATLAS-1000
...
subsubject: "030"
subsubject_title: "Short-Term Storage"
subsubject_file: "009-030-Short-Term-Storage.md"
subsubject_link: "./009-030-Short-Term-Storage.md"
...
# ATLAS 000-009 · Section 00 · Subsection 009 · 030 — Short-Term Storage
...
| S1000D SNS | 009-030-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for short-term storage. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Short-Term Storage]
...
*Diagram 1 — System context for Short-Term Storage.*
...
```mermaid
flowchart TB
    SYS[Short-Term Storage] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Short-Term Storage.*
...
|---|---|---|---|
| OI-009-030-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-009-030-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
