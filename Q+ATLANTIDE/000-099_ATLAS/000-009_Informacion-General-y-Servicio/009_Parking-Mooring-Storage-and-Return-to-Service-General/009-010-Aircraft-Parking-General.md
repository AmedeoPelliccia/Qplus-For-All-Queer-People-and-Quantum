---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-009-010-AIRCRAFT-PARKING-GENERAL"
title: "ATLAS 000-009 · 00.009.010 — Aircraft Parking General"
register: ATLAS-1000
...
subsubject: "010"
subsubject_title: "Aircraft Parking General"
subsubject_file: "009-010-Aircraft-Parking-General.md"
subsubject_link: "./009-010-Aircraft-Parking-General.md"
...
# ATLAS 000-009 · Section 00 · Subsection 009 · 010 — Aircraft Parking General
...
Documents the general parking procedures for the programme-defined aircraft type, covering parking spot requirements, aircraft positioning, wheel chocking and chock placement, HVDC system status during parking, ground power connection for battery maintenance, and the normal handover procedure from flight operations to ground servicing.
...
| S1000D SNS | 009-010-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the aircraft parking general scope;
...
The **Aircraft Parking General** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for aircraft parking general. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Aircraft Parking General]
...
*Diagram 1 — System context for Aircraft Parking General.*
...
```mermaid
flowchart TB
    SYS[Aircraft Parking General] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Aircraft Parking General.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-009-010` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-009-010-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-009-010-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
