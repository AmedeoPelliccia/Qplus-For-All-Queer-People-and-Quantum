---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-007-070-WEIGHING-RECORDS-AND-TRACEABILITY"
title: "ATLAS 000-009 · 00.007.070 — Weighing Records and Traceability"
register: ATLAS-1000
...
subsubject: "070"
subsubject_title: "Weighing Records and Traceability"
subsubject_file: "007-070-Weighing-Records-and-Traceability.md"
subsubject_link: "./007-070-Weighing-Records-and-Traceability.md"
...
# ATLAS 000-009 · Section 00 · Subsection 007 · 070 — Weighing Records and Traceability
...
Documents the controlled weighing record format, retention requirements, and traceability chain for the programme-defined aircraft type. Defines the Official Weighing Record structure, the QA signature authority, the interface with the aircraft technical log, and the CSDB evidence record for weight and balance compliance.
...
| S1000D SNS | 007-070-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
The **Weighing Records and Traceability** node defines the documentation, retention, and traceability requirements for all leveling and weighing events on the programme-defined aircraft type. Each weighing event generates three mandatory records: (1) WMMS-LW raw data export (CSV, auto-archived to CSDB as DM info code "200"); (2) signed Weighing Report (Q-WB-REPORT-001, in PDF, generated from the WMMS-LW export and signed by LAME B1 and quality representative); (3) Mass and Balance Statement (Q-MB-STAT-001), issued after OEW computation and C-of-G confirmation, stored in the aircraft technical log and in the CSDB aircraft configuration record.
...
- controlled definition of the weighing records and traceability scope;
...
The **Weighing Records and Traceability** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for weighing records and traceability. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Weighing Records and Traceability]
...
*Diagram 1 — System context for Weighing Records and Traceability.*
...
```mermaid
flowchart TB
    SYS[Weighing Records and Traceability] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Weighing Records and Traceability.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-007-070` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-007-070-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-007-070-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
