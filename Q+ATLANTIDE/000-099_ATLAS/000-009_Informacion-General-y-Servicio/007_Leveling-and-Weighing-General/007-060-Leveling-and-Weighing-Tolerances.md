---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-007-060-LEVELING-AND-WEIGHING-TOLERANCES"
title: "ATLAS 000-009 · 00.007.060 — Leveling and Weighing Tolerances"
register: ATLAS-1000
...
subsubject: "060"
subsubject_title: "Leveling and Weighing Tolerances"
subsubject_file: "007-060-Leveling-and-Weighing-Tolerances.md"
subsubject_link: "./007-060-Leveling-and-Weighing-Tolerances.md"
...
# ATLAS 000-009 · Section 00 · Subsection 007 · 060 — Leveling and Weighing Tolerances
...
Defines the controlled tolerances for leveling and weighing operations on the programme-defined aircraft type. Covers acceptable level tolerance at each reference point, weighing accuracy requirements, CG tolerance limits, and the acceptance or rejection criteria for the Official Weighing Record.
...
| S1000D SNS | 007-060-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the leveling and weighing tolerances scope;
...
The **Leveling and Weighing Tolerances** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for leveling and weighing tolerances. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Leveling and Weighing Tolerances]
...
*Diagram 1 — System context for Leveling and Weighing Tolerances.*
...
```mermaid
flowchart TB
    SYS[Leveling and Weighing Tolerances] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Leveling and Weighing Tolerances.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-007-060` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-007-060-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-007-060-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
