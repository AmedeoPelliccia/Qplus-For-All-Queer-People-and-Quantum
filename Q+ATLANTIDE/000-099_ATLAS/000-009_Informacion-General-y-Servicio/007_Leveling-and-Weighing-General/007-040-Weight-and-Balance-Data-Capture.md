---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-007-040-WEIGHT-AND-BALANCE-DATA-CAPTURE"
title: "ATLAS 000-009 · 00.007.040 — Weight and Balance Data Capture"
register: ATLAS-1000
...
subsubject: "040"
subsubject_title: "Weight and Balance Data Capture"
subsubject_file: "007-040-Weight-and-Balance-Data-Capture.md"
subsubject_link: "./007-040-Weight-and-Balance-Data-Capture.md"
...
# ATLAS 000-009 · Section 00 · Subsection 007 · 040 — Weight and Balance Data Capture
...
| S1000D SNS | 007-040-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for weight and balance data capture. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Weight and Balance Data Capture]
...
*Diagram 1 — System context for Weight and Balance Data Capture.*
...
```mermaid
flowchart TB
    SYS[Weight and Balance Data Capture] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Weight and Balance Data Capture.*
...
|---|---|---|---|
| OI-007-040-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-007-040-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
