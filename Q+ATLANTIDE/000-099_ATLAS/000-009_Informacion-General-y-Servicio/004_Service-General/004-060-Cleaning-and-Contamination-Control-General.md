---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-004-060-CLEANING-AND-CONTAMINATION-CONTROL-GENERAL"
title: "ATLAS 000-009 · 00.004.060 — Cleaning and Contamination Control General"
register: ATLAS-1000
...
subsubject: "060"
subsubject_title: "Cleaning and Contamination Control General"
subsubject_file: "004-060-Cleaning-and-Contamination-Control-General.md"
subsubject_link: "./004-060-Cleaning-and-Contamination-Control-General.md"
...
# ATLAS 000-009 · Section 00 · Subsection 004 · 060 — Cleaning and Contamination Control General
...
Establishes the cleaning and contamination control requirements for the programme-defined aircraft type, covering airframe external cleaning, fuel contamination checks, hydraulic (TBD) contamination sampling, potable water system disinfection, cargo hold cleaning, and the controlled cleaning products approved for use on composite and metallic surfaces.
...
| S1000D SNS | 004-060-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the cleaning and contamination control general scope;
...
The **Cleaning and Contamination Control General** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for cleaning and contamination control general. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Cleaning and Contamination Control General]
...
*Diagram 1 — System context for Cleaning and Contamination Control General.*
...
```mermaid
flowchart TB
    SYS[Cleaning and Contamination Control General] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Cleaning and Contamination Control General.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-004-060` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-004-060-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-004-060-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
