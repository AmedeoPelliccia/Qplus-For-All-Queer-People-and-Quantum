---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-004-020-SERVICE-ACCESS-AND-GROUND-SAFETY"
title: "ATLAS 000-009 · 00.004.020 — Service Access and Ground Safety"
register: ATLAS-1000
...
subsubject: "020"
subsubject_title: "Service Access and Ground Safety"
subsubject_file: "004-020-Service-Access-and-Ground-Safety.md"
subsubject_link: "./004-020-Service-Access-and-Ground-Safety.md"
...
# ATLAS 000-009 · Section 00 · Subsection 004 · 020 — Service Access and Ground Safety
...
Defines the service access provisions and ground safety rules for the programme-defined aircraft type. Covers the aircraft grounding and bonding requirements for an HVDC system, HVDC bus isolation procedures, access panel locations, personnel fall protection requirements, and safety interlocks for service access panels.
...
| S1000D SNS | 004-020-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the service access and ground safety scope;
...
The **Service Access and Ground Safety** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for service access and ground safety. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Service Access and Ground Safety]
...
*Diagram 1 — System context for Service Access and Ground Safety.*
...
```mermaid
flowchart TB
    SYS[Service Access and Ground Safety] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Service Access and Ground Safety.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-004-020` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-004-020-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-004-020-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
