---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-004-040-SERVICE-POINTS-AND-PANELS-GENERAL"
title: "ATLAS 000-009 · 00.004.040 — Service Points and Panels General"
register: ATLAS-1000
...
subsubject: "040"
subsubject_title: "Service Points and Panels General"
subsubject_file: "004-040-Service-Points-and-Panels-General.md"
subsubject_link: "./004-040-Service-Points-and-Panels-General.md"
...
# ATLAS 000-009 · Section 00 · Subsection 004 · 040 — Service Points and Panels General
...
Documents the general layout of service points and service panels on the programme-defined aircraft type. Covers the fuel service panel, oil service points, coolant service points, de-icing fluid service points, potable water service point, waste service point, nitrogen charge points, and ground power receptacle locations.
...
| S1000D SNS | 004-040-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the service points and panels general scope;
...
The **Service Points and Panels General** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for service points and panels general. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Service Points and Panels General]
...
*Diagram 1 — System context for Service Points and Panels General.*
...
```mermaid
flowchart TB
    SYS[Service Points and Panels General] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Service Points and Panels General.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-004-040` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-004-040-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-004-040-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
