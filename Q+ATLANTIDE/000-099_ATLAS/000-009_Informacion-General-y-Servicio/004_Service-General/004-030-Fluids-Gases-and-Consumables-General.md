---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-004-030-FLUIDS-GASES-AND-CONSUMABLES-GENERAL"
title: "ATLAS 000-009 · 00.004.030 — Fluids Gases and Consumables General"
register: ATLAS-1000
...
subsubject: "030"
subsubject_title: "Fluids Gases and Consumables General"
subsubject_file: "004-030-Fluids-Gases-and-Consumables-General.md"
subsubject_link: "./004-030-Fluids-Gases-and-Consumables-General.md"
...
# ATLAS 000-009 · Section 00 · Subsection 004 · 030 — Fluids Gases and Consumables General
...
Documents the controlled fluids, gases, and consumables applicable to the programme-defined aircraft type, including aviation fuel specifications (Jet-A, Jet-A-1, SAF ASTM D7566), hydraulic fluid (if applicable TBD — bleed-less architecture), lubricants, coolants, and compressed gases. Defines cross-reference to supplier-controlled specifications.
...
| S1000D SNS | 004-030-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the fluids gases and consumables general scope;
...
The **Fluids Gases and Consumables General** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for fluids gases and consumables general. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Fluids Gases and Consumables General]
...
*Diagram 1 — System context for Fluids Gases and Consumables General.*
...
```mermaid
flowchart TB
    SYS[Fluids Gases and Consumables General] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Fluids Gases and Consumables General.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-004-030` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-004-030-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-004-030-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
