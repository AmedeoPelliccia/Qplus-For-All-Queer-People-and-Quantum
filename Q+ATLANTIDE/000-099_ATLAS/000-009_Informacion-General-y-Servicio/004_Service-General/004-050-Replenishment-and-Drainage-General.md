---
document_id: "QATL-ATLAS-1000-ATLAS-000-009-00-004-050-REPLENISHMENT-AND-DRAINAGE-GENERAL"
title: "ATLAS 000-009 · 00.004.050 — Replenishment and Drainage General"
register: ATLAS-1000
...
subsubject: "050"
subsubject_title: "Replenishment and Drainage General"
subsubject_file: "004-050-Replenishment-and-Drainage-General.md"
subsubject_link: "./004-050-Replenishment-and-Drainage-General.md"
...
# ATLAS 000-009 · Section 00 · Subsection 004 · 050 — Replenishment and Drainage General
...
Defines the general replenishment and drainage procedures for the programme-defined aircraft type, covering fuel upload (pressure refuelling and gravity refuelling), oil replenishment, coolant replenishment, potable water upload, waste tank drainage, and hydraulic (if applicable) fluid replenishment. Covers SAF compatibility requirements.
...
| S1000D SNS | 004-050-00 | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
- controlled definition of the replenishment and drainage general scope;
...
The **Replenishment and Drainage General** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries within the 000-009 General Information and Service section of the programme-defined aircraft type programme.
...
|---:|---|---|---|---|
| F-001 | Core Function | Primary controlled function for replenishment and drainage general. | [Interfaces](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[Replenishment and Drainage General]
...
*Diagram 1 — System context for Replenishment and Drainage General.*
...
```mermaid
flowchart TB
    SYS[Replenishment and Drainage General] --> F1[Core Function]
...
*Diagram 2 — Internal functional architecture for Replenishment and Drainage General.*
...
| DMC prefix | `DMC-<PROGRAMME>-<VARIANT>-004-050` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
|---|---|---|---|
| OI-004-050-001 | Content requires review by system expert. | Q-GROUND | open |
| OI-004-050-002 | S1000D DMC mapping to be validated against DMRL. | Q-DATAGOV | open |
