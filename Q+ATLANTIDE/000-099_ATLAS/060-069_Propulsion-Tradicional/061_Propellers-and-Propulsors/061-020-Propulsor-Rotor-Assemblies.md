---
document_id: "QATL-ATLAS-1000-ATLAS-060-069-06-061-020-PROPULSOR-ROTOR-ASSEMBLIES"
title: "ATLAS 060-069 · 06.061.020 — Propulsor Rotor Assemblies"
register: ATLAS-1000
...
subsubject: "020"
subsubject_title: "Propulsor Rotor Assemblies"
subsubject_file: "061-020-Propulsor-Rotor-Assemblies.md"
subsubject_link: "./061-020-Propulsor-Rotor-Assemblies.md"
...
# ATLAS 060-069 · Section 06 · Subsection 061 · 020 — Propulsor Rotor Assemblies
...
This document defines the controlled technical scope for **Propulsor Rotor Assemblies** (`061-020`) within the [Q+ATLANTIDE](../../../../../Q+ATLANTIDE/) / [ATLAS 000-099](../../../) architecture branch, section [060-069 Propulsión Tradicional](../../).

The objective is to provide a deterministic, [S1000D](https://s1000d.org/)-compatible technical baseline covering the architecture, components, and controlled definition for propulsor rotor assemblies including ducted fan and contra-rotating configurations.

This file belongs to:

[`Q+ATLANTIDE/000-099_ATLAS/060-069_Propulsion-Tradicional/061_Propellers-and-Propulsors/061-020-Propulsor-Rotor-Assemblies.md`](./)
...
The **Propulsor Rotor Assemblies** node covers the architecture, components, and controlled definition for propulsor rotor assemblies including ducted fan and contra-rotating configurations.
...
- Define propulsor rotor assembly configuration
- Document ducted and open rotor variants
- Specify structural and interface requirements
- Define performance and installation parameters
- Map to S1000D DMs
...
The **Propulsor Rotor Assemblies** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries.
...
|---:|---|---|---|---|
| [F-001](#f-001) | <a id="f-001"></a>Define propulsor rotor assembly configuration | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
| [F-002](#f-002) | <a id="f-002"></a>Document ducted and open rotor variants | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
| [F-003](#f-003) | <a id="f-003"></a>Specify structural and interface requirements | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
***[Diagram 1](#diagram-system-context) — System context diagram for Propulsor Rotor Assemblies. Related sections: [Interfaces](#10-interfaces), [Monitoring and Diagnostics](#12-monitoring-and-diagnostics), [S1000D / CSDB Mapping](#14-s1000d--csdb-mapping).***
...
```mermaid
flowchart TB
    SYS[061-020 Propulsor Rotor Assemblies] --> F1[Define propulsor rotor assembly configuration]
    SYS --> F2[Document ducted and open rotor variants]
...
| Sub-sub-system code | `20` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
| DMC prefix | [`DMC-AMPEL360E-EWTW-061-020`](TBD) | ![TBD](https://img.shields.io/badge/TBD-red) |

### Recommended Data Module Set

| Info code | Data module purpose | Suggested filename | Status |
|---:|---|---|---|
| [040](#dm-040) | <a id="dm-040"></a>Descriptive information | [`DMC-AMPEL360E-EWTW-061-020-040A-D_System-Description.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [300](#dm-300) | <a id="dm-300"></a>Examination / inspection / check | [`DMC-AMPEL360E-EWTW-061-020-300A-D_Inspection.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [400](#dm-400) | <a id="dm-400"></a>Fault isolation | [`DMC-AMPEL360E-EWTW-061-020-400A-D_Fault-Isolation.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [520](#dm-520) | <a id="dm-520"></a>Remove / disassemble | [`DMC-AMPEL360E-EWTW-061-020-520A-D_Remove.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [720](#dm-720) | <a id="dm-720"></a>Install / assemble / connect | [`DMC-AMPEL360E-EWTW-061-020-720A-D_Install.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [941](#dm-941) | <a id="dm-941"></a>Illustrated parts data | [`DMC-AMPEL360E-EWTW-061-020-941A-D_Illustrated-Parts-Data.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
|---|---|---|---|---|---|
| [OI-001](#oi-001) | <a id="oi-001"></a>Confirm final system boundary for Propulsor Rotor Assemblies. | System expert | TBD | ![TBD](https://img.shields.io/badge/TBD-red) | [Architecture Description](#5-architecture-description) |
| [OI-002](#oi-002) | <a id="oi-002"></a>Complete S1000D SNS allocation for 061-020. | Q-DATAGOV | To Be Completed | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) | [S1000D / CSDB Mapping](#14-s1000d--csdb-mapping) |
...
|---|---|---|---|---|---|
| [0.1.0](#chg-010) | <a id="chg-010"></a>2026-05-11 | Q+ Team / Amedeo Pelliccia + AI | Initial programme-controlled scaffold. | [Document root](#atlas-060-069--section-06--subsection-061--020--propulsor-rotor-assemblies) | ![DRAFT](https://img.shields.io/badge/DRAFT-yellow) |
