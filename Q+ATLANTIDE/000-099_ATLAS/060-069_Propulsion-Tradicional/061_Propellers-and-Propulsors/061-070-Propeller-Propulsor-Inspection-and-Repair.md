---
document_id: "QATL-ATLAS-1000-ATLAS-060-069-06-061-070-PROPELLERPROPULSOR-INSPECTION-AND-REPAIR"
title: "ATLAS 060-069 · 06.061.070 — Propeller/Propulsor Inspection and Repair"
register: ATLAS-1000
...
subsubject: "070"
subsubject_title: "Propeller/Propulsor Inspection and Repair"
subsubject_file: "061-070-Propeller-Propulsor-Inspection-and-Repair.md"
subsubject_link: "./061-070-Propeller-Propulsor-Inspection-and-Repair.md"
...
# ATLAS 060-069 · Section 06 · Subsection 061 · 070 — Propeller/Propulsor Inspection and Repair
...
This document defines the controlled technical scope for **Propeller/Propulsor Inspection and Repair** (`061-070`) within the [Q+ATLANTIDE](../../../../../Q+ATLANTIDE/) / [ATLAS 000-099](../../../) architecture branch, section [060-069 Propulsión Tradicional](../../).

The objective is to provide a deterministic, [S1000D](https://s1000d.org/)-compatible technical baseline covering the inspection criteria, approved repair schemes, and return-to-service requirements for propeller and propulsor components.

This file belongs to:

[`Q+ATLANTIDE/000-099_ATLAS/060-069_Propulsion-Tradicional/061_Propellers-and-Propulsors/061-070-Propeller-Propulsor-Inspection-and-Repair.md`](./)
...
The **Propeller/Propulsor Inspection and Repair** node covers the inspection criteria, approved repair schemes, and return-to-service requirements for propeller and propulsor components.
...
- Define scheduled inspection criteria and intervals
- Specify approved repair schemes by damage type
- Document composite and metallic repair procedures
- Define functional test after repair
- Map to S1000D inspection and repair DMs
...
The **Propeller/Propulsor Inspection and Repair** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries.
...
|---:|---|---|---|---|
| [F-001](#f-001) | <a id="f-001"></a>Define scheduled inspection criteria and intervals | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
| [F-002](#f-002) | <a id="f-002"></a>Specify approved repair schemes by damage type | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
| [F-003](#f-003) | <a id="f-003"></a>Document composite and metallic repair procedures | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
***[Diagram 1](#diagram-system-context) — System context diagram for Propeller/Propulsor Inspection and Repair. Related sections: [Interfaces](#10-interfaces), [Monitoring and Diagnostics](#12-monitoring-and-diagnostics), [S1000D / CSDB Mapping](#14-s1000d--csdb-mapping).***
...
```mermaid
flowchart TB
    SYS[061-070 Propeller/Propulsor Inspection and ] --> F1[Define scheduled inspection criteria and intervals]
    SYS --> F2[Specify approved repair schemes by damage type]
...
| DMC prefix | [`DMC-AMPEL360E-EWTW-061-070`](TBD) | ![TBD](https://img.shields.io/badge/TBD-red) |

### Recommended Data Module Set

| Info code | Data module purpose | Suggested filename | Status |
|---:|---|---|---|
| [040](#dm-040) | <a id="dm-040"></a>Descriptive information | [`DMC-AMPEL360E-EWTW-061-070-040A-D_System-Description.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [300](#dm-300) | <a id="dm-300"></a>Examination / inspection / check | [`DMC-AMPEL360E-EWTW-061-070-300A-D_Inspection.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [400](#dm-400) | <a id="dm-400"></a>Fault isolation | [`DMC-AMPEL360E-EWTW-061-070-400A-D_Fault-Isolation.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [520](#dm-520) | <a id="dm-520"></a>Remove / disassemble | [`DMC-AMPEL360E-EWTW-061-070-520A-D_Remove.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [720](#dm-720) | <a id="dm-720"></a>Install / assemble / connect | [`DMC-AMPEL360E-EWTW-061-070-720A-D_Install.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [941](#dm-941) | <a id="dm-941"></a>Illustrated parts data | [`DMC-AMPEL360E-EWTW-061-070-941A-D_Illustrated-Parts-Data.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
|---|---|---|---|---|---|
| [OI-001](#oi-001) | <a id="oi-001"></a>Confirm final system boundary for Propeller/Propulsor Inspection and Repair. | System expert | TBD | ![TBD](https://img.shields.io/badge/TBD-red) | [Architecture Description](#5-architecture-description) |
| [OI-002](#oi-002) | <a id="oi-002"></a>Complete S1000D SNS allocation for 061-070. | Q-DATAGOV | To Be Completed | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) | [S1000D / CSDB Mapping](#14-s1000d--csdb-mapping) |
...
|---|---|---|---|---|---|
| [0.1.0](#chg-010) | <a id="chg-010"></a>2026-05-11 | Q+ Team / Amedeo Pelliccia + AI | Initial programme-controlled scaffold. | [Document root](#atlas-060-069--section-06--subsection-061--070--propeller-propulsor-inspection-and-repair) | ![DRAFT](https://img.shields.io/badge/DRAFT-yellow) |
