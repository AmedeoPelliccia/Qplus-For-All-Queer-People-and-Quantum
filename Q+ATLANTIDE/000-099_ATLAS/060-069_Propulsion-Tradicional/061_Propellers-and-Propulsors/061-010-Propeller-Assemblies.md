...
s1000d_dmc: "DMC-<PROGRAMME>-<VARIANT>-0061-010"
...
This document defines the agnostic ATLAS standard-level architecture context for `Propeller Assemblies`.
...
|---|---|---|---|
| OI-061-010-001 | Confirm blade count (N) and diameter for [PROGRAMME-AIRCRAFT] propulsor configuration — pending propulsion sizing study | Q-AIR / Q-GREENTECH | 2026-Q3 |
