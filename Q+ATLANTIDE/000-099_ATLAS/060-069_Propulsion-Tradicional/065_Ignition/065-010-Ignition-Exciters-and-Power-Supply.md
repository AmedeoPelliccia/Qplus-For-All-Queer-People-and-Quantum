---
document_id: "QATL-ATLAS-1000-ATLAS-060-069-06-065-010-IGNITION-EXCITERS-AND-POWER-SUPPLY"
title: "ATLAS 060-069 · 06.065.010 — Ignition Exciters and Power Supply"
register: ATLAS-1000
...
subsubject: "010"
subsubject_title: "Ignition Exciters and Power Supply"
subsubject_file: "065-010-Ignition-Exciters-and-Power-Supply.md"
subsubject_link: "./065-010-Ignition-Exciters-and-Power-Supply.md"
...
# ATLAS 060-069 · Section 06 · Subsection 065 · 010 — Ignition Exciters and Power Supply
...
This document defines the controlled technical scope for **Ignition Exciters and Power Supply** (`065-010`) within the [Q+ATLANTIDE](../../../../../Q+ATLANTIDE/) / [ATLAS 000-099](../../../) architecture branch, section [060-069 Propulsión Tradicional](../../).

The objective is to provide a deterministic, [S1000D](https://s1000d.org/)-compatible technical baseline covering the ignition exciter design, power supply interface, energy output specification, and controlled exciter architecture.

This file belongs to:

[`Q+ATLANTIDE/000-099_ATLAS/060-069_Propulsion-Tradicional/065_Ignition/065-010-Ignition-Exciters-and-Power-Supply.md`](./)
...
The **Ignition Exciters and Power Supply** node covers the ignition exciter design, power supply interface, energy output specification, and controlled exciter architecture.
...
- Define exciter type and energy output
- Specify power supply voltage and current requirements
- Document dual exciter and redundancy provisions
- Define exciter protection and isolation
...
The **Ignition Exciters and Power Supply** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries.
...
|---:|---|---|---|---|
| [F-001](#f-001) | <a id="f-001"></a>Define exciter type and energy output | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
| [F-002](#f-002) | <a id="f-002"></a>Specify power supply voltage and current requirements | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
| [F-003](#f-003) | <a id="f-003"></a>Document dual exciter and redundancy provisions | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
***[Diagram 1](#diagram-system-context) — System context diagram for Ignition Exciters and Power Supply. Related sections: [Interfaces](#10-interfaces), [Monitoring and Diagnostics](#12-monitoring-and-diagnostics), [S1000D / CSDB Mapping](#14-s1000d--csdb-mapping).***
...
```mermaid
flowchart TB
    SYS[065-010 Ignition Exciters and Power Supply] --> F1[Define exciter type and energy output]
    SYS --> F2[Specify power supply voltage and current requirements]
...
| Sub-sub-system code | `10` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
| DMC prefix | [`DMC-AMPEL360E-EWTW-065-010`](TBD) | ![TBD](https://img.shields.io/badge/TBD-red) |

### Recommended Data Module Set

| Info code | Data module purpose | Suggested filename | Status |
|---:|---|---|---|
| [040](#dm-040) | <a id="dm-040"></a>Descriptive information | [`DMC-AMPEL360E-EWTW-065-010-040A-D_System-Description.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [300](#dm-300) | <a id="dm-300"></a>Examination / inspection / check | [`DMC-AMPEL360E-EWTW-065-010-300A-D_Inspection.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [400](#dm-400) | <a id="dm-400"></a>Fault isolation | [`DMC-AMPEL360E-EWTW-065-010-400A-D_Fault-Isolation.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [520](#dm-520) | <a id="dm-520"></a>Remove / disassemble | [`DMC-AMPEL360E-EWTW-065-010-520A-D_Remove.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [720](#dm-720) | <a id="dm-720"></a>Install / assemble / connect | [`DMC-AMPEL360E-EWTW-065-010-720A-D_Install.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [941](#dm-941) | <a id="dm-941"></a>Illustrated parts data | [`DMC-AMPEL360E-EWTW-065-010-941A-D_Illustrated-Parts-Data.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
|---|---|---|---|---|---|
| [OI-001](#oi-001) | <a id="oi-001"></a>Confirm final system boundary for Ignition Exciters and Power Supply. | System expert | TBD | ![TBD](https://img.shields.io/badge/TBD-red) | [Architecture Description](#5-architecture-description) |
| [OI-002](#oi-002) | <a id="oi-002"></a>Complete S1000D SNS allocation for 065-010. | Q-DATAGOV | To Be Completed | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) | [S1000D / CSDB Mapping](#14-s1000d--csdb-mapping) |
...
|---|---|---|---|---|---|
| [0.1.0](#chg-010) | <a id="chg-010"></a>2026-05-11 | Q+ Team / Amedeo Pelliccia + AI | Initial programme-controlled scaffold. | [Document root](#atlas-060-069--section-06--subsection-065--010--ignition-exciters-and-power-supply) | ![DRAFT](https://img.shields.io/badge/DRAFT-yellow) |
