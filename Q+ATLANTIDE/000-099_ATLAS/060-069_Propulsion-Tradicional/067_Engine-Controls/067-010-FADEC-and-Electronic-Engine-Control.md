...
s1000d_dmc: "DMC-AMPEL360E-EWTW-0067-010"
---
...
This document describes the hardware architecture and operational characteristics of the FADEC Electronic Engine Controller (EEC) on the AMPEL360E eWTW. The EEC is the physical implementation of the FADEC authority: a dual-channel digital computer mounted on the engine fan case, receiving all engine control inputs and outputting all engine control commands.

The EEC is a Line Replaceable Unit (LRU) of approximately 6–8 kg, conforming to ARINC 600 size 6 MCU form factor, qualified per DO-160G to the thermal, vibration, humidity, and EMI environments of the engine fan case location. Software is DO-178C DAL A with an Engine Model Data File (EDF) specific to the engine serial number, uploaded via FADEC LOADMASTER ground software.
...
| ATA reference | ATA 67-010 — FADEC and Electronic Engine Control |
| Certification basis | EASA CS-E §150 / DO-178C DAL A / DO-254 |
| S1000D SNS | 067-010-00 |
