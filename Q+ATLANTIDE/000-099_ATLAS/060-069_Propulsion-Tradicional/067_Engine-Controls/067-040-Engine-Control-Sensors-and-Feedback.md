---
document_id: "QATL-ATLAS-1000-ATLAS-060-069-06-067-040-ENGINE-CONTROL-SENSORS-AND-FEEDBACK"
title: "ATLAS 060-069 · 06.067.040 — Engine Control Sensors and Feedback"
register: ATLAS-1000
...
subsubject: "040"
subsubject_title: "Engine Control Sensors and Feedback"
subsubject_file: "067-040-Engine-Control-Sensors-and-Feedback.md"
subsubject_link: "./067-040-Engine-Control-Sensors-and-Feedback.md"
...
# ATLAS 060-069 · Section 06 · Subsection 067 · 040 — Engine Control Sensors and Feedback
...
This document defines the controlled technical scope for **Engine Control Sensors and Feedback** (`067-040`) within the [Q+ATLANTIDE](../../../../../Q+ATLANTIDE/) / [ATLAS 000-099](../../../) architecture branch, section [060-069 Propulsión Tradicional](../../).

The objective is to provide a deterministic, [S1000D](https://s1000d.org/)-compatible technical baseline covering the engine control sensors, transducers, feedback signal architecture, and FADEC sensor interface definition.

This file belongs to:

[`Q+ATLANTIDE/000-099_ATLAS/060-069_Propulsion-Tradicional/067_Engine-Controls/067-040-Engine-Control-Sensors-and-Feedback.md`](./)
...
The **Engine Control Sensors and Feedback** node covers the engine control sensors, transducers, feedback signal architecture, and FADEC sensor interface definition.
...
- Define sensor types and quantities for FADEC inputs
- Specify sensor accuracy and failure detection
- Document sensor redundancy and cross-check logic
- Define sensor maintenance and replacement criteria
...
The **Engine Control Sensors and Feedback** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries.
...
|---:|---|---|---|---|
| [F-001](#f-001) | <a id="f-001"></a>Define sensor types and quantities for FADEC inputs | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
| [F-002](#f-002) | <a id="f-002"></a>Specify sensor accuracy and failure detection | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
| [F-003](#f-003) | <a id="f-003"></a>Document sensor redundancy and cross-check logic | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
***[Diagram 1](#diagram-system-context) — System context diagram for Engine Control Sensors and Feedback. Related sections: [Interfaces](#10-interfaces), [Monitoring and Diagnostics](#12-monitoring-and-diagnostics), [S1000D / CSDB Mapping](#14-s1000d--csdb-mapping).***
...
```mermaid
flowchart TB
    SYS[067-040 Engine Control Sensors and Feedback] --> F1[Define sensor types and quantities for FADEC inputs]
    SYS --> F2[Specify sensor accuracy and failure detection]
...
| DMC prefix | [`DMC-AMPEL360E-EWTW-067-040`](TBD) | ![TBD](https://img.shields.io/badge/TBD-red) |

### Recommended Data Module Set

| Info code | Data module purpose | Suggested filename | Status |
|---:|---|---|---|
| [040](#dm-040) | <a id="dm-040"></a>Descriptive information | [`DMC-AMPEL360E-EWTW-067-040-040A-D_System-Description.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [300](#dm-300) | <a id="dm-300"></a>Examination / inspection / check | [`DMC-AMPEL360E-EWTW-067-040-300A-D_Inspection.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [400](#dm-400) | <a id="dm-400"></a>Fault isolation | [`DMC-AMPEL360E-EWTW-067-040-400A-D_Fault-Isolation.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [520](#dm-520) | <a id="dm-520"></a>Remove / disassemble | [`DMC-AMPEL360E-EWTW-067-040-520A-D_Remove.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [720](#dm-720) | <a id="dm-720"></a>Install / assemble / connect | [`DMC-AMPEL360E-EWTW-067-040-720A-D_Install.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [941](#dm-941) | <a id="dm-941"></a>Illustrated parts data | [`DMC-AMPEL360E-EWTW-067-040-941A-D_Illustrated-Parts-Data.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
|---|---|---|---|---|---|
| [OI-001](#oi-001) | <a id="oi-001"></a>Confirm final system boundary for Engine Control Sensors and Feedback. | System expert | TBD | ![TBD](https://img.shields.io/badge/TBD-red) | [Architecture Description](#5-architecture-description) |
| [OI-002](#oi-002) | <a id="oi-002"></a>Complete S1000D SNS allocation for 067-040. | Q-DATAGOV | To Be Completed | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) | [S1000D / CSDB Mapping](#14-s1000d--csdb-mapping) |
...
|---|---|---|---|---|---|
| [0.1.0](#chg-010) | <a id="chg-010"></a>2026-05-11 | Q+ Team / Amedeo Pelliccia + AI | Initial programme-controlled scaffold. | [Document root](#atlas-060-069--section-06--subsection-067--040--engine-control-sensors-and-feedback) | ![DRAFT](https://img.shields.io/badge/DRAFT-yellow) |
