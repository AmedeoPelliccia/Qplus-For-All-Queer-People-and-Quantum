---
document_id: "QATL-ATLAS-1000-ATLAS-060-069-06-067-020-THROTTLE-LEVER-AND-POWER-COMMAND-INTERFACES"
title: "ATLAS 060-069 · 06.067.020 — Throttle Lever and Power Command Interfaces"
register: ATLAS-1000
...
subsubject: "020"
subsubject_title: "Throttle Lever and Power Command Interfaces"
subsubject_file: "067-020-Throttle-Lever-and-Power-Command-Interfaces.md"
subsubject_link: "./067-020-Throttle-Lever-and-Power-Command-Interfaces.md"
...
# ATLAS 060-069 · Section 06 · Subsection 067 · 020 — Throttle Lever and Power Command Interfaces
...
This document defines the controlled technical scope for **Throttle Lever and Power Command Interfaces** (`067-020`) within the [Q+ATLANTIDE](../../../../../Q+ATLANTIDE/) / [ATLAS 000-099](../../../) architecture branch, section [060-069 Propulsión Tradicional](../../).

The objective is to provide a deterministic, [S1000D](https://s1000d.org/)-compatible technical baseline covering the thrust lever angle (TLA) interface, autothrottle integration, power command signal architecture, and controlled TLA definition.

This file belongs to:

[`Q+ATLANTIDE/000-099_ATLAS/060-069_Propulsion-Tradicional/067_Engine-Controls/067-020-Throttle-Lever-and-Power-Command-Interfaces.md`](./)
...
The **Throttle Lever and Power Command Interfaces** node covers the thrust lever angle (TLA) interface, autothrottle integration, power command signal architecture, and controlled TLA definition.
...
- Define TLA signal type and FADEC interface
- Specify autothrottle servo interface
- Document TOGA and reverse thrust command provisions
- Define TLA rigging and calibration requirements
...
The **Throttle Lever and Power Command Interfaces** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries.
...
|---:|---|---|---|---|
| [F-001](#f-001) | <a id="f-001"></a>Define TLA signal type and FADEC interface | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
| [F-002](#f-002) | <a id="f-002"></a>Specify autothrottle servo interface | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
| [F-003](#f-003) | <a id="f-003"></a>Document TOGA and reverse thrust command provisions | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
***[Diagram 1](#diagram-system-context) — System context diagram for Throttle Lever and Power Command Interfaces. Related sections: [Interfaces](#10-interfaces), [Monitoring and Diagnostics](#12-monitoring-and-diagnostics), [S1000D / CSDB Mapping](#14-s1000d--csdb-mapping).***
...
```mermaid
flowchart TB
    SYS[067-020 Throttle Lever and Power Command In] --> F1[Define TLA signal type and FADEC interface]
    SYS --> F2[Specify autothrottle servo interface]
...
| DMC prefix | [`DMC-AMPEL360E-EWTW-067-020`](TBD) | ![TBD](https://img.shields.io/badge/TBD-red) |

### Recommended Data Module Set

| Info code | Data module purpose | Suggested filename | Status |
|---:|---|---|---|
| [040](#dm-040) | <a id="dm-040"></a>Descriptive information | [`DMC-AMPEL360E-EWTW-067-020-040A-D_System-Description.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [300](#dm-300) | <a id="dm-300"></a>Examination / inspection / check | [`DMC-AMPEL360E-EWTW-067-020-300A-D_Inspection.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [400](#dm-400) | <a id="dm-400"></a>Fault isolation | [`DMC-AMPEL360E-EWTW-067-020-400A-D_Fault-Isolation.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [520](#dm-520) | <a id="dm-520"></a>Remove / disassemble | [`DMC-AMPEL360E-EWTW-067-020-520A-D_Remove.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [720](#dm-720) | <a id="dm-720"></a>Install / assemble / connect | [`DMC-AMPEL360E-EWTW-067-020-720A-D_Install.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [941](#dm-941) | <a id="dm-941"></a>Illustrated parts data | [`DMC-AMPEL360E-EWTW-067-020-941A-D_Illustrated-Parts-Data.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
|---|---|---|---|---|---|
| [OI-001](#oi-001) | <a id="oi-001"></a>Confirm final system boundary for Throttle Lever and Power Command Interfaces. | System expert | TBD | ![TBD](https://img.shields.io/badge/TBD-red) | [Architecture Description](#5-architecture-description) |
| [OI-002](#oi-002) | <a id="oi-002"></a>Complete S1000D SNS allocation for 067-020. | Q-DATAGOV | To Be Completed | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) | [S1000D / CSDB Mapping](#14-s1000d--csdb-mapping) |
...
|---|---|---|---|---|---|
| [0.1.0](#chg-010) | <a id="chg-010"></a>2026-05-11 | Q+ Team / Amedeo Pelliccia + AI | Initial programme-controlled scaffold. | [Document root](#atlas-060-069--section-06--subsection-067--020--throttle-lever-and-power-command-interfaces) | ![DRAFT](https://img.shields.io/badge/DRAFT-yellow) |
