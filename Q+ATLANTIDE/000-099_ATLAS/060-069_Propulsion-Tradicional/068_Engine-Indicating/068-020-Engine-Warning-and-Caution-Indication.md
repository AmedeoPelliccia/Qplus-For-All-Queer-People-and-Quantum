...
s1000d_dmc: "DMC-AMPEL360E-EWTW-0068-020"
---
...
Defines the engine-related ECAM warning and caution alert architecture for the AMPEL360E eWTW. Alerts are generated by FADEC and IAS based on parameter exceedances or system faults, and are classified into three levels: Warning (Level 3 — immediate action), Caution (Level 2 — awareness and action), and Advisory (Level 1 — awareness only).
...
| ATA reference | ATA 68-020 |
| S1000D SNS | 068-020-00 |
