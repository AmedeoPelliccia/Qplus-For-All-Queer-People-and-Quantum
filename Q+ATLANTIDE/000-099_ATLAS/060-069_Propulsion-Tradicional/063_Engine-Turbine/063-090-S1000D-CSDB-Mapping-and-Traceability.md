...
s1000d_dmc: "DMC-<PROGRAMME>-<VARIANT>-0063-090"
...
ATA 63 DMRL: 36 data modules. DMC `[PROGRAMME-AIRCRAFT]-[PROGRAMME-VARIANT]-063-{NNN}-00A-EN-US`. BREX `[PROGRAMME-AIRCRAFT]-BREX-063-v1` enforces: (1) all LLP DMs must cite engine TC and LLP life value; (2) HSI DMs must cite OEM-approved borescope procedure; (3) no DM may reference engine bleed air as aircraft pneumatic supply.
