---
document_id: "QATL-ATLAS-1000-ATLAS-060-069-06-062-040-POWER-PLANT-CONTROLS-AND-ACCESSORIES"
title: "ATLAS 060-069 · 06.062.040 — Power Plant Controls and Accessories"
register: ATLAS-1000
...
subsubject: "040"
subsubject_title: "Power Plant Controls and Accessories"
subsubject_file: "062-040-Power-Plant-Controls-and-Accessories.md"
subsubject_link: "./062-040-Power-Plant-Controls-and-Accessories.md"
...
# ATLAS 060-069 · Section 06 · Subsection 062 · 040 — Power Plant Controls and Accessories
...
This document defines the controlled technical scope for **Power Plant Controls and Accessories** (`062-040`) within the [Q+ATLANTIDE](../../../../../Q+ATLANTIDE/) / [ATLAS 000-099](../../../) architecture branch, section [060-069 Propulsión Tradicional](../../).

The objective is to provide a deterministic, [S1000D](https://s1000d.org/)-compatible technical baseline covering the engine controls architecture, accessory gearbox interfaces, and controlled accessories definition for the power plant system.

This file belongs to:

[`Q+ATLANTIDE/000-099_ATLAS/060-069_Propulsion-Tradicional/062_Power-Plant/062-040-Power-Plant-Controls-and-Accessories.md`](./)
...
The **Power Plant Controls and Accessories** node covers the engine controls architecture, accessory gearbox interfaces, and controlled accessories definition for the power plant system.
...
- Define accessory gearbox configuration
- Specify driven accessories and load interfaces
- Document FADEC and control system interface
- Define accessories maintenance requirements
- Map to S1000D DMs
...
The **Power Plant Controls and Accessories** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries.
...
|---:|---|---|---|---|
| [F-001](#f-001) | <a id="f-001"></a>Define accessory gearbox configuration | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
| [F-002](#f-002) | <a id="f-002"></a>Specify driven accessories and load interfaces | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
| [F-003](#f-003) | <a id="f-003"></a>Document FADEC and control system interface | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
***[Diagram 1](#diagram-system-context) — System context diagram for Power Plant Controls and Accessories. Related sections: [Interfaces](#10-interfaces), [Monitoring and Diagnostics](#12-monitoring-and-diagnostics), [S1000D / CSDB Mapping](#14-s1000d--csdb-mapping).***
...
```mermaid
flowchart TB
    SYS[062-040 Power Plant Controls and Accessorie] --> F1[Define accessory gearbox configuration]
    SYS --> F2[Specify driven accessories and load interfaces]
...
| DMC prefix | [`DMC-AMPEL360E-EWTW-062-040`](TBD) | ![TBD](https://img.shields.io/badge/TBD-red) |

### Recommended Data Module Set

| Info code | Data module purpose | Suggested filename | Status |
|---:|---|---|---|
| [040](#dm-040) | <a id="dm-040"></a>Descriptive information | [`DMC-AMPEL360E-EWTW-062-040-040A-D_System-Description.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [300](#dm-300) | <a id="dm-300"></a>Examination / inspection / check | [`DMC-AMPEL360E-EWTW-062-040-300A-D_Inspection.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [400](#dm-400) | <a id="dm-400"></a>Fault isolation | [`DMC-AMPEL360E-EWTW-062-040-400A-D_Fault-Isolation.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [520](#dm-520) | <a id="dm-520"></a>Remove / disassemble | [`DMC-AMPEL360E-EWTW-062-040-520A-D_Remove.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [720](#dm-720) | <a id="dm-720"></a>Install / assemble / connect | [`DMC-AMPEL360E-EWTW-062-040-720A-D_Install.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [941](#dm-941) | <a id="dm-941"></a>Illustrated parts data | [`DMC-AMPEL360E-EWTW-062-040-941A-D_Illustrated-Parts-Data.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
|---|---|---|---|---|---|
| [OI-001](#oi-001) | <a id="oi-001"></a>Confirm final system boundary for Power Plant Controls and Accessories. | System expert | TBD | ![TBD](https://img.shields.io/badge/TBD-red) | [Architecture Description](#5-architecture-description) |
| [OI-002](#oi-002) | <a id="oi-002"></a>Complete S1000D SNS allocation for 062-040. | Q-DATAGOV | To Be Completed | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) | [S1000D / CSDB Mapping](#14-s1000d--csdb-mapping) |
...
|---|---|---|---|---|---|
| [0.1.0](#chg-010) | <a id="chg-010"></a>2026-05-11 | Q+ Team / Amedeo Pelliccia + AI | Initial programme-controlled scaffold. | [Document root](#atlas-060-069--section-06--subsection-062--040--power-plant-controls-and-accessories) | ![DRAFT](https://img.shields.io/badge/DRAFT-yellow) |
