---
document_id: "QATL-ATLAS-1000-ATLAS-060-069-06-062-070-POWER-PLANT-REMOVAL-AND-INSTALLATION-INTERFACES"
title: "ATLAS 060-069 · 06.062.070 — Power Plant Removal and Installation Interfaces"
register: ATLAS-1000
...
subsection: "062"
subsection_title: "Power Plant"
subsubject: "070"
subsubject_title: "Power Plant Removal and Installation Interfaces"
subsubject_file: "062-070-Power-Plant-Removal-and-Installation-Interfaces.md"
subsubject_link: "./062-070-Power-Plant-Removal-and-Installation-Interfaces.md"
...
# ATLAS 060-069 · Section 06 · Subsection 062 · 070 — Power Plant Removal and Installation Interfaces
...
This document defines the controlled technical scope for **Power Plant Removal and Installation Interfaces** (`062-070`) within the [Q+ATLANTIDE](../../../../../Q+ATLANTIDE/) / [ATLAS 000-099](../../../) architecture branch, section [060-069 Propulsión Tradicional](../../).

The objective is to provide a deterministic, [S1000D](https://s1000d.org/)-compatible technical baseline covering the engine removal and installation procedures, tooling requirements, and controlled interface definition for power plant change operations.

This file belongs to:

[`Q+ATLANTIDE/000-099_ATLAS/060-069_Propulsion-Tradicional/062_Power-Plant/062-070-Power-Plant-Removal-and-Installation-Interfaces.md`](./)
...
| Subsection | [062 Power Plant](../) | ![DRAFT](https://img.shields.io/badge/DRAFT-yellow) |
| ATA reference | [ATA 62](#ref-ata) | ![DRAFT](https://img.shields.io/badge/DRAFT-yellow) |
...
The **Power Plant Removal and Installation Interfaces** node covers the engine removal and installation procedures, tooling requirements, and controlled interface definition for power plant change operations.
...
- Define engine change sequence and required tooling
- Specify lifting and positioning provisions
- Document disconnection and reconnection sequence
- Define functional test criteria after engine installation
- Map to S1000D removal/installation DMs
...
The **Power Plant Removal and Installation Interfaces** architecture is organized around controlled interfaces, deterministic function allocation, and maintainable component boundaries.
...
|---:|---|---|---|---|
| [F-001](#f-001) | <a id="f-001"></a>Define engine change sequence and required tooling | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
| [F-002](#f-002) | <a id="f-002"></a>Specify lifting and positioning provisions | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
| [F-003](#f-003) | <a id="f-003"></a>Document disconnection and reconnection sequence | TBD — to be completed. | [Interface](#10-interfaces) | ![TBD](https://img.shields.io/badge/TBD-red) |
...
```mermaid
flowchart LR
    A[Aircraft-Level Function] --> B[062 Power Plant]
    B --> C[Power Interface]
...
***[Diagram 1](#diagram-system-context) — System context diagram for Power Plant Removal and Installation Interfaces. Related sections: [Interfaces](#10-interfaces), [Monitoring and Diagnostics](#12-monitoring-and-diagnostics), [S1000D / CSDB Mapping](#14-s1000d--csdb-mapping).***
...
```mermaid
flowchart TB
    SYS[062-070 Power Plant Removal and Installatio] --> F1[Define engine change sequence and required tooling]
    SYS --> F2[Specify lifting and positioning provisions]
...
| System code | `062` | ![DRAFT](https://img.shields.io/badge/DRAFT-yellow) |
| Sub-system code | `0` | ![TBD](https://img.shields.io/badge/TBD-red) |
| Sub-sub-system code | `70` | ![TBD](https://img.shields.io/badge/TBD-red) |
...
| DMC prefix | [`DMC-AMPEL360E-EWTW-062-070`](TBD) | ![TBD](https://img.shields.io/badge/TBD-red) |

### Recommended Data Module Set

| Info code | Data module purpose | Suggested filename | Status |
|---:|---|---|---|
| [040](#dm-040) | <a id="dm-040"></a>Descriptive information | [`DMC-AMPEL360E-EWTW-062-070-040A-D_System-Description.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [300](#dm-300) | <a id="dm-300"></a>Examination / inspection / check | [`DMC-AMPEL360E-EWTW-062-070-300A-D_Inspection.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [400](#dm-400) | <a id="dm-400"></a>Fault isolation | [`DMC-AMPEL360E-EWTW-062-070-400A-D_Fault-Isolation.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [520](#dm-520) | <a id="dm-520"></a>Remove / disassemble | [`DMC-AMPEL360E-EWTW-062-070-520A-D_Remove.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [720](#dm-720) | <a id="dm-720"></a>Install / assemble / connect | [`DMC-AMPEL360E-EWTW-062-070-720A-D_Install.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
| [941](#dm-941) | <a id="dm-941"></a>Illustrated parts data | [`DMC-AMPEL360E-EWTW-062-070-941A-D_Illustrated-Parts-Data.xml`](TBD) | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) |
...
| [CIT-004](#cit-004) | <a id="cit-004"></a>`ATA iSpec 2200, Chapter 62 — Power Plant.` | ATA reference | TBD | ![TBD](https://img.shields.io/badge/TBD-red) |
...
| [REF-004](#ref-004) | <a id="ref-004"></a>062 Power Plant subsection index | `QATL-ATLAS-060-069-062` | TBD | ![TBD](https://img.shields.io/badge/TBD-red) | [Open](../) |
| [REF-005](#ref-005) | <a id="ref-005"></a>S1000D project BREX | `BREX-AMPEL360E-EWTW` | TBD | ![TBD](https://img.shields.io/badge/TBD-red) | TBD |
| [REF-ATA](#ref-ata) | <a id="ref-ata"></a>ATA iSpec 2200 — Chapter 62 | `ATA-ISPEC-2200-62` | TBD | ![TBD](https://img.shields.io/badge/TBD-red) | TBD |
...
|---|---|---|---|---|---|
| [OI-001](#oi-001) | <a id="oi-001"></a>Confirm final system boundary for Power Plant Removal and Installation Interfaces. | System expert | TBD | ![TBD](https://img.shields.io/badge/TBD-red) | [Architecture Description](#5-architecture-description) |
| [OI-002](#oi-002) | <a id="oi-002"></a>Complete S1000D SNS allocation for 062-070. | Q-DATAGOV | To Be Completed | ![To Be Completed](https://img.shields.io/badge/To_Be_Completed-orange) | [S1000D / CSDB Mapping](#14-s1000d--csdb-mapping) |
...
|---|---|---|---|---|---|
| [0.1.0](#chg-010) | <a id="chg-010"></a>2026-05-11 | Q+ Team / Amedeo Pelliccia + AI | Initial programme-controlled scaffold. | [Document root](#atlas-060-069--section-06--subsection-062--070--power-plant-removal-and-installation-interfaces) | ![DRAFT](https://img.shields.io/badge/DRAFT-yellow) |
