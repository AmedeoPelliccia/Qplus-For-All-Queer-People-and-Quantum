---
document_id: "QATL-ATLAS-1000-ATLAS-060-069-062-030-POWER-PLANT-EXHAUST-INTERFACES"
register: ATLAS-1000
title: "Power Plant Exhaust Interfaces"
ata: "ATA 62"
sns: "062-030-00"
subsection: "062"
subsubject_code: "030"
...
s1000d_dmc: "DMC-AMPEL360E-EWTW-0062-030"
---

<!-- ──────────────────────────────────────────────────────────────────────────
     QATL-ATLAS-1000-ATLAS-060-069-062-030-POWER-PLANT-EXHAUST-INTERFACES
     ATA 62 · Power Plant Exhaust Interfaces
     AMPEL360E eWTW — ATLAS Register 1000
────────────────────────────────────────────────────────────────────────────── -->

# Power Plant Exhaust Interfaces
...
The exhaust system on AMPEL360E eWTW consists of the core exhaust nozzle (convergent fixed-geometry) and the fan bypass duct exit. The exhaust is purely thermal; no thrust reverser requirement exists on the programme baseline, pending airport performance analysis.
...
| ATA reference | ATA 62-030 — Power Plant Exhaust Interfaces |
| Certification basis | EASA CS-25 Amdt 27+ |
| S1000D SNS | 062-030-00 |

---

## §3 Functional Description ![DRAFT]

System description for Power Plant Exhaust Interfaces within the AMPEL360E eWTW Power Plant architecture. See §3 Functional Description for technical detail.
...
|---|---|---|---|
| F-001 | Power Plant Exhaust Interfaces Function 1 | Primary system function | Q-GREENTECH |
| F-002 | Power Plant Exhaust Interfaces Function 2 | Secondary function | Q-MECHANICS |
...
```mermaid
flowchart LR
    A[Power Plant Level] --> B[Power Plant Exhaust Interfaces]
...
```mermaid
flowchart TB
    SYS[Power Plant Exhaust ] --> F1[Function A]
    SYS --> F2[Function B]
...
|---|---|---|---|---|---|
| Core exhaust nozzle (fixed convergent) | Nozzle-PN-TBD | 1 per engine | Core exhaust exit | Borescope inspect at C-check | CS-25 §25.939 exhaust compliance |
| Fan bypass duct exit (cold stream) | BypassDuct-PN-TBD | 1 per engine | Nacelle aft section | Visual inspect at C-check | No thrust reverser baseline |
| Exhaust temperature probe (EGT) | EGT-Probe-PN-TBD | Per OEM spec | Core exhaust plane | On condition | Feeds ATA 68 engine indicating |
...
- All work in the Power Plant Exhaust Interfaces area requires FADEC isolation and fuel system isolation before starting.
...
|---|---|---|---|
| Scheduled inspection of Power Plant Exhaust Interfaces | C-check | Nacelle access | Inspection kit per AMM |
| BITE download for Power Plant Exhaust Interfaces | A-check | Maintenance terminal | CMS terminal |
...
|---|---|---|---|
| OI-062-030-001 | Finalise Power Plant Exhaust Interfaces design for AMPEL360E baseline (OEM data pending) | Q-MECHANICS | 2026-Q4 |
