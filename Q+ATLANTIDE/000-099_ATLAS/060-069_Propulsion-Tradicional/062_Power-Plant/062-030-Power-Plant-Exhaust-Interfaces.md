...
s1000d_dmc: "DMC-<PROGRAMME>-<VARIANT>-0062-030"
...
This document defines the agnostic ATLAS standard-level architecture context for `Power Plant Exhaust Interfaces`.
...
System description for Power Plant Exhaust Interfaces within the programme-defined aircraft type Power Plant architecture. See §3 Functional Description for technical detail.
...
|---|---|---|---|
| OI-062-030-001 | Finalise Power Plant Exhaust Interfaces design for [PROGRAMME-AIRCRAFT] baseline (OEM data pending) | Q-MECHANICS | 2026-Q4 |
