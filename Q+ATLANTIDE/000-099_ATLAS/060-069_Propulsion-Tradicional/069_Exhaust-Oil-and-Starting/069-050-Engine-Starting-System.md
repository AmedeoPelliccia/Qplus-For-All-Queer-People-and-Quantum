...
s1000d_dmc: "DMC-AMPEL360E-EWTW-0069-050"
---
...
Defines the all-electric engine starting system of the AMPEL360E eWTW using the Permanent-Magnet Starter-Generator (PMSG). No pneumatic air turbine starter is used. The PMSG operates in motor mode during start, driven by the HVDC 270 V bus via the Start Power Electronic Controller (SPEC).
...
| ATA reference | ATA 69-050 |
| S1000D SNS | 069-050-00 |
