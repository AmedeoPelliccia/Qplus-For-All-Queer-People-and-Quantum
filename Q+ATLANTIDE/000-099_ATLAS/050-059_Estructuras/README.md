...
Section-level index for *Estructuras* (`050-059`) within the ATLAS band. General, prácticas estándar estructurales, puertas, fuselaje, nacelles y pilones, estabilizadores, ventanas y alas.
...
|---:|---|---|---|
| `050` | General | [`050_General/`](./050_General/) | draft |
| `051` | Standard Practices — Structures | [`051_Standard-Practices-Structures/`](./051_Standard-Practices-Structures/) | draft |
