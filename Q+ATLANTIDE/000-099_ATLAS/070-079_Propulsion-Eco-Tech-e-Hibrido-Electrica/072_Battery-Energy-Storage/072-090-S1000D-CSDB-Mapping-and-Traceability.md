...
s1000d_dmc: "DMC-<MODEL>-<SYSTEMDIFF>-072-090"
---
...
## §1 Purpose
This document provides the S1000D Data Module Code (DMC) mapping for all Battery Energy Storage (072) documents, defining the Common Source Database (CSDB) allocation, Business Rules Exchange (BREX) reference, and traceability between the ATLAS-1000 subsubject files and the S1000D publication set for any programme implementing this ATLAS standard node.

## §2 Applicability
| Aircraft | Variant | MSN Range | Effectivity |
|---|---|---|---|
| <MODEL> | <SYSTEMDIFF> | All | From EIS |

## §3 Functional Description ![DRAFT](https://img.shields.io/badge/-DRAFT-yellow)
The <PROGRAMME> technical publications are structured under S1000D Issue 5.0. The Battery Energy Storage subsystem (subsystem code `0072`) maps to the SNS (Standard Numbering System) range `0072-000` through `0072-090`. Data modules are allocated within the CSDB under CAGE code `AMPEL` and model identifier `360E-<PROGRAMME-SHORT>`.
...
|---|---|---|---|---|---|
| 072-000 | 0072-000 | DMC-<MODEL>-<SYSTEMDIFF>-0072-000-A-00A-A | 000 | Battery Energy Storage — General | AMM |
| 072-010 | 0072-010 | DMC-<MODEL>-<SYSTEMDIFF>-0072-010-A-00A-A | 000 | Battery Cell and Module Design | AMM |
| 072-020 | 0072-020 | DMC-<MODEL>-<SYSTEMDIFF>-0072-020-A-00A-A | 000 | Battery Pack Architecture | AMM |
| 072-030 | 0072-030 | DMC-<MODEL>-<SYSTEMDIFF>-0072-030-A-00A-A | 000 | Battery Management System | AMM |
| 072-040 | 0072-040 | DMC-<MODEL>-<SYSTEMDIFF>-0072-040-A-00A-A | 000 | Battery Thermal Management | AMM |
| 072-050 | 0072-050 | DMC-<MODEL>-<SYSTEMDIFF>-0072-050-A-00A-A | 000 | HV Contactors and Protection | AMM |
| 072-060 | 0072-060 | DMC-<MODEL>-<SYSTEMDIFF>-0072-060-A-00A-A | 000 | Battery State Estimation | AMM |
| 072-070 | 0072-070 | DMC-<MODEL>-<SYSTEMDIFF>-0072-070-A-00A-A | 000 | Battery Safety and TR Protection | AMM |
| 072-080 | 0072-080 | DMC-<MODEL>-<SYSTEMDIFF>-0072-080-A-00A-A | 000 | Battery Charging and Ground Support | AMM |
| 072-090 | 0072-090 | DMC-<MODEL>-<SYSTEMDIFF>-0072-090-A-00A-A | 000 | S1000D CSDB Mapping | AMM |

## §5 DMRL Summary
| DM Ref | DMC | Info Code | Pub Type | Status |
|---|---|---|---|---|
| DM-072-AMM-001 | DMC-<MODEL>-<SYSTEMDIFF>-0072-000-A-00A-A | 000 | AMM | Planned |
| DM-072-AMM-002 | DMC-<MODEL>-<SYSTEMDIFF>-0072-010-A-00A-A | 000 | AMM | Planned |
| DM-072-AMM-003 | DMC-<MODEL>-<SYSTEMDIFF>-0072-020-A-00A-A | 000 | AMM | Planned |
| DM-072-AMM-004 | DMC-<MODEL>-<SYSTEMDIFF>-0072-030-A-00A-A | 000 | AMM | Planned |
| DM-072-AMM-005 | DMC-<MODEL>-<SYSTEMDIFF>-0072-040-A-00A-A | 000 | AMM | Planned |
| DM-072-AMM-006 | DMC-<MODEL>-<SYSTEMDIFF>-0072-050-A-00A-A | 000 | AMM | Planned |
| DM-072-AMM-007 | DMC-<MODEL>-<SYSTEMDIFF>-0072-060-A-00A-A | 000 | AMM | Planned |
| DM-072-AMM-008 | DMC-<MODEL>-<SYSTEMDIFF>-0072-070-A-00A-A | 000 | AMM | Planned |
| DM-072-AMM-009 | DMC-<MODEL>-<SYSTEMDIFF>-0072-080-A-00A-A | 000 | AMM | Planned |
| DM-072-AMM-010 | DMC-<MODEL>-<SYSTEMDIFF>-0072-090-A-00A-A | 000 | AMM | Planned |
| DM-072-CMM-001 | DMC-<MODEL>-<SYSTEMDIFF>-0072-010-C-00A-A | 000 | CMM | Planned |
| DM-072-CMM-002 | DMC-<MODEL>-<SYSTEMDIFF>-0072-030-C-00A-A | 000 | CMM | Planned |
| DM-072-CMM-003 | DMC-<MODEL>-<SYSTEMDIFF>-0072-040-C-00A-A | 000 | CMM | Planned |
| DM-072-CMM-004 | DMC-<MODEL>-<SYSTEMDIFF>-0072-050-C-00A-A | 000 | CMM | Planned |
| DM-072-CMM-005 | DMC-<MODEL>-<SYSTEMDIFF>-0072-060-C-00A-A | 000 | CMM | Planned |
| DM-072-FIM-001 | DMC-<MODEL>-<SYSTEMDIFF>-0072-030-F-00A-A | 000 | FIM | Planned |
| DM-072-FIM-002 | DMC-<MODEL>-<SYSTEMDIFF>-0072-040-F-00A-A | 000 | FIM | Planned |
| DM-072-FIM-003 | DMC-<MODEL>-<SYSTEMDIFF>-0072-050-F-00A-A | 000 | FIM | Planned |
| DM-072-FIM-004 | DMC-<MODEL>-<SYSTEMDIFF>-0072-070-F-00A-A | 000 | FIM | Planned |
| DM-072-IPD-001 | DMC-<MODEL>-<SYSTEMDIFF>-0072-000-P-00A-A | 000 | IPD | Planned |
| DM-072-IPD-002 | DMC-<MODEL>-<SYSTEMDIFF>-0072-010-P-00A-A | 000 | IPD | Planned |
| DM-072-IPD-003 | DMC-<MODEL>-<SYSTEMDIFF>-0072-020-P-00A-A | 000 | IPD | Planned |
| DM-072-IPD-004 | DMC-<MODEL>-<SYSTEMDIFF>-0072-030-P-00A-A | 000 | IPD | Planned |
| DM-072-IPD-005 | DMC-<MODEL>-<SYSTEMDIFF>-0072-040-P-00A-A | 000 | IPD | Planned |
| DM-072-IPD-006 | DMC-<MODEL>-<SYSTEMDIFF>-0072-050-P-00A-A | 000 | IPD | Planned |
| DM-072-IPD-007 | DMC-<MODEL>-<SYSTEMDIFF>-0072-060-P-00A-A | 000 | IPD | Planned |
| DM-072-IPD-008 | DMC-<MODEL>-<SYSTEMDIFF>-0072-070-P-00A-A | 000 | IPD | Planned |
| DM-072-IPD-009 | DMC-<MODEL>-<SYSTEMDIFF>-0072-080-P-00A-A | 000 | IPD | Planned |
| DM-072-CIR-001 | DMC-<MODEL>-<SYSTEMDIFF>-0072-000-W-00A-A | 000 | WDM | Planned |
| DM-072-CIR-002 | DMC-<MODEL>-<SYSTEMDIFF>-0072-050-W-00A-A | 000 | WDM | Planned |
...
|---|---|---|---|
| BREX-072-v1 | 1.0 | All DMC-<MODEL>-<SYSTEMDIFF>-0072-* | Planned |

BREX-072-v1 inherits from the aircraft-level BREX `BREX-<MODEL>-<SYSTEMDIFF>-MASTER-v1` and adds subsystem-specific rules for:
...
| S1000D Issue | 5.0 |
| CAGE Code | AMPEL |
| Model Identifier | 360E-<PROGRAMME-SHORT> |
