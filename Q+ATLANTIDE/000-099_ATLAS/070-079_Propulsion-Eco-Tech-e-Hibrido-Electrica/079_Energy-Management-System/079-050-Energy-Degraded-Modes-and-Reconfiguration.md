...
s1000d_dmc: "DMC-AMPEL360E-EWTW-0079-050"
---
...
This document defines all **EMS degraded operational modes** triggered by energy source failures, EMCU hardware faults, or power bus faults, and specifies the **automatic reconfiguration sequences**, associated load shedding actions, crew advisories, exit criteria, and maintenance verification requirements.

Five degraded modes (DM-1 through DM-5) are defined, forming a graduated response from single source loss through total power emergency. Each mode is designed to maintain airworthiness and ensure Class 1 load continuity at all times.
...
| ATA Reference | ATA 79-050 |
| Certification Basis | EASA CS-25 Amendment 27+, DO-178C DAL B, SAE ARP4754A |
| S1000D SNS | 079-050-00 |
