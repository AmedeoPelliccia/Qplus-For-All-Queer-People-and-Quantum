...
s1000d_dmc: "DMC-AMPEL360E-EWTW-0085-060"
---
...
ATLAS subsubject 085-060 defines the five DEPA degraded operating modes (DM-1 through DM-5), the automatic and manual reconfiguration logic executed by the DEPCU, the redundancy architecture for each propulsor and the DEPCU itself, a top-level FMEA summary for the DEPA, and the Minimum Equipment List (MEL) cross-reference for dispatch with inoperative DEPA components.
...
| ATA Reference | ATLAS-085 — 085-060 Redundancy Fault Tolerance and Degraded Modes |
| Certification Basis | EASA CS-25.1309; CS-25.143; CS-25.147; DO-178C DAL B |
| S1000D SNS | 085-060-00 |
