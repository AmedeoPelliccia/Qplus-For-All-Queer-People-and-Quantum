...
- Concepts in scope:
  - **Physical-vs-logical distinction** — physical qubits are the device-level objects of `002_`; a logical qubit is an encoded subspace of $n$ physical qubits with active syndrome extraction and correction.
