...
- Out of scope: code-level mitigation (`005_`); circuit-level error-mitigation techniques (covered downstream in `902_circuits/` and `903_quantum-algorithms/`).
