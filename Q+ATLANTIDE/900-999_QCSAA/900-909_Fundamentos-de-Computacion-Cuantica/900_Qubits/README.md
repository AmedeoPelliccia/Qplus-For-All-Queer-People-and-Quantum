...
- Covers the full subsubject namespace `000`–`099` of subsection `900` *Qubits*; subsubjects `001`–`005` are populated in this baseline release, the remaining `006`–`099` slots remain available for future extension per the Overview's authorisation[^archtable].
...
| 01 | Qubit Definition and Mathematical Formalism | [`001_Qubit-Definition-and-Mathematical-Formalism.md`](./001_Qubit-Definition-and-Mathematical-Formalism.md) | active |
| 02 | Physical Qubit Implementations | [`002_Physical-Qubit-Implementations.md`](./002_Physical-Qubit-Implementations.md) | active |
| 03 | Qubit States, Operations and Measurement | [`003_Qubit-States-Operations-and-Measurement.md`](./003_Qubit-States-Operations-and-Measurement.md) | active |
| 04 | Decoherence, Noise and Fidelity | [`004_Decoherence-Noise-and-Fidelity.md`](./004_Decoherence-Noise-and-Fidelity.md) | active |
| 05 | Logical Qubits, Encoding and Error Correction | [`005_Logical-Qubits-Encoding-and-Error-Correction.md`](./005_Logical-Qubits-Encoding-and-Error-Correction.md) | active |
...
- **Within `900-909`** — `901_gates/`, `902_circuits/`, `903_quantum-algorithms/`, `904_foundations/` (acyclic dependency graph: qubits → gates → circuits → algorithms → foundations/applications).
...
|---|---|---|---|
| 1.0.0 | 2026-05-07 | Q-HORIZON | Initial baseline: `000_Overview.md` plus subsubjects `001`–`005`. Subsection index established. |
