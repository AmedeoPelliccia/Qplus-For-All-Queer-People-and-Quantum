...
- **Within `900-909`** — `901_gates/`, `030_circuits/`, `040_quantum-algorithms/`, `050_foundations/` (acyclic dependency graph: qubits → gates → circuits → algorithms → foundations/applications).
