---
document_id: QATL-ATLAS-1000-QCSAA-900-909-00-010-900-OVERVIEW
title: "QCSAA 900-909 · 00.010.900 — Qubits"
register: ATLAS-1000
...
This subsubject (`900 Overview`) introduces the QCSAA 900-909.010.900 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
- The qubit, defined here, is the **atomic unit of quantum computation** and the upstream dependency of every other chapter in QCSAA. Downstream subsections and bands that build on it include:
  - Within `900-909`: [`../901_gates/`](../901_gates/), [`../030_circuits/`](../030_circuits/), [`../040_quantum-algorithms/`](../040_quantum-algorithms/), [`../050_foundations/`](../050_foundations/).
