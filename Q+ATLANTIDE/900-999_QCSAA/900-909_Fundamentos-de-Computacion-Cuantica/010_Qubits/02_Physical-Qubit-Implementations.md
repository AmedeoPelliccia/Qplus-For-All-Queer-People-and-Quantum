---
document_id: QATL-ATLAS-1000-QCSAA-900-909-00-010-02-PHYSICAL-QUBIT-IMPLEMENTATIONS
title: "QCSAA 900-909 · 00.010.02 — Physical Qubit Implementations"
register: ATLAS-1000
...
- Out of scope: gate algebra and measurement (`03_`), noise characterisation (`04_`), logical-qubit overhead (`05_`).

## 3. Modality Compatibility Matrix

The matrix below mirrors the structural pattern of the GSE compatibility matrix in ATLAS `010-019/060_GSE/02_`: three columns expressing **engineering posture**, not just physics. This is the slice of the QCSAA register where technology-readiness honesty must live; every reader making an engineering decision should be able to read the column headers and understand which modalities are operational, which are roadmap, and which remain research.
