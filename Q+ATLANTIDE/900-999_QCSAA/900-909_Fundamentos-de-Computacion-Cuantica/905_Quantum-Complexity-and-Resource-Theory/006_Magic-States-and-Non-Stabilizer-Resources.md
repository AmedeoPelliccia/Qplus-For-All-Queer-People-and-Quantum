...
- Concepts in scope:
  ...
  - **Resource theory of magic** — free states: stabiliser states (pure and mixed convex hull); free operations: stabiliser (Clifford) operations; resource states: any state with nonzero non-stabilizerness; magic is necessary and sufficient for quantum computational universality beyond BPP.
  - **Magic measures**:
