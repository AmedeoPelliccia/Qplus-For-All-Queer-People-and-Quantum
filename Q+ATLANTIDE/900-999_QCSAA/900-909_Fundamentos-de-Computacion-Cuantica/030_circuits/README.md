...
- **Upstream (within `900-909`)** — [`../010_Qubits/`](../010_Qubits/) and [`../901_gates/`](../901_gates/). Every circuit in this chapter operates on the Hilbert space defined in `010_Qubits/01_` and is composed of the unitary operations defined in `901_gates/001_`–`901_gates/004_`; every circuit-depth and noise-budget argument in `902_` and `905_` is bounded by the per-gate times and fidelities of [`../901_gates/005_Gate-Implementation-Calibration-and-Error-Characterization.md`](../901_gates/005_Gate-Implementation-Calibration-and-Error-Characterization.md) and the $T_1, T_2$ values of [`../010_Qubits/04_Decoherence-Noise-and-Fidelity.md`](../010_Qubits/04_Decoherence-Noise-and-Fidelity.md).
...
|---|---|---|---|
| 1.0.0 | 2026-05-07 | Q-HORIZON | Initial baseline: `900_Overview.md` plus subsubjects `901`–`905`. Subsection index established; chapter parallel to `010_Qubits/` and `901_gates/` (definition → properties → operations → engineering → practice). |
