...
- Out of scope: the qubit-level decoherence model itself (already in `900_Qubits/004_`); logical-qubit-level error correction (`900_Qubits/005_`); algorithm-level resource estimation including circuit depth and scheduling (`030_circuits/`, `040_quantum-algorithms/`).
